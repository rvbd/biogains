...
`+i))});const n=document.querySelector("head");n.insertBefore(e,n.lastChild)};class Fn{constructor(t){this.Reveal=t,this.state="idle",this.registeredPlugins={},this.asyncDependencies=[]}load(t,e){return this.state="loading",t.forEach(this.registerPlugin.bind(this)),new Promise((n=>{let i=[],a=0;if(e.forEach((s=>{s.condition&&!s.condition()||(s.async?this.asyncDependencies.push(s):i.push(s))})),i.length){a=i.length;const s=l=>{l&&typeof l.callback=="function"&&l.callback(),--a==0&&this.initPlugins().then(n)};i.forEach((l=>{typeof l.id=="string"?(this.registerPlugin(l),s(l)):typeof l.src=="string"?_e(l.src,(()=>s(l))):(console.warn("Unrecognized plugin format",l),s())}))}else this.initPlugins().then(n)}))}initPlugins(){return new Promise((t=>{let e=Object.values(this.registeredPlugins),n=e.length;if(n===0)this.loadAsync().then(t);else{let i,a=()=>{--n==0?this.loadAsync().then(t):i()},s=0;i=()=>{let l=e[s++];if(typeof l.init=="function"){let o=l.init(this.Reveal);o&&typeof o.then=="function"?o.then(a):a()}else a()},i()}}))}loadAsync(){return this.state="loaded",this.asyncDependencies.length&&this.asyncDependencies.forEach((t=>{_e(t.src,t.callback)})),Promise.resolve()}registerPlugin(t){arguments.length===2&&typeof arguments[0]=="string"?(t=arguments[1]).id=arguments[0]:typeof t=="function"&&(t=t());let e=t.id;typeof e!="string"?console.warn("Unrecognized plugin format; can't find plugin.id",t):this.registeredPlugins[e]===void 0?(this.registeredPlugins[e]=t,this.state==="loaded"&&typeof t.init=="function"&&t.init(this.Reveal)):console.warn('reveal.js: "'+e+'" plugin has already been registered')}hasPlugin(t){return!!this.registeredPlugins[t]}getPlugin(t){return this.registeredPlugins[t]}getRegisteredPlugins(){return this.registeredPlugins}destroy(){Object.values(this.registeredPlugins).forEach((t=>{typeof t.destroy=="function"&&t.destroy()})),this.registeredPlugins={},this.asyncDependencies=[]}}class jn{constructor(t){this.Reveal=t,this.onSlidesClicked=this.onSlidesClicked.bind(this),this.iframeTriggerSelector=null,this.mediaTriggerSelector="[data-preview-image], [data-preview-video]",this.stateProps=["previewIframe","previewImage","previewVideo","previewFit"],this.state={}}update(){this.Reveal.getConfig().previewLinks?this.iframeTriggerSelector="a[href]:not([data-preview-link=false]), [data-preview-link]:not(a):not([data-preview-link=false])":this.iframeTriggerSelector="[data-preview-link]:not([data-preview-link=false])";const t=this.Reveal.getSlidesElement().querySelectorAll(this.iframeTriggerSelector).length>0,e=this.Reveal.getSlidesElement().querySelectorAll(this.mediaTriggerSelector).length>0;t||e?this.Reveal.getSlidesElement().addEventListener("click",this.onSlidesClicked,!1):this.Reveal.getSlidesElement().removeEventListener("click",this.onSlidesClicked,!1)}createOverlay(t){this.dom=document.createElement("div"),this.dom.classList.add("r-overlay"),this.dom.classList.add(t),this.viewport=document.createElement("div"),this.viewport.classList.add("r-overlay-viewport"),this.dom.appendChild(this.viewport),this.Reveal.getRevealElement().appendChild(this.dom)}previewIframe(t){this.close(),this.state={previewIframe:t},this.createOverlay("r-overlay-preview"),this.dom.dataset.state="loading",this.viewport.innerHTML=`<header class="r-overlay-header">
			...
			`,this.dom.querySelector(".r-overlay-close").addEventListener("click",(i=>{this.close(),i.preventDefault()}),!1),this.Reveal.dispatchEvent({type:"showhelp"})}}isOpen(){return!!this.dom}close(){return!!this.dom&&(this.dom.remove(),this.dom=null,this.state={},this.Reveal.dispatchEvent({type:"closeoverlay"}),!0)}getState(){return this.state}setState(t){this.stateProps.every((e=>this.state[e]===t[e]))||(t.previewIframe?this.previewIframe(t.previewIframe):t.previewImage?this.previewImage(t.previewImage,t.previewFit):t.previewVideo?this.previewVideo(t.previewVideo,t.previewFit):this.close())}onSlidesClicked(t){const e=t.target,n=e.closest(this.iframeTriggerSelector),i=e.closest(this.mediaTriggerSelector);if(n){if(t.metaKey||t.shiftKey||t.altKey)return;let a=n.getAttribute("href")||n.getAttribute("data-preview-link");a&&(this.previewIframe(a),t.preventDefault())}else if(i){if(i.hasAttribute("data-preview-image")){let a=i.dataset.previewImage||i.getAttribute("src");a&&(this.previewImage(a,i.dataset.previewFit),t.preventDefault())}else if(i.hasAttribute("data-preview-video")){let a=i.dataset.previewVideo||i.getAttribute("src");if(!a){let s=i.querySelector("source");s&&(a=s.getAttribute("src"))}a&&(this.previewVideo(a,i.dataset.previewFit),t.preventDefault())}}}destroy(){this.close()}}let _n=class{constructor(t){this.Reveal=t,this.touchStartX=0,this.touchStartY=0,this.touchStartCount=0,this.touchCaptured=!1,this.onPointerDown=this.onPointerDown.bind(this),this.onPointerMove=this.onPointerMove.bind(this),this.onPointerUp=this.onPointerUp.bind(this),this.onTouchStart=this.onTouchStart.bind(this),this.onTouchMove=this.onTouchMove.bind(this),this.onTouchEnd=this.onTouchEnd.bind(this)}bind(){let t=this.Reveal.getRevealElement();"onpointerdown"in window?(t.addEventListener("pointerdown",this.onPointerDown,!1),t.addEventListener("pointermove",this.onPointerMove,!1),t.addEventListener("pointerup",this.onPointerUp,!1)):window.navigator.msPointerEnabled?(t.addEventListener("MSPointerDown",this.onPointerDown,!1),t.addEventListener("MSPointerMove",this.onPointerMove,!1),t.addEventListener("MSPointerUp",this.onPointerUp,!1)):(t.addEventListener("touchstart",this.onTouchStart,!1),t.addEventListener("touchmove",this.onTouchMove,!1),t.addEventListener("touchend",this.onTouchEnd,!1))}unbind(){let t=this.Reveal.getRevealElement();t.removeEventListener("pointerdown",this.onPointerDown,!1),t.removeEventListener("pointermove",this.onPointerMove,!1),t.removeEventListener("pointerup",this.onPointerUp,!1),t.removeEventListener("MSPointerDown",this.onPointerDown,!1),t.removeEventListener("MSPointerMove",this.onPointerMove,!1),t.removeEventListener("MSPointerUp",this.onPointerUp,!1),t.removeEventListener("touchstart",this.onTouchStart,!1),t.removeEventListener("touchmove",this.onTouchMove,!1),t.removeEventListener("touchend",this.onTouchEnd,!1)}isSwipePrevented(t){if(Ht(t,"video[controls], audio[controls]"))return!0;for(;t&&typeof t.hasAttribute=="function";){if(t.hasAttribute("data-prevent-swipe"))return!0;t=t.parentNode}return!1}onTouchStart(t){if(this.touchCaptured=!1,this.isSwipePrevented(t.target))return!0;this.touchStartX=t.touches[0].clientX,this.touchStartY=t.touches[0].clientY,this.touchStartCount=t.touches.length}onTouchMove(t){if(this.isSwipePrevented(t.target))return!0;let e=this.Reveal.getConfig();if(this.touchCaptured)sn&&t.preventDefault();else{this.Reveal.onUserInput(t);let n=t.touches[0].clientX,i=t.touches[0].clientY;if(t.touches.length===1&&this.touchStartCount!==2){let a=this.Reveal.availableRoutes({includeFragments:!0}),s=n-this.touchStartX,l=i-this.touchStartY;s>40&&Math.abs(s)>Math.abs(l)?(this.touchCaptured=!0,e.navigationMode==="linear"?e.rtl?this.Reveal.next():this.Reveal.prev():this.Reveal.left()):s<-40&&Math.abs(s)>Math.abs(l)?(this.touchCaptured=!0,e.navigationMode==="linear"?e.rtl?this.Reveal.prev():this.Reveal.next():this.Reveal.right()):l>40&&a.up?(this.touchCaptured=!0,e.navigationMode==="linear"?this.Reveal.prev():this.Reveal.up()):l<-40&&a.down&&(this.touchCaptured=!0,e.navigationMode==="linear"?this.Reveal.next():this.Reveal.down()),e.embedded?(this.touchCaptured||this.Reveal.isVerticalSlide())&&t.preventDefault():t.preventDefault()}}}onTouchEnd(t){this.touchCaptured=!1}onPointerDown(t){t.pointerType!==t.MSPOINTER_TYPE_TOUCH&&t.pointerType!=="touch"||(t.touches=[{clientX:t.clientX,clientY:t.clientY}],this.onTouchStart(t))}onPointerMove(t){t.pointerType!==t.MSPOINTER_TYPE_TOUCH&&t.pointerType!=="touch"||(t.touches=[{clientX:t.clientX,clientY:t.clientY}],this.onTouchMove(t))}onPointerUp(t){t.pointerType!==t.MSPOINTER_TYPE_TOUCH&&t.pointerType!=="touch"||(t.touches=[{clientX:t.clientX,clientY:t.clientY}],this.onTouchEnd(t))}};const ne="focus",Ue="blur";class Un{constructor(t){this.Reveal=t,this.onRevealPointerDown=this.onRevealPointerDown.bind(this),this.onDocumentPointerDown=this.onDocumentPointerDown.bind(this)}configure(t,e){t.embedded?this.blur():(this.focus(),this.unbind())}bind(){this.Reveal.getConfig().embedded&&this.Reveal.getRevealElement().addEventListener("pointerdown",this.onRevealPointerDown,!1)}unbind(){this.Reveal.getRevealElement().removeEventListener("pointerdown",this.onRevealPointerDown,!1),document.removeEventListener("pointerdown",this.onDocumentPointerDown,!1)}focus(){this.state!==ne&&(this.Reveal.getRevealElement().classList.add("focused"),document.addEventListener("pointerdown",this.onDocumentPointerDown,!1)),this.state=ne}blur(){this.state!==Ue&&(this.Reveal.getRevealElement().classList.remove("focused"),document.removeEventListener("pointerdown",this.onDocumentPointerDown,!1)),this.state=Ue}isFocused(){return this.state===ne}destroy(){this.Reveal.getRevealElement().classList.remove("focused")}onRevealPointerDown(t){this.focus()}onDocumentPointerDown(t){let e=G(t.target,".reveal");e&&e===this.Reveal.getRevealElement()||this.blur()}}class Wn{constructor(t){this.Reveal=t}render(){this.element=document.createElement("div"),this.element.className="speaker-notes",this.element.setAttribute("data-prevent-swipe",""),this.element.setAttribute("tabindex","0"),this.Reveal.getRevealElement().appendChild(this.element)}configure(t,e){t.showNotes&&this.element.setAttribute("data-layout",typeof t.showNotes=="string"?t.showNotes:"inline")}update(){this.Reveal.getConfig().showNotes&&this.element&&this.Reveal.getCurrentSlide()&&!this.Reveal.isScrollView()&&!this.Reveal.isPrintView()&&(this.element.innerHTML=this.getSlideNotes()||'<span class="notes-placeholder">No notes on this slide.</span>')}updateVisibility(){this.Reveal.getConfig().showNotes&&this.hasNotes()&&!this.Reveal.isScrollView()&&!this.Reveal.isPrintView()?this.Reveal.getRevealElement().classList.add("show-notes"):this.Reveal.getRevealElement().classList.remove("show-notes")}hasNotes(){return this.Reveal.getSlidesElement().querySelectorAll("[data-notes], aside.notes").length>0}isSpeakerNotesWindow(){return!!window.location.search.match(/receiver/gi)}getSlideNotes(t=this.Reveal.getCurrentSlide()){if(t.hasAttribute("data-notes"))return t.getAttribute("data-notes");let e=t.querySelectorAll("aside.notes");return e?Array.from(e).map((n=>n.innerHTML)).join(`
`):null}destroy(){this.element.remove()}}class Vn{constructor(t,e){this.diameter=100,this.diameter2=this.diameter/2,this.thickness=6,this.playing=!1,this.progress=0,this.progressOffset=1,this.container=t,this.progressCheck=e,this.canvas=document.createElement("canvas"),this.canvas.className="playback",this.canvas.width=this.diameter,this.canvas.height=this.diameter,this.canvas.style.width=this.diameter2+"px",this.canvas.style.height=this.diameter2+"px",this.context=this.canvas.getContext("2d"),this.container.appendChild(this.canvas),this.render()}setPlaying(t){const e=this.playing;this.playing=t,!e&&this.playing?this.animate():this.render()}animate(){const t=this.progress;this.progress=this.progressCheck(),t>.8&&this.progress<.2&&(this.progressOffset=this.progress),this.render(),this.playing&&requestAnimationFrame(this.animate.bind(this))}render(){let t=this.playing?this.progress:0,e=this.diameter2-this.thickness,n=this.diameter2,i=this.diameter2,a=28;this.progressOffset+=.1*(1-this.progressOffset);const s=-Math.PI/2+t*(2*Math.PI),l=-Math.PI/2+this.progressOffset*(2*Math.PI);this.context.save(),this.context.clearRect(0,0,this.diameter,this.diameter),this.context.beginPath(),this.context.arc(n,i,e+4,0,2*Math.PI,!1),this.context.fillStyle="rgba( 0, 0, 0, 0.4 )",this.context.fill(),this.context.beginPath(),this.context.arc(n,i,e,0,2*Math.PI,!1),this.context.lineWidth=this.thickness,this.context.strokeStyle="rgba( 255, 255, 255, 0.2 )",this.context.stroke(),this.playing&&(this.context.beginPath(),this.context.arc(n,i,e,l,s,!1),this.context.lineWidth=this.thickness,this.context.strokeStyle="#fff",this.context.stroke()),this.context.translate(n-14,i-14),this.playing?(this.context.fillStyle="#fff",this.context.fillRect(0,0,10,a),this.context.fillRect(18,0,10,a)):(this.context.beginPath(),this.context.translate(4,0),this.context.moveTo(0,0),this.context.lineTo(24,14),this.context.lineTo(0,a),this.context.fillStyle="#fff",this.context.fill()),this.context.restore()}on(t,e){this.canvas.addEventListener(t,e,!1)}off(t,e){this.canvas.removeEventListener(t,e,!1)}destroy(){this.playing=!1,this.canvas.parentNode&&this.container.removeChild(this.canvas)}}var Kn={width:960,height:700,margin:.04,minScale:.2,maxScale:2,controls:!0,controlsTutorial:!0,controlsLayout:"bottom-right",controlsBackArrows:"faded",progress:!0,slideNumber:!1,showSlideNumber:"all",hashOneBasedIndex:!1,hash:!1,respondToHashChanges:!0,jumpToSlide:!0,history:!1,keyboard:!0,keyboardCondition:null,disableLayout:!1,overview:!0,center:!0,touch:!0,loop:!1,rtl:!1,navigationMode:"default",shuffle:!1,fragments:!0,fragmentInURL:!0,embedded:!1,help:!0,pause:!0,showNotes:!1,showHiddenSlides:!1,autoPlayMedia:null,preloadIframes:null,autoAnimate:!0,autoAnimateMatcher:null,autoAnimateEasing:"ease",autoAnimateDuration:1,autoAnimateUnmatched:!0,autoAnimateStyles:["opacity","color","background-color","padding","font-size","line-height","letter-spacing","border-width","border-color","border-radius","outline","outline-offset"],autoSlide:0,autoSlideStoppable:!0,autoSlideMethod:null,defaultTiming:null,mouseWheel:!1,previewLinks:!1,postMessage:!0,postMessageEvents:!1,focusBodyOnPageVisibilityChange:!0,transition:"slide",transitionSpeed:"default",backgroundTransition:"fade",parallaxBackgroundImage:"",parallaxBackgroundSize:"",parallaxBackgroundRepeat:"",parallaxBackgroundPosition:"",parallaxBackgroundHorizontal:null,parallaxBackgroundVertical:null,view:null,scrollLayout:"full",scrollSnap:"mandatory",scrollProgress:"auto",scrollActivationWidth:435,pdfMaxPagesPerSlide:Number.POSITIVE_INFINITY,pdfSeparateFragments:!0,pdfPageHeightOffset:-1,viewDistance:3,mobileViewDistance:2,display:"block",hideInactiveCursor:!0,hideCursorTime:5e3,sortFragmentsOnSync:!0,dependencies:[],plugins:[]};const rn="5.2.1";function on(r,t){arguments.length<2&&(t=arguments[0],r=document.querySelector(".reveal"));const e={};let n,i,a,s,l,o={},c=!1,h=!1,u={hasNavigatedHorizontally:!1,hasNavigatedVertically:!1},g=[],v=1,L={layout:"",overview:""},p={},F="idle",x=0,q=0,X=-1,M=!1,R=new Rn(e),E=new Cn(e),B=new Ln(e),U=new Pn(e),P=new In(e),f=new Nn(e),I=new $n(e),N=new Mn(e),O=new Bn(e),_=new On(e),V=new zn(e),K=new Hn(e),at=new Dn(e),oe=new qn(e),et=new Fn(e),W=new jn(e),pt=new Un(e),jt=new _n(e),tt=new Wn(e);function yn(){c!==!1&&(h=!0,o.showHiddenSlides||A(p.wrapper,'section[data-visibility="hidden"]').forEach((d=>{const m=d.parentNode;m.childElementCount===1&&/section/i.test(m.nodeName)?m.remove():d.remove()})),(function(){p.slides.classList.add("no-transition"),kt?p.wrapper.classList.add("no-hover"):p.wrapper.classList.remove("no-hover"),P.render(),E.render(),B.render(),K.render(),at.render(),tt.render(),p.pauseOverlay=((d,m,b,w="")=>{let k=d.querySelectorAll("."+b);for(let z=0;z<k.length;z++){let D=k[z];if(D.parentNode===d)return D}let $=document.createElement(m);return $.className=b,$.innerHTML=w,d.appendChild($),$})(p.wrapper,"div","pause-overlay",o.controls?'<button class="resume-button">Resume presentation</button>':null),p.statusElement=(function(){let d=p.wrapper.querySelector(".aria-status");return d||(d=document.createElement("div"),d.style.position="absolute",d.style.height="1px",d.style.width="1px",d.style.overflow="hidden",d.style.clip="rect( 1px, 1px, 1px, 1px )",d.classList.add("aria-status"),d.setAttribute("aria-live","polite"),d.setAttribute("aria-atomic","true"),p.wrapper.appendChild(d)),d})(),p.wrapper.setAttribute("role","application")})(),o.postMessage&&window.addEventListener("message",Me,!1),setInterval((()=>{(!f.isActive()&&p.wrapper.scrollTop!==0||p.wrapper.scrollLeft!==0)&&(p.wrapper.scrollTop=0,p.wrapper.scrollLeft=0)}),1e3),document.addEventListener("fullscreenchange",$t),document.addEventListener("webkitfullscreenchange",$t),ot().forEach((d=>{A(d,"section").forEach(((m,b)=>{b>0&&(m.classList.remove("present"),m.classList.remove("past"),m.classList.add("future"),m.setAttribute("aria-hidden","true"))}))})),le(),P.update(!0),(function(){const d=o.view==="print",m=o.view==="scroll"||o.view==="reader";(d||m)&&(d?Rt():jt.unbind(),p.viewport.classList.add("loading-scroll-mode"),d?document.readyState==="complete"?I.activate():window.addEventListener("load",(()=>I.activate())):f.activate())})(),V.readURL(),setTimeout((()=>{p.slides.classList.remove("no-transition"),p.wrapper.classList.add("ready"),Q({type:"ready",data:{indexh:n,indexv:i,currentSlide:s}})}),1))}function _t(d){p.statusElement.textContent=d}function At(d){let m="";if(d.nodeType===3)m+=d.textContent;else if(d.nodeType===1){let b=d.getAttribute("aria-hidden"),w=window.getComputedStyle(d).display==="none";b==="true"||w||Array.from(d.childNodes).forEach((k=>{m+=At(k)}))}return m=m.trim(),m===""?"":m+" "}function le(d){const m={...o};if(typeof d=="object"&&wt(o,d),e.isReady()===!1)return;const b=p.wrapper.querySelectorAll(mt).length;p.wrapper.classList.remove(m.transition),p.wrapper.classList.add(o.transition),p.wrapper.setAttribute("data-transition-speed",o.transitionSpeed),p.wrapper.setAttribute("data-background-transition",o.backgroundTransition),p.viewport.style.setProperty("--slide-width",typeof o.width=="string"?o.width:o.width+"px"),p.viewport.style.setProperty("--slide-height",typeof o.height=="string"?o.height:o.height+"px"),o.shuffle&&Kt(),te(p.wrapper,"embedded",o.embedded),te(p.wrapper,"rtl",o.rtl),te(p.wrapper,"center",o.center),o.pause===!1&&Et(),U.reset(),l&&(l.destroy(),l=null),b>1&&o.autoSlide&&o.autoSlideStoppable&&(l=new Vn(p.wrapper,(()=>Math.min(Math.max((Date.now()-X)/x,0),1))),l.on("click",wn),M=!1),o.navigationMode!=="default"?p.wrapper.setAttribute("data-navigation-mode",o.navigationMode):p.wrapper.removeAttribute("data-navigation-mode"),tt.configure(o,m),pt.configure(o,m),oe.configure(o,m),K.configure(o,m),at.configure(o,m),_.configure(o,m),N.configure(o,m),E.configure(o,m),ke()}function ce(){window.addEventListener("resize",ze,!1),o.touch&&jt.bind(),o.keyboard&&_.bind(),o.progress&&at.bind(),o.respondToHashChanges&&V.bind(),K.bind(),pt.bind(),p.slides.addEventListener("click",Oe,!1),p.slides.addEventListener("transitionend",Be,!1),p.pauseOverlay.addEventListener("click",Et,!1),o.focusBodyOnPageVisibilityChange&&document.addEventListener("visibilitychange",He,!1)}function Rt(){jt.unbind(),pt.unbind(),_.unbind(),K.unbind(),at.unbind(),V.unbind(),window.removeEventListener("resize",ze,!1),p.slides.removeEventListener("click",Oe,!1),p.slides.removeEventListener("transitionend",Be,!1),p.pauseOverlay.removeEventListener("click",Et,!1)}function de(d,m,b){r.addEventListener(d,m,b)}function ue(d,m,b){r.removeEventListener(d,m,b)}function Ut(d){typeof d.layout=="string"&&(L.layout=d.layout),typeof d.overview=="string"&&(L.overview=d.overview),L.layout?ct(p.slides,L.layout+" "+L.overview):ct(p.slides,L.overview)}function Q({target:d=p.wrapper,type:m,data:b,bubbles:w=!0}){let k=document.createEvent("HTMLEvents",1,2);return k.initEvent(m,w,!0),wt(k,b),d.dispatchEvent(k),d===p.wrapper&&pe(m),k}function he(d){Q({type:"slidechanged",data:{indexh:n,indexv:i,previousSlide:a,currentSlide:s,origin:d}})}function pe(d,m){if(o.postMessageEvents&&window.parent!==window.self){let b={namespace:"reveal",eventName:d,state:Ne()};wt(b,m),window.parent.postMessage(JSON.stringify(b),"*")}}function vt(){if(p.wrapper&&!I.isActive()){const d=p.viewport.offsetWidth,m=p.viewport.offsetHeight;if(!o.disableLayout){kt&&!o.embedded&&document.documentElement.style.setProperty("--vh",.01*window.innerHeight+"px");const b=f.isActive()?Tt(d,m):Tt(),w=v;ge(o.width,o.height),p.slides.style.width=b.width+"px",p.slides.style.height=b.height+"px",v=Math.min(b.presentationWidth/b.width,b.presentationHeight/b.height),v=Math.max(v,o.minScale),v=Math.min(v,o.maxScale),v===1||f.isActive()?(p.slides.style.zoom="",p.slides.style.left="",p.slides.style.top="",p.slides.style.bottom="",p.slides.style.right="",Ut({layout:""})):(p.slides.style.zoom="",p.slides.style.left="50%",p.slides.style.top="50%",p.slides.style.bottom="auto",p.slides.style.right="auto",Ut({layout:"translate(-50%, -50%) scale("+v+")"}));const k=Array.from(p.wrapper.querySelectorAll(mt));for(let $=0,z=k.length;$<z;$++){const D=k[$];D.style.display!=="none"&&(o.center||D.classList.contains("center")?D.classList.contains("stack")?D.style.top=0:D.style.top=Math.max((b.height-D.scrollHeight)/2,0)+"px":D.style.top="")}w!==v&&Q({type:"resize",data:{oldScale:w,scale:v,size:b}})}(function(){if(p.wrapper&&!o.disableLayout&&!I.isActive()&&typeof o.scrollActivationWidth=="number"&&o.view!=="scroll"){const b=Tt();b.presentationWidth>0&&b.presentationWidth<=o.scrollActivationWidth?f.isActive()||(P.create(),f.activate()):f.isActive()&&f.deactivate()}})(),p.viewport.style.setProperty("--slide-scale",v),p.viewport.style.setProperty("--viewport-width",d+"px"),p.viewport.style.setProperty("--viewport-height",m+"px"),f.layout(),at.update(),P.updateParallax(),O.isActive()&&O.update()}}function ge(d,m){A(p.slides,"section > .stretch, section > .r-stretch").forEach((b=>{let w=((k,$=0)=>{if(k){let z,D=k.style.height;return k.style.height="0px",k.parentNode.style.height="auto",z=$-k.parentNode.offsetHeight,k.style.height=D+"px",k.parentNode.style.removeProperty("height"),z}return $})(b,m);if(/(img|video)/gi.test(b.nodeName)){const k=b.naturalWidth||b.videoWidth,$=b.naturalHeight||b.videoHeight,z=Math.min(d/k,w/$);b.style.width=k*z+"px",b.style.height=$*z+"px"}else b.style.width=d+"px",b.style.height=w+"px"}))}function Tt(d,m){let b=o.width,w=o.height;o.disableLayout&&(b=p.slides.offsetWidth,w=p.slides.offsetHeight);const k={width:b,height:w,presentationWidth:d||p.wrapper.offsetWidth,presentationHeight:m||p.wrapper.offsetHeight};return k.presentationWidth-=k.presentationWidth*o.margin,k.presentationHeight-=k.presentationHeight*o.margin,typeof k.width=="string"&&/%$/.test(k.width)&&(k.width=parseInt(k.width,10)/100*k.presentationWidth),typeof k.height=="string"&&/%$/.test(k.height)&&(k.height=parseInt(k.height,10)/100*k.presentationHeight),k}function me(d,m){typeof d=="object"&&typeof d.setAttribute=="function"&&d.setAttribute("data-previous-indexv",m||0)}function fe(d){if(typeof d=="object"&&typeof d.setAttribute=="function"&&d.classList.contains("stack")){const m=d.hasAttribute("data-start-indexv")?"data-start-indexv":"data-previous-indexv";return parseInt(d.getAttribute(m)||0,10)}return 0}function St(d=s){return d&&d.parentNode&&!!d.parentNode.nodeName.match(/section/i)}function ve(){return!(!s||!St(s))&&!s.nextElementSibling}function be(){return n===0&&i===0}function Wt(){return!!s&&!s.nextElementSibling&&(!St(s)||!s.parentNode.nextElementSibling)}function ye(){if(o.pause){const d=p.wrapper.classList.contains("paused");Ct(),p.wrapper.classList.add("paused"),d===!1&&Q({type:"paused"})}}function Et(){const d=p.wrapper.classList.contains("paused");p.wrapper.classList.remove("paused"),bt(),d&&Q({type:"resumed"})}function we(d){typeof d=="boolean"?d?ye():Et():xt()?Et():ye()}function xt(){return p.wrapper.classList.contains("paused")}function nt(d,m,b,w){if(Q({type:"beforeslidechange",data:{indexh:d===void 0?n:d,indexv:m===void 0?i:m,origin:w}}).defaultPrevented)return;a=s;const k=p.wrapper.querySelectorAll(lt);if(f.isActive()){const Z=f.getSlideByIndices(d,m);return void(Z&&f.scrollToSlide(Z))}if(k.length===0)return;m!==void 0||O.isActive()||(m=fe(k[d])),a&&a.parentNode&&a.parentNode.classList.contains("stack")&&me(a.parentNode,i);const $=g.concat();g.length=0;let z=n||0,D=i||0;n=Se(lt,d===void 0?n:d),i=Se(Fe,m===void 0?i:m);let rt=n!==z||i!==D;rt||(a=null);let gt=k[n],J=gt.querySelectorAll("section");r.classList.toggle("is-vertical-slide",J.length>1),s=J[i]||gt;let j=!1;rt&&a&&s&&!O.isActive()&&(F="running",j=Vt(a,s,z,D),j&&p.slides.classList.add("disable-slide-transitions")),Gt(),vt(),O.isActive()&&O.update(),b!==void 0&&N.goto(b),a&&a!==s&&(a.classList.remove("present"),a.setAttribute("aria-hidden","true"),be()&&setTimeout((()=>{A(p.wrapper,lt+".stack").forEach((Z=>{me(Z,0)}))}),0));t:for(let Z=0,kn=g.length;Z<kn;Z++){for(let Mt=0;Mt<$.length;Mt++)if($[Mt]===g[Z]){$.splice(Mt,1);continue t}p.viewport.classList.add(g[Z]),Q({type:g[Z]})}for(;$.length;)p.viewport.classList.remove($.pop());rt&&he(w),!rt&&a||(R.stopEmbeddedContent(a),R.startEmbeddedContent(s)),requestAnimationFrame((()=>{_t(At(s))})),at.update(),K.update(),tt.update(),P.update(),P.updateParallax(),E.update(),N.update(),V.writeURL(),bt(),j&&(setTimeout((()=>{p.slides.classList.remove("disable-slide-transitions")}),0),o.autoAnimate&&U.run(a,s))}function Vt(d,m,b,w){return d.hasAttribute("data-auto-animate")&&m.hasAttribute("data-auto-animate")&&d.getAttribute("data-auto-animate-id")===m.getAttribute("data-auto-animate-id")&&!(n>b||i>w?m:d).hasAttribute("data-auto-animate-restart")}function ke(){Rt(),ce(),vt(),x=o.autoSlide,bt(),P.create(),V.writeURL(),o.sortFragmentsOnSync===!0&&N.sortAll(),K.update(),at.update(),Gt(),tt.update(),tt.updateVisibility(),W.update(),P.update(!0),E.update(),R.formatEmbeddedContent(),o.autoPlayMedia===!1?R.stopEmbeddedContent(s,{unloadIframes:!1}):R.startEmbeddedContent(s),O.isActive()&&O.layout()}function Kt(d=ot()){d.forEach(((m,b)=>{let w=d[Math.floor(Math.random()*d.length)];w.parentNode===m.parentNode&&m.parentNode.insertBefore(m,w);let k=m.querySelectorAll("section");k.length&&Kt(k)}))}function Se(d,m){let b=A(p.wrapper,d),w=b.length,k=f.isActive()||I.isActive(),$=!1,z=!1;if(w){o.loop&&(m>=w&&($=!0),(m%=w)<0&&(m=w+m,z=!0)),m=Math.max(Math.min(m,w-1),0);for(let J=0;J<w;J++){let j=b[J],Z=o.rtl&&!St(j);j.classList.remove("past"),j.classList.remove("present"),j.classList.remove("future"),j.setAttribute("hidden",""),j.setAttribute("aria-hidden","true"),j.querySelector("section")&&j.classList.add("stack"),k?j.classList.add("present"):J<m?(j.classList.add(Z?"future":"past"),o.fragments&&Ee(j)):J>m?(j.classList.add(Z?"past":"future"),o.fragments&&xe(j)):J===m&&o.fragments&&($?xe(j):z&&Ee(j))}let D=b[m],rt=D.classList.contains("present");D.classList.add("present"),D.removeAttribute("hidden"),D.removeAttribute("aria-hidden"),rt||Q({target:D,type:"visible",bubbles:!1});let gt=D.getAttribute("data-state");gt&&(g=g.concat(gt.split(" ")))}else m=0;return m}function Ee(d){A(d,".fragment").forEach((m=>{m.classList.add("visible"),m.classList.remove("current-fragment")}))}function xe(d){A(d,".fragment.visible").forEach((m=>{m.classList.remove("visible","current-fragment")}))}function Gt(){let d,m,b=ot(),w=b.length;if(w&&n!==void 0){let k=O.isActive()?10:o.viewDistance;kt&&(k=O.isActive()?6:o.mobileViewDistance),I.isActive()&&(k=Number.MAX_VALUE);for(let $=0;$<w;$++){let z=b[$],D=A(z,"section"),rt=D.length;if(d=Math.abs((n||0)-$)||0,o.loop&&(d=Math.abs(((n||0)-$)%(w-k))||0),d<k?R.load(z):R.unload(z),rt){let gt=fe(z);for(let J=0;J<rt;J++){let j=D[J];m=Math.abs($===(n||0)?(i||0)-J:J-gt),d+m<k?R.load(j):R.unload(j)}}}Le()?p.wrapper.classList.add("has-vertical-slides"):p.wrapper.classList.remove("has-vertical-slides"),Ce()?p.wrapper.classList.add("has-horizontal-slides"):p.wrapper.classList.remove("has-horizontal-slides")}}function st({includeFragments:d=!1}={}){let m=p.wrapper.querySelectorAll(lt),b=p.wrapper.querySelectorAll(Fe),w={left:n>0,right:n<m.length-1,up:i>0,down:i<b.length-1};if(o.loop&&(m.length>1&&(w.left=!0,w.right=!0),b.length>1&&(w.up=!0,w.down=!0)),m.length>1&&o.navigationMode==="linear"&&(w.right=w.right||w.down,w.left=w.left||w.up),d===!0){let k=N.availableRoutes();w.left=w.left||k.prev,w.up=w.up||k.prev,w.down=w.down||k.next,w.right=w.right||k.next}if(o.rtl){let k=w.left;w.left=w.right,w.right=k}return w}function Ae(d=s){let m=ot(),b=0;t:for(let w=0;w<m.length;w++){let k=m[w],$=k.querySelectorAll("section");for(let z=0;z<$.length;z++){if($[z]===d)break t;$[z].dataset.visibility!=="uncounted"&&b++}if(k===d)break;k.classList.contains("stack")===!1&&k.dataset.visibility!=="uncounted"&&b++}return b}function Re(d){let m,b=n,w=i;if(d)if(f.isActive())b=parseInt(d.getAttribute("data-index-h"),10),d.getAttribute("data-index-v")&&(w=parseInt(d.getAttribute("data-index-v"),10));else{let k=St(d),$=k?d.parentNode:d,z=ot();b=Math.max(z.indexOf($),0),w=void 0,k&&(w=Math.max(A(d.parentNode,"section").indexOf(d),0))}if(!d&&s&&s.querySelectorAll(".fragment").length>0){let k=s.querySelector(".current-fragment");m=k&&k.hasAttribute("data-fragment-index")?parseInt(k.getAttribute("data-fragment-index"),10):s.querySelectorAll(".fragment.visible").length-1}return{h:b,v:w,f:m}}function Yt(){return A(p.wrapper,mt+':not(.stack):not([data-visibility="uncounted"])')}function ot(){return A(p.wrapper,lt)}function Te(){return A(p.wrapper,".slides>section>section")}function Ce(){return ot().length>1}function Le(){return Te().length>1}function Ie(){return Yt().length}function Pe(d,m){let b=ot()[d],w=b&&b.querySelectorAll("section");return w&&w.length&&typeof m=="number"?w?w[m]:void 0:b}function Ne(){let d=Re();return{indexh:d.h,indexv:d.v,indexf:d.f,paused:xt(),overview:O.isActive(),...W.getState()}}function bt(){if(Ct(),s&&o.autoSlide!==!1){let d=s.querySelector(".current-fragment[data-autoslide]"),m=d?d.getAttribute("data-autoslide"):null,b=s.parentNode?s.parentNode.getAttribute("data-autoslide"):null,w=s.getAttribute("data-autoslide");m?x=parseInt(m,10):w?x=parseInt(w,10):b?x=parseInt(b,10):(x=o.autoSlide,s.querySelectorAll(".fragment").length===0&&A(s,"video, audio").forEach((k=>{k.hasAttribute("data-autoplay")&&x&&1e3*k.duration/k.playbackRate>x&&(x=1e3*k.duration/k.playbackRate+1e3)}))),!x||M||xt()||O.isActive()||Wt()&&!N.availableRoutes().next&&o.loop!==!0||(q=setTimeout((()=>{typeof o.autoSlideMethod=="function"?o.autoSlideMethod():Zt(),bt()}),x),X=Date.now()),l&&l.setPlaying(q!==-1)}}function Ct(){clearTimeout(q),q=-1}function Lt(){x&&!M&&(M=!0,Q({type:"autoslidepaused"}),clearTimeout(q),l&&l.setPlaying(!1))}function It(){x&&M&&(M=!1,Q({type:"autoslideresumed"}),bt())}function Pt({skipFragments:d=!1}={}){if(u.hasNavigatedHorizontally=!0,f.isActive())return f.prev();o.rtl?(O.isActive()||d||N.next()===!1)&&st().left&&nt(n+1,o.navigationMode==="grid"?i:void 0):(O.isActive()||d||N.prev()===!1)&&st().left&&nt(n-1,o.navigationMode==="grid"?i:void 0)}function Nt({skipFragments:d=!1}={}){if(u.hasNavigatedHorizontally=!0,f.isActive())return f.next();o.rtl?(O.isActive()||d||N.prev()===!1)&&st().right&&nt(n-1,o.navigationMode==="grid"?i:void 0):(O.isActive()||d||N.next()===!1)&&st().right&&nt(n+1,o.navigationMode==="grid"?i:void 0)}function Xt({skipFragments:d=!1}={}){if(f.isActive())return f.prev();(O.isActive()||d||N.prev()===!1)&&st().up&&nt(n,i-1)}function Jt({skipFragments:d=!1}={}){if(u.hasNavigatedVertically=!0,f.isActive())return f.next();(O.isActive()||d||N.next()===!1)&&st().down&&nt(n,i+1)}function $e({skipFragments:d=!1}={}){if(f.isActive())return f.prev();if(d||N.prev()===!1)if(st().up)Xt({skipFragments:d});else{let m;if(m=o.rtl?A(p.wrapper,lt+".future").pop():A(p.wrapper,lt+".past").pop(),m&&m.classList.contains("stack")){let b=m.querySelectorAll("section").length-1||void 0;nt(n-1,b)}else o.rtl?Nt({skipFragments:d}):Pt({skipFragments:d})}}function Zt({skipFragments:d=!1}={}){if(u.hasNavigatedHorizontally=!0,u.hasNavigatedVertically=!0,f.isActive())return f.next();if(d||N.next()===!1){let m=st();m.down&&m.right&&o.loop&&ve()&&(m.down=!1),m.down?Jt({skipFragments:d}):o.rtl?Pt({skipFragments:d}):Nt({skipFragments:d})}}function Me(d){let m=d.data;if(typeof m=="string"&&m.charAt(0)==="{"&&m.charAt(m.length-1)==="}"&&(m=JSON.parse(m),m.method&&typeof e[m.method]=="function"))if(Tn.test(m.method)===!1){const b=e[m.method].apply(e,m.args);pe("callback",{method:m.method,result:b})}else console.warn('reveal.js: "'+m.method+'" is is blacklisted from the postMessage API')}function Be(d){F==="running"&&/section/gi.test(d.target.nodeName)&&(F="idle",Q({type:"slidetransitionend",data:{indexh:n,indexv:i,previousSlide:a,currentSlide:s}}))}function Oe(d){const m=G(d.target,'a[href^="#"]');if(m){const b=m.getAttribute("href"),w=V.getIndicesFromHash(b);w&&(e.slide(w.h,w.v,w.f),d.preventDefault())}}function ze(d){vt()}function He(d){document.hidden===!1&&document.activeElement!==document.body&&(typeof document.activeElement.blur=="function"&&document.activeElement.blur(),document.body.focus())}function $t(d){(document.fullscreenElement||document.webkitFullscreenElement)===p.wrapper&&(d.stopImmediatePropagation(),setTimeout((()=>{e.layout(),e.focus.focus()}),1))}function wn(d){Wt()&&o.loop===!1?(nt(0,0),It()):M?It():Lt()}const De={VERSION:rn,initialize:function(d){if(!r)throw'Unable to find presentation root (<div class="reveal">).';if(c)throw"Reveal.js has already been initialized.";if(c=!0,p.wrapper=r,p.slides=r.querySelector(".slides"),!p.slides)throw'Unable to find slides container (<div class="slides">).';return o={...Kn,...o,...t,...d,...qe()},/print-pdf/gi.test(window.location.search)&&(o.view="print"),(function(){o.embedded===!0?p.viewport=G(r,".reveal-viewport")||r:(p.viewport=document.body,document.documentElement.classList.add("reveal-full-page")),p.viewport.classList.add("reveal-viewport")})(),window.addEventListener("load",vt,!1),et.load(o.plugins,o.dependencies).then(yn),new Promise((m=>e.on("ready",m)))},configure:le,destroy:function(){c=!1,h!==!1&&(Rt(),Ct(),tt.destroy(),pt.destroy(),W.destroy(),et.destroy(),oe.destroy(),K.destroy(),at.destroy(),P.destroy(),E.destroy(),B.destroy(),document.removeEventListener("fullscreenchange",$t),document.removeEventListener("webkitfullscreenchange",$t),document.removeEventListener("visibilitychange",He,!1),window.removeEventListener("message",Me,!1),window.removeEventListener("load",vt,!1),p.pauseOverlay&&p.pauseOverlay.remove(),p.statusElement&&p.statusElement.remove(),document.documentElement.classList.remove("reveal-full-page"),p.wrapper.classList.remove("ready","center","has-horizontal-slides","has-vertical-slides"),p.wrapper.removeAttribute("data-transition-speed"),p.wrapper.removeAttribute("data-background-transition"),p.viewport.classList.remove("reveal-viewport"),p.viewport.style.removeProperty("--slide-width"),p.viewport.style.removeProperty("--slide-height"),p.slides.style.removeProperty("width"),p.slides.style.removeProperty("height"),p.slides.style.removeProperty("zoom"),p.slides.style.removeProperty("left"),p.slides.style.removeProperty("top"),p.slides.style.removeProperty("bottom"),p.slides.style.removeProperty("right"),p.slides.style.removeProperty("transform"),Array.from(p.wrapper.querySelectorAll(mt)).forEach((d=>{d.style.removeProperty("display"),d.style.removeProperty("top"),d.removeAttribute("hidden"),d.removeAttribute("aria-hidden")})))},sync:ke,syncSlide:function(d=s){P.sync(d),N.sync(d),R.load(d),P.update(),tt.update()},syncFragments:N.sync.bind(N),slide:nt,left:Pt,right:Nt,up:Xt,down:Jt,prev:$e,next:Zt,navigateLeft:Pt,navigateRight:Nt,navigateUp:Xt,navigateDown:Jt,navigatePrev:$e,navigateNext:Zt,navigateFragment:N.goto.bind(N),prevFragment:N.prev.bind(N),nextFragment:N.next.bind(N),on:de,off:ue,addEventListener:de,removeEventListener:ue,layout:vt,shuffle:Kt,availableRoutes:st,availableFragments:N.availableRoutes.bind(N),toggleHelp:W.toggleHelp.bind(W),toggleOverview:O.toggle.bind(O),toggleScrollView:f.toggle.bind(f),togglePause:we,toggleAutoSlide:function(d){typeof d=="boolean"?d?It():Lt():M?It():Lt()},toggleJumpToSlide:function(d){typeof d=="boolean"?d?B.show():B.hide():B.isVisible()?B.hide():B.show()},isFirstSlide:be,isLastSlide:Wt,isLastVerticalSlide:ve,isVerticalSlide:St,isVerticalStack:function(d=s){return d.classList.contains(".stack")||d.querySelector("section")!==null},isPaused:xt,isAutoSliding:function(){return!(!x||M)},isSpeakerNotes:tt.isSpeakerNotesWindow.bind(tt),isOverview:O.isActive.bind(O),isFocused:pt.isFocused.bind(pt),isOverlayOpen:W.isOpen.bind(W),isScrollView:f.isActive.bind(f),isPrintView:I.isActive.bind(I),isReady:()=>h,loadSlide:R.load.bind(R),unloadSlide:R.unload.bind(R),startEmbeddedContent:()=>R.startEmbeddedContent(s),stopEmbeddedContent:()=>R.stopEmbeddedContent(s,{unloadIframes:!1}),previewIframe:W.previewIframe.bind(W),previewImage:W.previewImage.bind(W),previewVideo:W.previewVideo.bind(W),showPreview:W.previewIframe.bind(W),hidePreview:W.close.bind(W),addEventListeners:ce,removeEventListeners:Rt,dispatchEvent:Q,getState:Ne,setState:function(d){if(typeof d=="object"){nt(yt(d.indexh),yt(d.indexv),yt(d.indexf));let m=yt(d.paused),b=yt(d.overview);typeof m=="boolean"&&m!==xt()&&we(m),typeof b=="boolean"&&b!==O.isActive()&&O.toggle(b),W.setState(d)}},getProgress:function(){let d=Ie(),m=Ae();if(s){let b=s.querySelectorAll(".fragment");b.length>0&&(m+=s.querySelectorAll(".fragment.visible").length/b.length*.9)}return Math.min(m/(d-1),1)},getIndices:Re,getSlidesAttributes:function(){return Yt().map((d=>{let m={};for(let b=0;b<d.attributes.length;b++){let w=d.attributes[b];m[w.name]=w.value}return m}))},getSlidePastCount:Ae,getTotalSlides:Ie,getSlide:Pe,getPreviousSlide:()=>a,getCurrentSlide:()=>s,getSlideBackground:function(d,m){let b=typeof d=="number"?Pe(d,m):d;if(b)return b.slideBackgroundElement},getSlideNotes:tt.getSlideNotes.bind(tt),getSlides:Yt,getHorizontalSlides:ot,getVerticalSlides:Te,hasHorizontalSlides:Ce,hasVerticalSlides:Le,hasNavigatedHorizontally:()=>u.hasNavigatedHorizontally,hasNavigatedVertically:()=>u.hasNavigatedVertically,shouldAutoAnimateBetween:Vt,addKeyBinding:_.addKeyBinding.bind(_),removeKeyBinding:_.removeKeyBinding.bind(_),triggerKey:_.triggerKey.bind(_),registerKeyboardShortcut:_.registerKeyboardShortcut.bind(_),getComputedSlideSize:Tt,setCurrentScrollPage:function(d,m,b){let w=n||0;n=m,i=b;const k=s!==d;a=s,s=d,s&&a&&o.autoAnimate&&Vt(a,s,w,i)&&U.run(a,s),k&&(a&&(R.stopEmbeddedContent(a),R.stopEmbeddedContent(a.slideBackgroundElement)),R.startEmbeddedContent(s),R.startEmbeddedContent(s.slideBackgroundElement)),requestAnimationFrame((()=>{_t(At(s))})),he()},getScale:()=>v,getConfig:()=>o,getQueryHash:qe,getSlidePath:V.getHash.bind(V),getRevealElement:()=>r,getSlidesElement:()=>p.slides,getViewportElement:()=>p.viewport,getBackgroundsElement:()=>P.element,registerPlugin:et.registerPlugin.bind(et),hasPlugin:et.hasPlugin.bind(et),getPlugin:et.getPlugin.bind(et),getPlugins:et.getRegisteredPlugins.bind(et)};return wt(e,{...De,announceStatus:_t,getStatusText:At,focus:pt,scroll:f,progress:at,controls:K,location:V,overview:O,keyboard:_,fragments:N,backgrounds:P,slideContent:R,slideNumber:E,onUserInput:function(d){o.autoSlideStoppable&&Lt()},closeOverlay:W.close.bind(W),updateSlidesVisibility:Gt,layoutSlideContents:ge,transformSlides:Ut,cueAutoSlide:bt,cancelAutoSlide:Ct}),De}let it=on,We=[];it.initialize=r=>(Object.assign(it,new on(document.querySelector(".reveal"),r)),We.map((t=>t(it))),it.initialize()),["configure","on","off","addEventListener","removeEventListener","registerPlugin"].forEach((r=>{it[r]=(...t)=>{We.push((e=>e[r].call(null,...t)))}})),it.isReady=()=>!1,it.VERSION=rn;function Gn(){return{async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1}}let ft={async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1};const ln=/[&<>"']/,Yn=new RegExp(ln.source,"g"),cn=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,Xn=new RegExp(cn.source,"g"),Jn={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Ve=r=>Jn[r];function Y(r,t){if(t){if(ln.test(r))return r.replace(Yn,Ve)}else if(cn.test(r))return r.replace(Xn,Ve);return r}const Zn=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi;function dn(r){return r.replace(Zn,((t,e)=>(e=e.toLowerCase())==="colon"?":":e.charAt(0)==="#"?e.charAt(1)==="x"?String.fromCharCode(parseInt(e.substring(2),16)):String.fromCharCode(+e.substring(1)):""))}const Qn=/(^|[^\[])\^/g;function H(r,t){r=typeof r=="string"?r:r.source,t=t||"";const e={replace:(n,i)=>(i=(i=i.source||i).replace(Qn,"$1"),r=r.replace(n,i),e),getRegex:()=>new RegExp(r,t)};return e}const ti=/[^\w:]/g,ei=/^$|^[a-z][a-z0-9+.-]*:|^[?#]/i;function Ke(r,t,e){if(r){let n;try{n=decodeURIComponent(dn(e)).replace(ti,"").toLowerCase()}catch{return null}if(n.indexOf("javascript:")===0||n.indexOf("vbscript:")===0||n.indexOf("data:")===0)return null}t&&!ei.test(e)&&(e=(function(n,i){Bt[" "+n]||(ni.test(n)?Bt[" "+n]=n+"/":Bt[" "+n]=Ot(n,"/",!0)),n=Bt[" "+n];const a=n.indexOf(":")===-1;return i.substring(0,2)==="//"?a?i:n.replace(ii,"$1")+i:i.charAt(0)==="/"?a?i:n.replace(ai,"$1")+i:n+i})(t,e));try{e=encodeURI(e).replace(/%25/g,"%")}catch{return null}return e}const Bt={},ni=/^[^:]+:\/*[^/]*$/,ii=/^([^:]+:)[\s\S]*$/,ai=/^([^:]+:\/*[^/]*)[\s\S]*$/,Dt={exec:function(){}};function Ge(r,t){const e=r.replace(/\|/g,((i,a,s)=>{let l=!1,o=a;for(;--o>=0&&s[o]==="\\";)l=!l;return l?"|":" |"})).split(/ \|/);let n=0;if(e[0].trim()||e.shift(),e.length>0&&!e[e.length-1].trim()&&e.pop(),e.length>t)e.splice(t);else for(;e.length<t;)e.push("");for(;n<e.length;n++)e[n]=e[n].trim().replace(/\\\|/g,"|");return e}function Ot(r,t,e){const n=r.length;if(n===0)return"";let i=0;for(;i<n;){const a=r.charAt(n-i-1);if(a!==t||e){if(a===t||!e)break;i++}else i++}return r.slice(0,n-i)}function Ye(r,t){if(t<1)return"";let e="";for(;t>1;)1&t&&(e+=r),t>>=1,r+=r;return e+r}function Xe(r,t,e,n){const i=t.href,a=t.title?Y(t.title):null,s=r[1].replace(/\\([\[\]])/g,"$1");if(r[0].charAt(0)!=="!"){n.state.inLink=!0;const l={type:"link",raw:e,href:i,title:a,text:s,tokens:n.inlineTokens(s)};return n.state.inLink=!1,l}return{type:"image",raw:e,href:i,title:a,text:Y(s)}}class ae{constructor(t){this.options=t||ft}space(t){const e=this.rules.block.newline.exec(t);if(e&&e[0].length>0)return{type:"space",raw:e[0]}}code(t){const e=this.rules.block.code.exec(t);if(e){const n=e[0].replace(/^ {1,4}/gm,"");return{type:"code",raw:e[0],codeBlockStyle:"indented",text:this.options.pedantic?n:Ot(n,`
`)}}}fences(t){const e=this.rules.block.fences.exec(t);if(e){const n=e[0],i=(function(a,s){const l=a.match(/^(\s+)(?:```)/);if(l===null)return s;const o=l[1];return s.split(`
`).map((c=>{const h=c.match(/^\s+/);if(h===null)return c;const[u]=h;return u.length>=o.length?c.slice(o.length):c})).join(`
`)})(n,e[3]||"");return{type:"code",raw:n,lang:e[2]?e[2].trim().replace(this.rules.inline._escapes,"$1"):e[2],text:i}}}heading(t){const e=this.rules.block.heading.exec(t);if(e){let n=e[2].trim();if(/#$/.test(n)){const i=Ot(n,"#");this.options.pedantic?n=i.trim():i&&!/ $/.test(i)||(n=i.trim())}return{type:"heading",raw:e[0],depth:e[1].length,text:n,tokens:this.lexer.inline(n)}}}hr(t){const e=this.rules.block.hr.exec(t);if(e)return{type:"hr",raw:e[0]}}blockquote(t){const e=this.rules.block.blockquote.exec(t);if(e){const n=e[0].replace(/^ *>[ \t]?/gm,""),i=this.lexer.state.top;this.lexer.state.top=!0;const a=this.lexer.blockTokens(n);return this.lexer.state.top=i,{type:"blockquote",raw:e[0],tokens:a,text:n}}}list(t){let e=this.rules.block.list.exec(t);if(e){let n,i,a,s,l,o,c,h,u,g,v,L,p=e[1].trim();const F=p.length>1,x={type:"list",raw:"",ordered:F,start:F?+p.slice(0,-1):"",loose:!1,items:[]};p=F?`\\d{1,9}\\${p.slice(-1)}`:`\\${p}`,this.options.pedantic&&(p=F?p:"[*+-]");const q=new RegExp(`^( {0,3}${p})((?:[	 ][^\\n]*)?(?:\\n|$))`);for(;t&&(L=!1,e=q.exec(t))&&!this.rules.block.hr.test(t);){if(n=e[0],t=t.substring(n.length),h=e[2].split(`
`,1)[0].replace(/^\t+/,(M=>" ".repeat(3*M.length))),u=t.split(`
`,1)[0],this.options.pedantic?(s=2,v=h.trimLeft()):(s=e[2].search(/[^ ]/),s=s>4?1:s,v=h.slice(s),s+=e[1].length),o=!1,!h&&/^ *$/.test(u)&&(n+=u+`
`,t=t.substring(u.length+1),L=!0),!L){const M=new RegExp(`^ {0,${Math.min(3,s-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),R=new RegExp(`^ {0,${Math.min(3,s-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),E=new RegExp(`^ {0,${Math.min(3,s-1)}}(?:\`\`\`|~~~)`),B=new RegExp(`^ {0,${Math.min(3,s-1)}}#`);for(;t&&(g=t.split(`
`,1)[0],u=g,this.options.pedantic&&(u=u.replace(/^ {1,4}(?=( {4})*[^ ])/g,"  ")),!E.test(u))&&!B.test(u)&&!M.test(u)&&!R.test(t);){if(u.search(/[^ ]/)>=s||!u.trim())v+=`
`+u.slice(s);else{if(o||h.search(/[^ ]/)>=4||E.test(h)||B.test(h)||R.test(h))break;v+=`
`+u}o||u.trim()||(o=!0),n+=g+`
`,t=t.substring(g.length+1),h=u.slice(s)}}x.loose||(c?x.loose=!0:/\n *\n *$/.test(n)&&(c=!0)),this.options.gfm&&(i=/^\[[ xX]\] /.exec(v),i&&(a=i[0]!=="[ ] ",v=v.replace(/^\[[ xX]\] +/,""))),x.items.push({type:"list_item",raw:n,task:!!i,checked:a,loose:!1,text:v}),x.raw+=n}x.items[x.items.length-1].raw=n.trimRight(),x.items[x.items.length-1].text=v.trimRight(),x.raw=x.raw.trimRight();const X=x.items.length;for(l=0;l<X;l++)if(this.lexer.state.top=!1,x.items[l].tokens=this.lexer.blockTokens(x.items[l].text,[]),!x.loose){const M=x.items[l].tokens.filter((E=>E.type==="space")),R=M.length>0&&M.some((E=>/\n.*\n/.test(E.raw)));x.loose=R}if(x.loose)for(l=0;l<X;l++)x.items[l].loose=!0;return x}}html(t){const e=this.rules.block.html.exec(t);if(e){const n={type:"html",raw:e[0],pre:!this.options.sanitizer&&(e[1]==="pre"||e[1]==="script"||e[1]==="style"),text:e[0]};if(this.options.sanitize){const i=this.options.sanitizer?this.options.sanitizer(e[0]):Y(e[0]);n.type="paragraph",n.text=i,n.tokens=this.lexer.inline(i)}return n}}def(t){const e=this.rules.block.def.exec(t);if(e){const n=e[1].toLowerCase().replace(/\s+/g," "),i=e[2]?e[2].replace(/^<(.*)>$/,"$1").replace(this.rules.inline._escapes,"$1"):"",a=e[3]?e[3].substring(1,e[3].length-1).replace(this.rules.inline._escapes,"$1"):e[3];return{type:"def",tag:n,raw:e[0],href:i,title:a}}}table(t){const e=this.rules.block.table.exec(t);if(e){const n={type:"table",header:Ge(e[1]).map((i=>({text:i}))),align:e[2].replace(/^ *|\| *$/g,"").split(/ *\| */),rows:e[3]&&e[3].trim()?e[3].replace(/\n[ \t]*$/,"").split(`
`):[]};if(n.header.length===n.align.length){n.raw=e[0];let i,a,s,l,o=n.align.length;for(i=0;i<o;i++)/^ *-+: *$/.test(n.align[i])?n.align[i]="right":/^ *:-+: *$/.test(n.align[i])?n.align[i]="center":/^ *:-+ *$/.test(n.align[i])?n.align[i]="left":n.align[i]=null;for(o=n.rows.length,i=0;i<o;i++)n.rows[i]=Ge(n.rows[i],n.header.length).map((c=>({text:c})));for(o=n.header.length,a=0;a<o;a++)n.header[a].tokens=this.lexer.inline(n.header[a].text);for(o=n.rows.length,a=0;a<o;a++)for(l=n.rows[a],s=0;s<l.length;s++)l[s].tokens=this.lexer.inline(l[s].text);return n}}}lheading(t){const e=this.rules.block.lheading.exec(t);if(e)return{type:"heading",raw:e[0],depth:e[2].charAt(0)==="="?1:2,text:e[1],tokens:this.lexer.inline(e[1])}}paragraph(t){const e=this.rules.block.paragraph.exec(t);if(e){const n=e[1].charAt(e[1].length-1)===`
`?e[1].slice(0,-1):e[1];return{type:"paragraph",raw:e[0],text:n,tokens:this.lexer.inline(n)}}}text(t){const e=this.rules.block.text.exec(t);if(e)return{type:"text",raw:e[0],text:e[0],tokens:this.lexer.inline(e[0])}}escape(t){const e=this.rules.inline.escape.exec(t);if(e)return{type:"escape",raw:e[0],text:Y(e[1])}}tag(t){const e=this.rules.inline.tag.exec(t);if(e)return!this.lexer.state.inLink&&/^<a /i.test(e[0])?this.lexer.state.inLink=!0:this.lexer.state.inLink&&/^<\/a>/i.test(e[0])&&(this.lexer.state.inLink=!1),!this.lexer.state.inRawBlock&&/^<(pre|code|kbd|script)(\s|>)/i.test(e[0])?this.lexer.state.inRawBlock=!0:this.lexer.state.inRawBlock&&/^<\/(pre|code|kbd|script)(\s|>)/i.test(e[0])&&(this.lexer.state.inRawBlock=!1),{type:this.options.sanitize?"text":"html",raw:e[0],inLink:this.lexer.state.inLink,inRawBlock:this.lexer.state.inRawBlock,text:this.options.sanitize?this.options.sanitizer?this.options.sanitizer(e[0]):Y(e[0]):e[0]}}link(t){const e=this.rules.inline.link.exec(t);if(e){const n=e[2].trim();if(!this.options.pedantic&&/^</.test(n)){if(!/>$/.test(n))return;const s=Ot(n.slice(0,-1),"\\");if((n.length-s.length)%2==0)return}else{const s=(function(l,o){if(l.indexOf(o[1])===-1)return-1;const c=l.length;let h=0,u=0;for(;u<c;u++)if(l[u]==="\\")u++;else if(l[u]===o[0])h++;else if(l[u]===o[1]&&(h--,h<0))return u;return-1})(e[2],"()");if(s>-1){const l=(e[0].indexOf("!")===0?5:4)+e[1].length+s;e[2]=e[2].substring(0,s),e[0]=e[0].substring(0,l).trim(),e[3]=""}}let i=e[2],a="";if(this.options.pedantic){const s=/^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(i);s&&(i=s[1],a=s[3])}else a=e[3]?e[3].slice(1,-1):"";return i=i.trim(),/^</.test(i)&&(i=this.options.pedantic&&!/>$/.test(n)?i.slice(1):i.slice(1,-1)),Xe(e,{href:i&&i.replace(this.rules.inline._escapes,"$1"),title:a&&a.replace(this.rules.inline._escapes,"$1")},e[0],this.lexer)}}reflink(t,e){let n;if((n=this.rules.inline.reflink.exec(t))||(n=this.rules.inline.nolink.exec(t))){let i=(n[2]||n[1]).replace(/\s+/g," ");if(i=e[i.toLowerCase()],!i){const a=n[0].charAt(0);return{type:"text",raw:a,text:a}}return Xe(n,i,n[0],this.lexer)}}emStrong(t,e,n=""){let i=this.rules.inline.emStrong.lDelim.exec(t);if(!i||i[3]&&n.match(/[\p{L}\p{N}]/u))return;const a=i[1]||i[2]||"";if(!a||a&&(n===""||this.rules.inline.punctuation.exec(n))){const s=i[0].length-1;let l,o,c=s,h=0;const u=i[0][0]==="*"?this.rules.inline.emStrong.rDelimAst:this.rules.inline.emStrong.rDelimUnd;for(u.lastIndex=0,e=e.slice(-1*t.length+s);(i=u.exec(e))!=null;){if(l=i[1]||i[2]||i[3]||i[4]||i[5]||i[6],!l)continue;if(o=l.length,i[3]||i[4]){c+=o;continue}if((i[5]||i[6])&&s%3&&!((s+o)%3)){h+=o;continue}if(c-=o,c>0)continue;o=Math.min(o,o+c+h);const g=t.slice(0,s+i.index+(i[0].length-l.length)+o);if(Math.min(s,o)%2){const L=g.slice(1,-1);return{type:"em",raw:g,text:L,tokens:this.lexer.inlineTokens(L)}}const v=g.slice(2,-2);return{type:"strong",raw:g,text:v,tokens:this.lexer.inlineTokens(v)}}}}codespan(t){const e=this.rules.inline.code.exec(t);if(e){let n=e[2].replace(/\n/g," ");const i=/[^ ]/.test(n),a=/^ /.test(n)&&/ $/.test(n);return i&&a&&(n=n.substring(1,n.length-1)),n=Y(n,!0),{type:"codespan",raw:e[0],text:n}}}br(t){const e=this.rules.inline.br.exec(t);if(e)return{type:"br",raw:e[0]}}del(t){const e=this.rules.inline.del.exec(t);if(e)return{type:"del",raw:e[0],text:e[2],tokens:this.lexer.inlineTokens(e[2])}}autolink(t,e){const n=this.rules.inline.autolink.exec(t);if(n){let i,a;return n[2]==="@"?(i=Y(this.options.mangle?e(n[1]):n[1]),a="mailto:"+i):(i=Y(n[1]),a=i),{type:"link",raw:n[0],text:i,href:a,tokens:[{type:"text",raw:i,text:i}]}}}url(t,e){let n;if(n=this.rules.inline.url.exec(t)){let i,a;if(n[2]==="@")i=Y(this.options.mangle?e(n[0]):n[0]),a="mailto:"+i;else{let s;do s=n[0],n[0]=this.rules.inline._backpedal.exec(n[0])[0];while(s!==n[0]);i=Y(n[0]),a=n[1]==="www."?"http://"+n[0]:n[0]}return{type:"link",raw:n[0],text:i,href:a,tokens:[{type:"text",raw:i,text:i}]}}}inlineText(t,e){const n=this.rules.inline.text.exec(t);if(n){let i;return i=this.lexer.state.inRawBlock?this.options.sanitize?this.options.sanitizer?this.options.sanitizer(n[0]):Y(n[0]):n[0]:Y(this.options.smartypants?e(n[0]):n[0]),{type:"text",raw:n[0],text:i}}}}const C={newline:/^(?: *(?:\n|$))+/,code:/^( {4}[^\n]+(?:\n(?: *(?:\n|$))*)?)+/,fences:/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,hr:/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,heading:/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,blockquote:/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/,list:/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/,html:"^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n *)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n *)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n *)+\\n|$))",def:/^ {0,3}\[(label)\]: *(?:\n *)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n *)?| *\n *)(title))? *(?:\n+|$)/,table:Dt,lheading:/^((?:.|\n(?!\n))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,_paragraph:/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,text:/^[^\n]+/,_label:/(?!\s*\])(?:\\.|[^\[\]\\])+/,_title:/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/};C.def=H(C.def).replace("label",C._label).replace("title",C._title).getRegex(),C.bullet=/(?:[*+-]|\d{1,9}[.)])/,C.listItemStart=H(/^( *)(bull) */).replace("bull",C.bullet).getRegex(),C.list=H(C.list).replace(/bull/g,C.bullet).replace("hr","\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))").replace("def","\\n+(?="+C.def.source+")").getRegex(),C._tag="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",C._comment=/<!--(?!-?>)[\s\S]*?(?:-->|$)/,C.html=H(C.html,"i").replace("comment",C._comment).replace("tag",C._tag).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),C.paragraph=H(C._paragraph).replace("hr",C.hr).replace("heading"," {0,3}#{1,6} ").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",C._tag).getRegex(),C.blockquote=H(C.blockquote).replace("paragraph",C.paragraph).getRegex(),C.normal={...C},C.gfm={...C.normal,table:"^ *([^\\n ].*\\|.*)\\n {0,3}(?:\\| *)?(:?-+:? *(?:\\| *:?-+:? *)*)(?:\\| *)?(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)"},C.gfm.table=H(C.gfm.table).replace("hr",C.hr).replace("heading"," {0,3}#{1,6} ").replace("blockquote"," {0,3}>").replace("code"," {4}[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",C._tag).getRegex(),C.gfm.paragraph=H(C._paragraph).replace("hr",C.hr).replace("heading"," {0,3}#{1,6} ").replace("|lheading","").replace("table",C.gfm.table).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",C._tag).getRegex(),C.pedantic={...C.normal,html:H(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",C._comment).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Dt,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:H(C.normal._paragraph).replace("hr",C.hr).replace("heading",` *#{1,6} *[^
]`).replace("lheading",C.lheading).replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").getRegex()};const S={escape:/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,autolink:/^<(scheme:[^\s\x00-\x1f<>]*|email)>/,url:Dt,tag:"^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>",link:/^!?\[(label)\]\(\s*(href)(?:\s+(title))?\s*\)/,reflink:/^!?\[(label)\]\[(ref)\]/,nolink:/^!?\[(ref)\](?:\[\])?/,reflinkSearch:"reflink|nolink(?!\\()",emStrong:{lDelim:/^(?:\*+(?:([punct_])|[^\s*]))|^_+(?:([punct*])|([^\s_]))/,rDelimAst:/^(?:[^_*\\]|\\.)*?\_\_(?:[^_*\\]|\\.)*?\*(?:[^_*\\]|\\.)*?(?=\_\_)|(?:[^*\\]|\\.)+(?=[^*])|[punct_](\*+)(?=[\s]|$)|(?:[^punct*_\s\\]|\\.)(\*+)(?=[punct_\s]|$)|[punct_\s](\*+)(?=[^punct*_\s])|[\s](\*+)(?=[punct_])|[punct_](\*+)(?=[punct_])|(?:[^punct*_\s\\]|\\.)(\*+)(?=[^punct*_\s])/,rDelimUnd:/^(?:[^_*\\]|\\.)*?\*\*(?:[^_*\\]|\\.)*?\_(?:[^_*\\]|\\.)*?(?=\*\*)|(?:[^_\\]|\\.)+(?=[^_])|[punct*](\_+)(?=[\s]|$)|(?:[^punct*_\s\\]|\\.)(\_+)(?=[punct*\s]|$)|[punct*\s](\_+)(?=[^punct*_\s])|[\s](\_+)(?=[punct*])|[punct*](\_+)(?=[punct*])/},code:/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,br:/^( {2,}|\\)\n(?!\s*$)/,del:Dt,text:/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,punctuation:/^([\spunctuation])/};function si(r){return r.replace(/---/g,"—").replace(/--/g,"–").replace(/(^|[-\u2014/(\[{"\s])'/g,"$1‘").replace(/'/g,"’").replace(/(^|[-\u2014/(\[{\u2018\s])"/g,"$1“").replace(/"/g,"”").replace(/\.{3}/g,"…")}function Je(r){let t,e,n="";const i=r.length;for(t=0;t<i;t++)e=r.charCodeAt(t),Math.random()>.5&&(e="x"+e.toString(16)),n+="&#"+e+";";return n}S._punctuation="!\"#$%&'()+\\-.,/:;<=>?@\\[\\]`^{|}~",S.punctuation=H(S.punctuation).replace(/punctuation/g,S._punctuation).getRegex(),S.blockSkip=/\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g,S.escapedEmSt=/(?:^|[^\\])(?:\\\\)*\\[*_]/g,S._comment=H(C._comment).replace("(?:-->|$)","-->").getRegex(),S.emStrong.lDelim=H(S.emStrong.lDelim).replace(/punct/g,S._punctuation).getRegex(),S.emStrong.rDelimAst=H(S.emStrong.rDelimAst,"g").replace(/punct/g,S._punctuation).getRegex(),S.emStrong.rDelimUnd=H(S.emStrong.rDelimUnd,"g").replace(/punct/g,S._punctuation).getRegex(),S._escapes=/\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g,S._scheme=/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/,S._email=/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/,S.autolink=H(S.autolink).replace("scheme",S._scheme).replace("email",S._email).getRegex(),S._attribute=/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/,S.tag=H(S.tag).replace("comment",S._comment).replace("attribute",S._attribute).getRegex(),S._label=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,S._href=/<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/,S._title=/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/,S.link=H(S.link).replace("label",S._label).replace("href",S._href).replace("title",S._title).getRegex(),S.reflink=H(S.reflink).replace("label",S._label).replace("ref",C._label).getRegex(),S.nolink=H(S.nolink).replace("ref",C._label).getRegex(),S.reflinkSearch=H(S.reflinkSearch,"g").replace("reflink",S.reflink).replace("nolink",S.nolink).getRegex(),S.normal={...S},S.pedantic={...S.normal,strong:{start:/^__|\*\*/,middle:/^__(?=\S)([\s\S]*?\S)__(?!_)|^\*\*(?=\S)([\s\S]*?\S)\*\*(?!\*)/,endAst:/\*\*(?!\*)/g,endUnd:/__(?!_)/g},em:{start:/^_|\*/,middle:/^()\*(?=\S)([\s\S]*?\S)\*(?!\*)|^_(?=\S)([\s\S]*?\S)_(?!_)/,endAst:/\*(?!\*)/g,endUnd:/_(?!_)/g},link:H(/^!?\[(label)\]\((.*?)\)/).replace("label",S._label).getRegex(),reflink:H(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",S._label).getRegex()},S.gfm={...S.normal,escape:H(S.escape).replace("])","~|])").getRegex(),_extended_email:/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/,url:/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])([\s\S]*?[^\s~])\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/},S.gfm.url=H(S.gfm.url,"i").replace("email",S.gfm._extended_email).getRegex(),S.breaks={...S.gfm,br:H(S.br).replace("{2,}","*").getRegex(),text:H(S.gfm.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()};class dt{constructor(t){this.tokens=[],this.tokens.links=Object.create(null),this.options=t||ft,this.options.tokenizer=this.options.tokenizer||new ae,this.tokenizer=this.options.tokenizer,this.tokenizer.options=this.options,this.tokenizer.lexer=this,this.inlineQueue=[],this.state={inLink:!1,inRawBlock:!1,top:!0};const e={block:C.normal,inline:S.normal};this.options.pedantic?(e.block=C.pedantic,e.inline=S.pedantic):this.options.gfm&&(e.block=C.gfm,this.options.breaks?e.inline=S.breaks:e.inline=S.gfm),this.tokenizer.rules=e}static get rules(){return{block:C,inline:S}}static lex(t,e){return new dt(e).lex(t)}static lexInline(t,e){return new dt(e).inlineTokens(t)}lex(t){let e;for(t=t.replace(/\r\n|\r/g,`
...
`+n.raw,i.text+=`
`+n.raw,this.inlineQueue[this.inlineQueue.length-1].src=i.text);else if(n=this.tokenizer.table(t))t=t.substring(n.raw.length),e.push(n);else if(n=this.tokenizer.lheading(t))t=t.substring(n.raw.length),e.push(n);else{if(a=t,this.options.extensions&&this.options.extensions.startBlock){let l=1/0;const o=t.slice(1);let c;this.options.extensions.startBlock.forEach((function(h){c=h.call({lexer:this},o),typeof c=="number"&&c>=0&&(l=Math.min(l,c))})),l<1/0&&l>=0&&(a=t.substring(0,l+1))}if(this.state.top&&(n=this.tokenizer.paragraph(a)))i=e[e.length-1],s&&i.type==="paragraph"?(i.raw+=`
`+n.raw,i.text+=`
...
`+n.raw,i.text+=`
`+n.text,this.inlineQueue.pop(),this.inlineQueue[this.inlineQueue.length-1].src=i.text):e.push(n);else if(t){const l="Infinite loop on byte: "+t.charCodeAt(0);if(this.options.silent){console.error(l);break}throw new Error(l)}}return this.state.top=!0,e}inline(t,e=[]){return this.inlineQueue.push({src:t,tokens:e}),e}inlineTokens(t,e=[]){let n,i,a,s,l,o,c=t;if(this.tokens.links){const h=Object.keys(this.tokens.links);if(h.length>0)for(;(s=this.tokenizer.rules.inline.reflinkSearch.exec(c))!=null;)h.includes(s[0].slice(s[0].lastIndexOf("[")+1,-1))&&(c=c.slice(0,s.index)+"["+Ye("a",s[0].length-2)+"]"+c.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(s=this.tokenizer.rules.inline.blockSkip.exec(c))!=null;)c=c.slice(0,s.index)+"["+Ye("a",s[0].length-2)+"]"+c.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);for(;(s=this.tokenizer.rules.inline.escapedEmSt.exec(c))!=null;)c=c.slice(0,s.index+s[0].length-2)+"++"+c.slice(this.tokenizer.rules.inline.escapedEmSt.lastIndex),this.tokenizer.rules.inline.escapedEmSt.lastIndex--;for(;t;)if(l||(o=""),l=!1,!(this.options.extensions&&this.options.extensions.inline&&this.options.extensions.inline.some((h=>!!(n=h.call({lexer:this},t,e))&&(t=t.substring(n.raw.length),e.push(n),!0)))))if(n=this.tokenizer.escape(t))t=t.substring(n.raw.length),e.push(n);else if(n=this.tokenizer.tag(t))t=t.substring(n.raw.length),i=e[e.length-1],i&&n.type==="text"&&i.type==="text"?(i.raw+=n.raw,i.text+=n.text):e.push(n);else if(n=this.tokenizer.link(t))t=t.substring(n.raw.length),e.push(n);else if(n=this.tokenizer.reflink(t,this.tokens.links))t=t.substring(n.raw.length),i=e[e.length-1],i&&n.type==="text"&&i.type==="text"?(i.raw+=n.raw,i.text+=n.text):e.push(n);else if(n=this.tokenizer.emStrong(t,c,o))t=t.substring(n.raw.length),e.push(n);else if(n=this.tokenizer.codespan(t))t=t.substring(n.raw.length),e.push(n);else if(n=this.tokenizer.br(t))t=t.substring(n.raw.length),e.push(n);else if(n=this.tokenizer.del(t))t=t.substring(n.raw.length),e.push(n);else if(n=this.tokenizer.autolink(t,Je))t=t.substring(n.raw.length),e.push(n);else if(this.state.inLink||!(n=this.tokenizer.url(t,Je))){if(a=t,this.options.extensions&&this.options.extensions.startInline){let h=1/0;const u=t.slice(1);let g;this.options.extensions.startInline.forEach((function(v){g=v.call({lexer:this},u),typeof g=="number"&&g>=0&&(h=Math.min(h,g))})),h<1/0&&h>=0&&(a=t.substring(0,h+1))}if(n=this.tokenizer.inlineText(a,si))t=t.substring(n.raw.length),n.raw.slice(-1)!=="_"&&(o=n.raw.slice(-1)),l=!0,i=e[e.length-1],i&&i.type==="text"?(i.raw+=n.raw,i.text+=n.text):e.push(n);else if(t){const h="Infinite loop on byte: "+t.charCodeAt(0);if(this.options.silent){console.error(h);break}throw new Error(h)}}else t=t.substring(n.raw.length),e.push(n);return e}}class se{constructor(t){this.options=t||ft}code(t,e,n){const i=(e||"").match(/\S*/)[0];if(this.options.highlight){const a=this.options.highlight(t,i);a!=null&&a!==t&&(n=!0,t=a)}return t=t.replace(/\n$/,"")+`
...
`}strong(t){return`<strong>${t}</strong>`}em(t){return`<em>${t}</em>`}codespan(t){return`<code>${t}</code>`}br(){return this.options.xhtml?"<br/>":"<br>"}del(t){return`<del>${t}</del>`}link(t,e,n){if((t=Ke(this.options.sanitize,this.options.baseUrl,t))===null)return n;let i='<a href="'+t+'"';return e&&(i+=' title="'+e+'"'),i+=">"+n+"</a>",i}image(t,e,n){if((t=Ke(this.options.sanitize,this.options.baseUrl,t))===null)return n;let i=`<img src="${t}" alt="${n}"`;return e&&(i+=` title="${e}"`),i+=this.options.xhtml?"/>":">",i}text(t){return t}}class un{strong(t){return t}em(t){return t}codespan(t){return t}del(t){return t}html(t){return t}text(t){return t}link(t,e,n){return""+n}image(t,e,n){return""+n}br(){return""}}class hn{constructor(){this.seen={}}serialize(t){return t.toLowerCase().trim().replace(/<[!\/a-z].*?>/gi,"").replace(/[\u2000-\u206F\u2E00-\u2E7F\\'!"#$%&()*+,./:;<=>?@[\]^`{|}~]/g,"").replace(/\s/g,"-")}getNextSafeSlug(t,e){let n=t,i=0;if(this.seen.hasOwnProperty(n)){i=this.seen[t];do i++,n=t+"-"+i;while(this.seen.hasOwnProperty(n))}return e||(this.seen[t]=i,this.seen[n]=0),n}slug(t,e={}){const n=this.serialize(t);return this.getNextSafeSlug(n,e.dryrun)}}class ut{constructor(t){this.options=t||ft,this.options.renderer=this.options.renderer||new se,this.renderer=this.options.renderer,this.renderer.options=this.options,this.textRenderer=new un,this.slugger=new hn}static parse(t,e){return new ut(e).parse(t)}static parseInline(t,e){return new ut(e).parseInline(t)}parse(t,e=!0){let n,i,a,s,l,o,c,h,u,g,v,L,p,F,x,q,X,M,R,E="";const B=t.length;for(n=0;n<B;n++)if(g=t[n],this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[g.type]&&(R=this.options.extensions.renderers[g.type].call({parser:this},g),R!==!1||!["space","hr","heading","code","table","blockquote","list","html","paragraph","text"].includes(g.type)))E+=R||"";else switch(g.type){case"space":continue;case"hr":E+=this.renderer.hr();continue;case"heading":E+=this.renderer.heading(this.parseInline(g.tokens),g.depth,dn(this.parseInline(g.tokens,this.textRenderer)),this.slugger);continue;case"code":E+=this.renderer.code(g.text,g.lang,g.escaped);continue;case"table":for(h="",c="",s=g.header.length,i=0;i<s;i++)c+=this.renderer.tablecell(this.parseInline(g.header[i].tokens),{header:!0,align:g.align[i]});for(h+=this.renderer.tablerow(c),u="",s=g.rows.length,i=0;i<s;i++){for(o=g.rows[i],c="",l=o.length,a=0;a<l;a++)c+=this.renderer.tablecell(this.parseInline(o[a].tokens),{header:!1,align:g.align[a]});u+=this.renderer.tablerow(c)}E+=this.renderer.table(h,u);continue;case"blockquote":u=this.parse(g.tokens),E+=this.renderer.blockquote(u);continue;case"list":for(v=g.ordered,L=g.start,p=g.loose,s=g.items.length,u="",i=0;i<s;i++)x=g.items[i],q=x.checked,X=x.task,F="",x.task&&(M=this.renderer.checkbox(q),p?x.tokens.length>0&&x.tokens[0].type==="paragraph"?(x.tokens[0].text=M+" "+x.tokens[0].text,x.tokens[0].tokens&&x.tokens[0].tokens.length>0&&x.tokens[0].tokens[0].type==="text"&&(x.tokens[0].tokens[0].text=M+" "+x.tokens[0].tokens[0].text)):x.tokens.unshift({type:"text",text:M}):F+=M),F+=this.parse(x.tokens,p),u+=this.renderer.listitem(F,X,q);E+=this.renderer.list(u,v,L);continue;case"html":E+=this.renderer.html(g.text);continue;case"paragraph":E+=this.renderer.paragraph(this.parseInline(g.tokens));continue;case"text":for(u=g.tokens?this.parseInline(g.tokens):g.text;n+1<B&&t[n+1].type==="text";)g=t[++n],u+=`
`+(g.tokens?this.parseInline(g.tokens):g.text);E+=e?this.renderer.paragraph(u):u;continue;default:{const U='Token with "'+g.type+'" type was not found.';if(this.options.silent)return void console.error(U);throw new Error(U)}}return E}parseInline(t,e){e=e||this.renderer;let n,i,a,s="";const l=t.length;for(n=0;n<l;n++)if(i=t[n],this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[i.type]&&(a=this.options.extensions.renderers[i.type].call({parser:this},i),a!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(i.type)))s+=a||"";else switch(i.type){case"escape":case"text":s+=e.text(i.text);break;case"html":s+=e.html(i.text);break;case"link":s+=e.link(i.href,i.title,this.parseInline(i.tokens,e));break;case"image":s+=e.image(i.href,i.title,i.text);break;case"strong":s+=e.strong(this.parseInline(i.tokens,e));break;case"em":s+=e.em(this.parseInline(i.tokens,e));break;case"codespan":s+=e.codespan(i.text);break;case"br":s+=e.br();break;case"del":s+=e.del(this.parseInline(i.tokens,e));break;default:{const o='Token with "'+i.type+'" type was not found.';if(this.options.silent)return void console.error(o);throw new Error(o)}}return s}}class zt{constructor(t){this.options=t||ft}preprocess(t){return t}postprocess(t){return t}}Qt(zt,"passThroughHooks",new Set(["preprocess","postprocess"]));function pn(r,t){return(e,n,i)=>{typeof n=="function"&&(i=n,n=null);const a={...n},s=(function(l,o,c){return h=>{if(h.message+=`
Please report this to https://github.com/markedjs/marked.`,l){const u="<p>An error occurred:</p><pre>"+Y(h.message+"",!0)+"</pre>";return o?Promise.resolve(u):c?void c(null,u):u}if(o)return Promise.reject(h);if(!c)throw h;c(h)}})((n={...T.defaults,...a}).silent,n.async,i);if(e==null)return s(new Error("marked(): input parameter is undefined or null"));if(typeof e!="string")return s(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(e)+", string expected"));if((function(l){l&&l.sanitize&&!l.silent&&console.warn("marked(): sanitize and sanitizer parameters are deprecated since version 0.7.0, should not be used and will be removed in the future. Read more here: https://marked.js.org/#/USING_ADVANCED.md#options")})(n),n.hooks&&(n.hooks.options=n),i){const l=n.highlight;let o;try{n.hooks&&(e=n.hooks.preprocess(e)),o=r(e,n)}catch(u){return s(u)}const c=function(u){let g;if(!u)try{n.walkTokens&&T.walkTokens(o,n.walkTokens),g=t(o,n),n.hooks&&(g=n.hooks.postprocess(g))}catch(v){u=v}return n.highlight=l,u?s(u):i(null,g)};if(!l||l.length<3||(delete n.highlight,!o.length))return c();let h=0;return T.walkTokens(o,(function(u){u.type==="code"&&(h++,setTimeout((()=>{l(u.text,u.lang,(function(g,v){if(g)return c(g);v!=null&&v!==u.text&&(u.text=v,u.escaped=!0),h--,h===0&&c()}))}),0))})),void(h===0&&c())}if(n.async)return Promise.resolve(n.hooks?n.hooks.preprocess(e):e).then((l=>r(l,n))).then((l=>n.walkTokens?Promise.all(T.walkTokens(l,n.walkTokens)).then((()=>l)):l)).then((l=>t(l,n))).then((l=>n.hooks?n.hooks.postprocess(l):l)).catch(s);try{n.hooks&&(e=n.hooks.preprocess(e));const l=r(e,n);n.walkTokens&&T.walkTokens(l,n.walkTokens);let o=t(l,n);return n.hooks&&(o=n.hooks.postprocess(o)),o}catch(l){return s(l)}}}function T(r,t,e){return pn(dt.lex,ut.parse)(r,t,e)}T.options=T.setOptions=function(r){var t;return T.defaults={...T.defaults,...r},t=T.defaults,ft=t,T},T.getDefaults=Gn,T.defaults=ft,T.use=function(...r){const t=T.defaults.extensions||{renderers:{},childTokens:{}};r.forEach((e=>{const n={...e};if(n.async=T.defaults.async||n.async||!1,e.extensions&&(e.extensions.forEach((i=>{if(!i.name)throw new Error("extension name required");if(i.renderer){const a=t.renderers[i.name];t.renderers[i.name]=a?function(...s){let l=i.renderer.apply(this,s);return l===!1&&(l=a.apply(this,s)),l}:i.renderer}if(i.tokenizer){if(!i.level||i.level!=="block"&&i.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");t[i.level]?t[i.level].unshift(i.tokenizer):t[i.level]=[i.tokenizer],i.start&&(i.level==="block"?t.startBlock?t.startBlock.push(i.start):t.startBlock=[i.start]:i.level==="inline"&&(t.startInline?t.startInline.push(i.start):t.startInline=[i.start]))}i.childTokens&&(t.childTokens[i.name]=i.childTokens)})),n.extensions=t),e.renderer){const i=T.defaults.renderer||new se;for(const a in e.renderer){const s=i[a];i[a]=(...l)=>{let o=e.renderer[a].apply(i,l);return o===!1&&(o=s.apply(i,l)),o}}n.renderer=i}if(e.tokenizer){const i=T.defaults.tokenizer||new ae;for(const a in e.tokenizer){const s=i[a];i[a]=(...l)=>{let o=e.tokenizer[a].apply(i,l);return o===!1&&(o=s.apply(i,l)),o}}n.tokenizer=i}if(e.hooks){const i=T.defaults.hooks||new zt;for(const a in e.hooks){const s=i[a];zt.passThroughHooks.has(a)?i[a]=l=>{if(T.defaults.async)return Promise.resolve(e.hooks[a].call(i,l)).then((c=>s.call(i,c)));const o=e.hooks[a].call(i,l);return s.call(i,o)}:i[a]=(...l)=>{let o=e.hooks[a].apply(i,l);return o===!1&&(o=s.apply(i,l)),o}}n.hooks=i}if(e.walkTokens){const i=T.defaults.walkTokens;n.walkTokens=function(a){let s=[];return s.push(e.walkTokens.call(this,a)),i&&(s=s.concat(i.call(this,a))),s}}T.setOptions(n)}))},T.walkTokens=function(r,t){let e=[];for(const n of r)switch(e=e.concat(t.call(T,n)),n.type){case"table":for(const i of n.header)e=e.concat(T.walkTokens(i.tokens,t));for(const i of n.rows)for(const a of i)e=e.concat(T.walkTokens(a.tokens,t));break;case"list":e=e.concat(T.walkTokens(n.items,t));break;default:T.defaults.extensions&&T.defaults.extensions.childTokens&&T.defaults.extensions.childTokens[n.type]?T.defaults.extensions.childTokens[n.type].forEach((function(i){e=e.concat(T.walkTokens(n[i],t))})):n.tokens&&(e=e.concat(T.walkTokens(n.tokens,t)))}return e},T.parseInline=pn(dt.lexInline,ut.parseInline),T.Parser=ut,T.parser=ut.parse,T.Renderer=se,T.TextRenderer=un,T.Lexer=dt,T.lexer=dt.lex,T.Tokenizer=ae,T.Slugger=hn,T.Hooks=zt,T.parse=T,T.options,T.setOptions,T.use,T.walkTokens,T.parseInline,ut.parse,dt.lex;const ri=()=>{let r,t,e=null;function n(){if(e&&!e.closed)e.focus();else{if(e=window.open("about:blank","reveal.js - Notes","width=1100,height=700"),e.marked=T,e.document.write(`<!--
...
</html>`),!e)return void alert("Speaker view popup failed to open. Please make sure popups are allowed and reopen the speaker view.");(function(){const l=t.getConfig().url,o=typeof l=="string"?l:window.location.protocol+"//"+window.location.host+window.location.pathname+window.location.search;r=setInterval((function(){e.postMessage(JSON.stringify({namespace:"reveal-notes",type:"connect",state:t.getState(),url:o}),"*")}),500),window.addEventListener("message",a)})()}}function i(l){let o=t.getCurrentSlide(),c=o.querySelectorAll("aside.notes"),h=o.querySelector(".current-fragment"),u={namespace:"reveal-notes",type:"state",notes:"",markdown:!1,whitespace:"normal",state:t.getState()};if(o.hasAttribute("data-notes")&&(u.notes=o.getAttribute("data-notes"),u.whitespace="pre-wrap"),h){let g=h.querySelector("aside.notes");g?(u.notes=g.innerHTML,u.markdown=typeof g.getAttribute("data-markdown")=="string",c=null):h.hasAttribute("data-notes")&&(u.notes=h.getAttribute("data-notes"),u.whitespace="pre-wrap",c=null)}c&&c.length&&(c=Array.from(c).filter((g=>g.closest(".fragment")===null)),u.notes=c.map((g=>g.innerHTML)).join(`
`),u.markdown=c[0]&&typeof c[0].getAttribute("data-markdown")=="string"),e.postMessage(JSON.stringify(u),"*")}function a(l){if((function(o){try{return window.location.origin===o.source.location.origin}catch{return!1}})(l))try{let o=JSON.parse(l.data);o&&o.namespace==="reveal-notes"&&o.type==="connected"?(clearInterval(r),s()):o&&o.namespace==="reveal-notes"&&o.type==="call"&&(function(c,h,u){let g=t[c].apply(t,h);e.postMessage(JSON.stringify({namespace:"reveal-notes",type:"return",result:g,callId:u}),"*")})(o.methodName,o.arguments,o.callId)}catch{}}function s(){t.on("slidechanged",i),t.on("fragmentshown",i),t.on("fragmenthidden",i),t.on("overviewhidden",i),t.on("overviewshown",i),t.on("paused",i),t.on("resumed",i),t.on("previewiframe",i),t.on("previewimage",i),t.on("previewvideo",i),t.on("closeoverlay",i),i()}return{id:"notes",init:function(l){t=l,/receiver/i.test(window.location.search)||(window.location.search.match(/(\?|\&)notes/gi)!==null?n():window.addEventListener("message",(o=>{if(!e&&typeof o.data=="string"){let h;try{h=JSON.parse(o.data)}catch{}h&&h.namespace==="reveal-notes"&&h.type==="heartbeat"&&(c=o.source,e&&!e.closed?e.focus():(e=c,window.addEventListener("message",a),s()))}var c})),t.addKeyBinding({keyCode:83,key:"S",description:"Speaker notes view"},(function(){n()})))},open:n}};/*!
 * Handles finding a text string anywhere in the slides and showing the next occurrence to the user
 * by navigatating to that slide and highlighting it.
 *
 * @author Jon Snyder <snyder.jon@gmail.com>, February 2013
 */const oi=()=>{let r,t,e,n,i,a,s;function l(){t=document.createElement("div"),t.classList.add("searchbox"),t.style.position="absolute",t.style.top="10px",t.style.right="10px",t.style.zIndex=10,t.innerHTML=`<input type="search" class="searchinput" placeholder="Search..." style="vertical-align: top;"/>
		</span>`,e=t.querySelector(".searchinput"),e.style.width="240px",e.style.fontSize="14px",e.style.padding="4px 6px",e.style.color="#000",e.style.background="#fff",e.style.borderRadius="2px",e.style.border="0",e.style.outline="0",e.style.boxShadow="0 2px 18px rgba(0, 0, 0, 0.2)",e.style["-webkit-appearance"]="none",r.getRevealElement().appendChild(t),e.addEventListener("keyup",(function(g){g.keyCode===13?(g.preventDefault(),(function(){if(a){var v=e.value;v===""?(s&&s.remove(),n=null):(s=new u("slidecontent"),n=s.apply(v),i=0)}n&&(n.length&&n.length<=i&&(i=0),n.length>i&&(r.slide(n[i].h,n[i].v),i++))})(),a=!1):a=!0}),!1),c()}function o(){t||l(),t.style.display="inline",e.focus(),e.select()}function c(){t||l(),t.style.display="none",s&&s.remove()}function h(){t||l(),t.style.display!=="inline"?o():c()}function u(g,v){var L=document.getElementById(g)||document.body,p=v||"EM",F=new RegExp("^(?:"+p+"|SCRIPT|FORM)$"),x=["#ff6","#a0ffff","#9f9","#f99","#f6f"],q=[],X=0,M="",R=[];this.setRegex=function(E){E=E.trim(),M=new RegExp("("+E+")","i")},this.getRegex=function(){return M.toString().replace(/^\/\\b\(|\)\\b\/i$/g,"").replace(/\|/g," ")},this.hiliteWords=function(E){if(E!=null&&E&&M&&!F.test(E.nodeName)){if(E.hasChildNodes())for(var B=0;B<E.childNodes.length;B++)this.hiliteWords(E.childNodes[B]);var U,P;if(E.nodeType==3&&(U=E.nodeValue)&&(P=M.exec(U))){for(var f=E;f!=null&&f.nodeName!="SECTION";)f=f.parentNode;var I=r.getIndices(f),N=R.length,O=!1;for(B=0;B<N;B++)R[B].h===I.h&&R[B].v===I.v&&(O=!0);O||R.push(I),q[P[0].toLowerCase()]||(q[P[0].toLowerCase()]=x[X++%x.length]);var _=document.createElement(p);_.appendChild(document.createTextNode(P[0])),_.style.backgroundColor=q[P[0].toLowerCase()],_.style.fontStyle="inherit",_.style.color="#000";var V=E.splitText(P.index);V.nodeValue=V.nodeValue.substring(P[0].length),E.parentNode.insertBefore(_,V)}}},this.remove=function(){for(var E,B=document.getElementsByTagName(p);B.length&&(E=B[0]);)E.parentNode.replaceChild(E.firstChild,E)},this.apply=function(E){if(E!=null&&E)return this.remove(),this.setRegex(E),this.hiliteWords(L),R}}return{id:"search",init:g=>{r=g,r.registerKeyboardShortcut("CTRL + Shift + F","Search"),document.addEventListener("keydown",(function(v){v.key=="F"&&(v.ctrlKey||v.metaKey)&&(v.preventDefault(),h())}),!1)},open:o,close:c,toggle:h}};/*!
 * reveal.js Zoom plugin
 */const li={id:"zoom",init:function(r){r.getRevealElement().addEventListener("mousedown",(function(t){var e=/Linux/.test(window.navigator.platform)?"ctrl":"alt",n=(r.getConfig().zoomKey?r.getConfig().zoomKey:e)+"Key",i=r.getConfig().zoomLevel?r.getConfig().zoomLevel:2;t[n]&&!r.isOverview()&&(t.preventDefault(),qt.to({x:t.clientX,y:t.clientY,scale:i,pan:!1}))}))},destroy:()=>{qt.reset()}};var ci=()=>li,qt=(function(){var r=1,t=0,e=0,n=-1,i=-1,a="transform"in document.body.style;function s(c,h){var u=o();if(c.width=c.width||1,c.height=c.height||1,c.x-=(window.innerWidth-c.width*h)/2,c.y-=(window.innerHeight-c.height*h)/2,a)if(h===1)document.body.style.transform="";else{var g=u.x+"px "+u.y+"px",v="translate("+-c.x+"px,"+-c.y+"px) scale("+h+")";document.body.style.transformOrigin=g,document.body.style.transform=v}else h===1?(document.body.style.position="",document.body.style.left="",document.body.style.top="",document.body.style.width="",document.body.style.height="",document.body.style.zoom=""):(document.body.style.position="relative",document.body.style.left=-(u.x+c.x)/h+"px",document.body.style.top=-(u.y+c.y)/h+"px",document.body.style.width=100*h+"%",document.body.style.height=100*h+"%",document.body.style.zoom=h);r=h,document.documentElement.classList&&(r!==1?document.documentElement.classList.add("zoomed"):document.documentElement.classList.remove("zoomed"))}function l(){var c=.12*window.innerWidth,h=.12*window.innerHeight,u=o();e<h?window.scroll(u.x,u.y-14/r*(1-e/h)):e>window.innerHeight-h&&window.scroll(u.x,u.y+(1-(window.innerHeight-e)/h)*(14/r)),t<c?window.scroll(u.x-14/r*(1-t/c),u.y):t>window.innerWidth-c&&window.scroll(u.x+(1-(window.innerWidth-t)/c)*(14/r),u.y)}function o(){return{x:window.scrollX!==void 0?window.scrollX:window.pageXOffset,y:window.scrollY!==void 0?window.scrollY:window.pageYOffset}}return a&&(document.body.style.transition="transform 0.8s ease"),document.addEventListener("keyup",(function(c){r!==1&&c.keyCode===27&&qt.out()})),document.addEventListener("mousemove",(function(c){r!==1&&(t=c.clientX,e=c.clientY)})),{to:function(c){if(r!==1)qt.out();else{if(c.x=c.x||0,c.y=c.y||0,c.element){var h=c.element.getBoundingClientRect();c.x=h.left-20,c.y=h.top-20,c.width=h.width+40,c.height=h.height+40}c.width!==void 0&&c.height!==void 0&&(c.scale=Math.max(Math.min(window.innerWidth/c.width,window.innerHeight/c.height),1)),c.scale>1&&(c.x*=c.scale,c.y*=c.scale,s(c,c.scale),c.pan!==!1&&(n=setTimeout((function(){i=setInterval(l,1e3/60)}),800)))}},out:function(){clearTimeout(n),clearInterval(i),s({x:0,y:0},1),r=1},magnify:function(c){this.to(c)},reset:function(){this.out()},zoomLevel:function(){return r}}})();/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const gn=(r,t,e=[])=>{const n=document.createElementNS("http://www.w3.org/2000/svg",r);return Object.keys(t).forEach(i=>{n.setAttribute(i,String(t[i]))}),e.length&&e.forEach(i=>{const a=gn(...i);n.appendChild(a)}),n};var di=([r,t,e])=>gn(r,t,e);/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ui=r=>Array.from(r.attributes).reduce((t,e)=>(t[e.name]=e.value,t),{}),hi=r=>typeof r=="string"?r:!r||!r.class?"":r.class&&typeof r.class=="string"?r.class.split(" "):r.class&&Array.isArray(r.class)?r.class:"",pi=r=>r.flatMap(hi).map(e=>e.trim()).filter(Boolean).filter((e,n,i)=>i.indexOf(e)===n).join(" "),gi=r=>r.replace(/(\w)(\w*)(_|-|\s*)/g,(t,e,n)=>e.toUpperCase()+n.toLowerCase()),Ze=(r,{nameAttr:t,icons:e,attrs:n})=>{const i=r.getAttribute(t);if(i==null)return;const a=gi(i),s=e[a];if(!s)return console.warn(`${r.outerHTML} icon name was not found in the provided icons object.`);const l=ui(r),[o,c,h]=s,u={...c,"data-lucide":i,...n,...l},g=pi(["lucide",`lucide-${i}`,l,n]);g&&Object.assign(u,{class:g});const v=di([o,u,h]);return r.parentNode?.replaceChild(v,r)};/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
lucide.createIcons({icons});\``);if(typeof document>"u")throw new Error("`createIcons()` only works in a browser environment.");const n=document.querySelectorAll(`[${t}]`);if(Array.from(n).forEach(i=>Ze(i,{nameAttr:t,icons:r,attrs:e})),t==="data-lucide"){const i=document.querySelectorAll("[icon-name]");i.length>0&&(console.warn("[Lucide] Some icons were found with the now deprecated icon-name attribute. These will still be replaced for backwards compatibility, but will no longer be supported in v1.0 and you should switch to data-lucide"),Array.from(i).forEach(a=>Ze(a,{nameAttr:"icon-name",icons:r,attrs:e})))}},xi={problem:"Many growing companies have finance, stock, sales, purchasing, and operations running on different versions of the truth.",solution:"I help them map the business process, choose the right ERPNext/BirdTec/custom-system approach, and connect it into one reliable operating model.",request:"This month, please introduce me to an owner, CFO, or COO whose business has changed faster than their systems can adapt."},Ai=JSON.parse(`[{"id":"identity","code":"[01 / IDENTITY]","title":"Arvy Budiarto","subtitle":"ERPNext and business systems that grow with your business.","kicker":"AGILE TECHNICA","layout":"hero","brandIds":["agile-technica","bni-firefly"],"component":"pillars","pillars":[{"label":"ERP System Implementation, powered by ERPNext","icon":"database"},{"label":"Digital Transformation","icon":"refresh-cw"},{"label":"Poultry Management Systems","icon":"bird"},{"label":"HR","icon":"users"},{"label":"CRM","icon":"contact-round"}],"mode":"all"},{"id":"problem","code":"[02 / PROBLEM]","title":"Business growth is great. But your systems must keep up.","subtitle":"More branches, products, channels, warehouses, and people create new ways of working.","layout":"visual-story","component":"illustration","illustrationId":"growth-outpaces-systems","mode":"feature"},{"id":"problem-truths","code":"[02A / DIFFERENT TRUTHS]","title":"Then every team sees a different truth.","subtitle":"Warehouse, finance, and management start defending different numbers.","layout":"visual-story","component":"illustration","illustrationId":"different-truths","mode":"feature"},{"id":"problem-pain","code":"[02B / THE PAIN]","title":"The pain appears in daily work.","subtitle":"Duplicate entry. Late reports. Missing stock. Money leakage. Weak controls.","layout":"visual-story","component":"illustration","illustrationId":"systems-pain","mode":"feature"},{"id":"problem-fraud","code":"[02C / INTERNAL FRAUD]","title":"Weak controls create room for internal fraud.","subtitle":"Fake transactions. Inflated material and equipment purchases. Kickbacks. Company money redirected for personal gain.","layout":"visual-story","component":"illustration","illustrationId":"internal-fraud","mode":"feature"},{"id":"gains-goals-main","code":"[G / GOALS]","title":"What I'm building.","subtitle":"Businesses where management, finance, stock, sales, and operations work from the same reality.","component":"gains","gainsSection":"goals","labelsOnly":true,"hideSectionTitle":true,"brandIds":["agile-technica"],"mode":"feature","verticals":[{"id":"erpnext","code":"[03A / GOALS - ERPNext]","title":"Goals detail: ERPNext as the connected operating core.","subtitle":"ERPNext supports the goal of one source of truth across finance, stock, operations, HR, approvals, and reporting.","component":"topology","map":{"left":["Accounting","Sales","Purchasing","Inventory","Manufacturing"],"center":"ERPNext","right":["CRM","Projects","Assets","HR","Reports"]},"points":[{"label":"Integrated","detail":"Transactions flow from operations into finance."},{"label":"Open source","detail":"The platform can be extended and controlled."},{"label":"No traditional per-user licensing burden","detail":"Growth does not automatically multiply software-license fees with every user."},{"label":"Customizable","detail":"Forms, workflows, reports, and applications can be adapted."},{"label":"Integration ready","detail":"External systems can connect through APIs and custom integrations."}],"mode":"one-to-one","verticals":[{"id":"erp-flow","code":"[04A / FLOW]","title":"Operational events become accounting truth.","component":"process","steps":["Sales Order","Delivery","Invoice","Payment","General Ledger"],"feature":true},{"id":"erp-architecture","code":"[04B / ARCHITECTURE]","title":"Open architecture means the system can grow.","component":"process","steps":["ERPNext Core","Custom App","External API","Business Intelligence"],"mode":"one-to-one"},{"id":"erp-commercial","code":"[04C / COMMERCIAL]","title":"Open source changes the commercial model.","points":["Hosting has a cost.","Implementation has a cost.","Migration has a cost.","Support has a cost.","Customization has a cost.","Professional expertise has value."],"component":"metric","metrics":[{"value":"0","label":"traditional per-user license pressure","context":"Conceptual model only; not competitor pricing."}],"mode":"one-to-one"},{"id":"erp-indonesia-tax","code":"[04D / INDONESIA]","title":"Localized for Indonesia.","subtitle":"Agile Technica extends ERPNext with Indonesian operational and tax requirements.","points":[{"label":"CoreTax E-Faktur generator","detail":"Generate Indonesian tax-ready outputs from ERP data."},{"label":"CoreTax XML exporter","detail":"Prepare structured tax files without manual retyping."},{"label":"CoreTax result importer","detail":"Bring tax processing results back into the system."},{"label":"Indonesian reports","detail":"Reduce manual reporting work and improve traceability."}],"component":"process","steps":["ERP transaction","Tax data","XML export","CoreTax result","ERP traceability"],"mode":"one-to-one"}]}]},{"id":"erpnext-operating-system","code":"[G / GOALS - ERPNext]","title":"ERPNext is the business operating system.","subtitle":"It connects the work that happens across the company, so every team works from the same business reality.","brandIds":["agile-technica"],"component":"topology","map":{"illustrated":true,"sceneAsset":"erpnext-operation-scenes","left":["Sales","Purchasing","Manufacturing"],"center":"ERPNext","right":["Accounting","Stock","HR"]},"mode":"feature"},{"id":"birdtec-hero","code":"[G / GOALS - POULTRY]","title":"BirdTec is made for poultry, end to end.","subtitle":"Layer. Broiler. Kemitraan. Poultry processing.","layout":"birdtec-hero","brandIds":["birdtec"],"component":"illustration","illustrationId":"birdtec-poultry-operations","mode":"feature"},{"id":"birdtec","code":"[G / GOALS - POULTRY]","title":"BirdTec connects the poultry business end to end.","subtitle":"From farm performance to inventory, costing, settlement, and finance - one business view.","layout":"birdtec-dashboard","brandIds":["birdtec"],"component":"product","productId":"birdtec-farm-analyzer","points":["See farm and flock performance in one practical view.","Compare feed, FCR, production, and earnings before management has to chase spreadsheets."],"mode":"feature","verticals":[{"id":"birdtec-layer","code":"[06A / LAYER]","title":"Layer operations need daily operational discipline.","component":"process","steps":["Flock lifecycle","Daily egg production","Feed","Mortality","Grading","Performance","Profitability"],"mode":"one-to-one"},{"id":"birdtec-broiler","code":"[06B / BROILER]","title":"Broiler and kemitraan need connected performance and settlement.","component":"process","steps":["Placement","DOC","Feed distribution","Medicine","Weight","FCR","Harvest","Settlement"],"mode":"one-to-one"},{"id":"birdtec-processing","code":"[06C / PROCESSING]","title":"Processing connects production yield with inventory, sales, and costing.","component":"process","steps":["Live-bird receiving","Production yield","Grading","Cold storage","Inventory","Sales","Costing"],"mode":"one-to-one"}]},{"id":"delivery-depth","code":"[G / GOALS - DELIVERY DEPTH]","title":"Bread, cheese, meat.","subtitle":"The depth of our work follows the depth of the business need.","component":"offerings","offerings":[{"level":"Bread","tagline":"Ready to use","items":["BizTec: a simplified ERPNext system, with no modifications.","Monthly server subscription includes 3 support hours; consultation is optional.","TemanHR and Frappe HR can follow the same no-modification model."]},{"level":"Cheese","tagline":"Fully assisted implementation","items":["Customized ERPNext implementation.","BirdTec implementation for poultry operations.","Large-scale TemanHR deployment, fully assisted."]},{"level":"Meat","tagline":"Enterprise transformation","items":["ERPNext with significant modification and integration into other systems.","Enterprise backbone work: deep consultation and business-process mapping into digital systems.","Highly tailored BirdTec for contract farming."]}],"mode":"feature"},{"id":"gains-skills-main","code":"[S / SKILLS]","title":"What I bring to the table.","subtitle":"I have worked from code and architecture to multi-team delivery and company leadership. Today, we are an official Frappe / ERPNext partner in Indonesia.","component":"gains","gainsSection":"skills","mode":"feature","verticals":[{"id":"proof","code":"[05A / SKILLS - PROOF]","title":"Skills credibility: proof you can verify.","subtitle":"Credibility belongs under Skills: official partner status, publications, and client references must be visible and properly verified.","brandIds":["bni-firefly"],"component":"evidence","claimIds":["official-frappe-partner","trobos-cover","agrina-cover","client-proof"],"mode":"one-to-one"},{"id":"implementation","code":"[05B / SKILLS - DELIVERY]","title":"Skills detail: Agile Technica turns system goals into delivery.","subtitle":"Business consulting, ERP implementation, and software engineering in one team.","component":"process","steps":["Discover","Design","Implement","Extend","Connect","Improve"],"points":[{"label":"Discover","detail":"Understand how the business earns money, moves stock, controls cost, and makes decisions."},{"label":"Design","detail":"Map processes, roles, approvals, controls, and reporting."},{"label":"Implement","detail":"Configure ERPNext, prepare data, and train users."},{"label":"Extend","detail":"Build custom applications and specialized functionality."}],"mode":"one-to-one","verticals":[{"id":"delivery-journey","code":"[05A / DELIVERY]","title":"From discovery to stabilization.","component":"process","steps":["Discovery","Blueprint","Configuration","Validation","Migration","Training","Go-live","Stabilization"],"mode":"one-to-one"},{"id":"consultant-risk","code":"[05C / DELIVERY RISK]","title":"A good system project also manages consultant risk.","subtitle":"The company profile names the frustrations buyers already fear: poor business understanding, weak communication, overpromising, delays, hidden costs, and insufficient training.","points":[{"label":"Business-first discovery","detail":"Understand how the company actually works before proposing configuration or customization."},{"label":"Collaborative delivery","detail":"Regular planning, testing, showcases, and user validation reduce surprise."},{"label":"Training and stabilization","detail":"Go-live is not the finish line; users need support as the new operating model settles."}],"component":"process","steps":["Free pre-sales analysis","Proposal and contract","Kickoff","Requirements","Collaborative development","Training and migration","Go-live and support"],"mode":"one-to-one"},{"id":"adaptation-levels","code":"[05B / ADAPTATION]","title":"Adapt only where the business case is real.","component":"process","steps":["Configuration","Custom fields","Workflow","Reports","Custom application","External integration"],"mode":"one-to-one"}]},{"id":"difference","code":"[05C / SKILLS - DIFFERENCE]","title":"We design the process before we automate it.","subtitle":"That is the difference between installing software and building a reliable business system.","component":"logos","logoIds":["agile-technica","birdtec","biztec","temanhr"],"points":[{"label":"Consulting","detail":"Clarify business logic, roles, controls, and decisions."},{"label":"ERP implementation","detail":"Configure and deploy the integrated platform."},{"label":"Software engineering","detail":"Build the extensions and integrations the business truly needs."}],"mode":"one-to-one"},{"id":"translator","code":"[05D / SKILLS - TRANSLATOR]","title":"I speak both languages: business and technology.","subtitle":"One operating model. One connected system. One source of truth.","points":[{"label":"Business","detail":"Strategy, management reporting, cost, profitability, governance, and control."},{"label":"Operations","detail":"Sales, purchasing, inventory, warehouses, manufacturing, and supply chain."},{"label":"Technology","detail":"ERP architecture, custom software, APIs, integration, automation, and analytics."}],"component":"topology","map":{"left":["Management intent","Operational reality","Accounting controls"],"center":"Architecture","right":["ERPNext","Custom apps","Integration"]},"mode":"one-to-one"}]},{"id":"career-journey","code":"[A / ACHIEVEMENTS]","title":"I learned the business from every side of delivery.","subtitle":"That journey is why I can talk with the owner, understand the operation, and still go deep with the technical team.","component":"process","steps":["Software engineer","Delivery leader","Company builder","ERP business owner"],"points":[{"label":"Engineer","detail":"Built high-performance wagering systems in Australia where speed, reliability, and constant business change mattered."},{"label":"Delivery Lead","detail":"Coached and led several onshore and offshore teams to discover, build, and release products iteratively."},{"label":"Founder","detail":"Co-founded Agile Technica in 2019 and grew the team from 3 people to more than 30."},{"label":"Today","detail":"Combine business ownership, ERPNext, custom software, integration, and change leadership in one conversation."}],"mode":"feature"},{"id":"proof-trobos","code":"[A / ACHIEVEMENTS - PUBLISHED]","title":"Recognized for bringing data into poultry operations.","subtitle":"Trobos Livestock, October 2021 - an article on integrated farm management, performance analysis, and connected business data.","component":"publication","publicationId":"trobos-livestock-2021","mode":"feature"},{"id":"proof-agrina","code":"[A / ACHIEVEMENTS - COVER STORY]","title":"The technology story became a business story.","subtitle":"Agrina Magazine, October 2023 - Arvy and BirdTec featured on the cover for smarter poultry profitability.","component":"publication","publicationId":"agrina-cover-2023","mode":"feature"},{"id":"gains-networks-main","code":"[N / NETWORKS]","title":"The easiest way to spot a referral for me.","subtitle":"You hear one of these. You think of Arvy.","component":"process","steps":["We're expanding.","Our stock never matches.","We don't know where the money goes.","We need better control."],"mode":"feature"},{"id":"referral","code":"[06 / LISTEN FOR]","title":"Listen for the brag or the complaint.","subtitle":"You do not need to diagnose the system. Just catch the signal and introduce the decision-maker.","component":"referrals","referralIds":["business-expansion","stock-mismatch","money-leakage","theft-risk"],"mode":"one-to-one"},{"id":"intro-script","code":"[07 / INTRO]","title":"You can introduce me like this.","component":"quote","quote":{"text":"I know someone who helps growing companies get finance, stock, and operations working from one reliable system. His name is Arvy from Agile Technica.","author":"That's enough. I'll take it from there."},"mode":"feature"},{"id":"built","code":"[08 / BUILT]","title":"BUILT is how we work.","subtitle":"Bold. United. Integrity. Lasting. Trust.","layout":"values","brandIds":["agile-technica"],"component":"values","values":[{"letter":"B","name":"Bold","behaviour":"Push into hard problems and challenge what no longer works.","imageId":"built-bold"},{"letter":"U","name":"United","behaviour":"Bring business, finance, operations, and technology into one team.","imageId":"built-united"},{"letter":"I","name":"Integrity","behaviour":"Stay professional, incorruptible, and always fly straight.","imageId":"built-integrity"},{"letter":"L","name":"Lasting","behaviour":"Create systems that last, improve, and evolve with the business.","imageId":"built-lasting"},{"letter":"T","name":"Trust","behaviour":"Give clients confidence that the project will be finished properly.","imageId":"built-trust"}],"mode":"feature"},{"id":"gains-interests-main","code":"[I / INTERESTS]","title":"My interests.","component":"gains","gainsSection":"interests","labelsOnly":true,"hideSectionTitle":true,"mode":"feature","verticals":[{"id":"personal","code":"[09A / PERSONAL]","title":"Bold means taking the shot.","subtitle":"The personal story comes after the business relevance.","component":"quote","quote":{"text":"You miss 100% of the shots you don't take.","author":"Wayne Gretzky","connection":"Starting Agile Technica, entering complicated industries, and taking responsibility for difficult implementations all require the courage to take worthwhile shots."},"points":["Software engineering","Retro computers and cameras","Agile, Neuro-linguistic programming (NLP), AI, and teaching","Curiosity that connects business and technology"],"mode":"one-to-one"}]},{"id":"client-portfolio","code":"[A / ACHIEVEMENTS - CLIENT PORTFOLIO]","title":"A client portfolio across industries.","subtitle":"ERPNext implementation and customization, custom integrations and development, plus Agile training, seminars, and CSR.","layout":"portfolio","component":"portfolio","portfolioId":"clients-2026","mode":"feature"},{"id":"partnership-journey","code":"[10 / PARTNERING]","title":"Partnering with Agile Technica.","subtitle":"A clear, collaborative path from the first conversation through continuous support.","brandIds":["agile-technica"],"component":"partnership","stages":["Free pre-sales analysis","Proposal and contract","Project kickoff","Business-requirements agreement","Collaborative development","Training, migration, and go-live","Continuous support"],"mode":"feature"},{"id":"weekly","code":"[11 / WEEKLY]","title":"Weekly BNI pitch.","subtitle":"One problem. One solution. One request.","component":"weekly","mode":"weekly"},{"id":"close","code":"[12 / CLOSE]","title":"Complex business. Clear systems. BUILT to last.","subtitle":"When a business has disconnected systems, unreliable stock, unclear costing, slow reporting, or operational complexity, introduce them to Arvy.","brandIds":["agile-technica","bni-firefly"],"component":"contact","monthlyRequest":true,"mode":"all"}]`),Ri={weekly:xi,slides:Ai},Ti={problem:"Banyak perusahaan yang bertumbuh memakai data finance, stok, sales, purchasing, dan operasional yang tidak lagi sama.",solution:"Saya membantu memetakan proses bisnis, memilih pendekatan ERPNext/BirdTec/custom system yang tepat, lalu menghubungkannya menjadi operating model yang reliable.",request:"Bulan ini, mohon perkenalkan saya kepada owner, CFO, atau COO yang bisnisnya berubah lebih cepat daripada sistemnya bisa menyesuaikan."},Ci=JSON.parse(`[{"id":"identity","code":"[01 / IDENTITY]","title":"Arvy Budiarto","subtitle":"ERPNext dan business systems yang berkembang bersama bisnis Anda.","kicker":"AGILE TECHNICA","layout":"hero","brandIds":["agile-technica","bni-firefly"],"component":"pillars","pillars":[{"label":"ERP System Implementation","icon":"database"},{"label":"Digital Transformation","icon":"refresh-cw"},{"label":"Poultry Management Systems","icon":"bird"},{"label":"HR","icon":"users"},{"label":"CRM","icon":"contact-round"}],"mode":"all"},{"id":"problem","code":"[02 / PROBLEM]","title":"Pertumbuhan bisnis itu baik. Tetapi sistem Anda harus mampu mengikutinya.","subtitle":"Cabang, produk, channel, gudang, dan tim baru menciptakan cara kerja baru.","layout":"visual-story","component":"illustration","illustrationId":"growth-outpaces-systems","mode":"feature"},{"id":"problem-truths","code":"[02A / DIFFERENT TRUTHS]","title":"Lalu tiap tim merasa angkanya paling benar.","subtitle":"Gudang, finance, dan manajemen mulai berdebat dengan data versi masing-masing.","layout":"visual-story","component":"illustration","illustrationId":"different-truths","mode":"feature"},{"id":"problem-pain","code":"[02B / THE PAIN]","title":"Rasa sakitnya muncul dalam pekerjaan sehari-hari.","subtitle":"Input berulang. Laporan lambat. Stok hilang. Uang bocor. Kontrol lemah.","layout":"visual-story","component":"illustration","illustrationId":"systems-pain","mode":"feature"},{"id":"problem-fraud","code":"[02C / INTERNAL FRAUD]","title":"Kontrol yang lemah membuka ruang untuk fraud internal.","subtitle":"Transaksi palsu. Harga material dan peralatan dinaikkan. Kickback. Uang perusahaan dialihkan untuk keuntungan pribadi.","layout":"visual-story","component":"illustration","illustrationId":"internal-fraud","mode":"feature"},{"id":"gains-goals-main","code":"[G / GOALS]","title":"Apa yang sedang saya bangun.","subtitle":"Bisnis tempat management, finance, stok, sales, dan operations bekerja dari realita yang sama.","component":"gains","gainsSection":"goals","labelsOnly":true,"hideSectionTitle":true,"brandIds":["agile-technica"],"mode":"feature","verticals":[{"id":"erpnext","code":"[03A / GOALS - ERPNext]","title":"Goals detail: ERPNext sebagai operating core yang terhubung.","subtitle":"Terintegrasi, dapat dikembangkan, dan siap menghubungkan operasi dengan finance.","component":"topology","map":{"left":["Accounting","Sales","Purchasing","Inventory","Manufacturing"],"center":"ERPNext","right":["CRM","Projects","Assets","HR","Reports"]},"points":[{"label":"Integrated","detail":"Transaksi mengalir dari operasional ke finance."},{"label":"Open source","detail":"Platform dapat dikontrol dan dikembangkan."},{"label":"Tanpa beban lisensi per-user tradisional","detail":"Pertumbuhan user tidak otomatis menggandakan biaya lisensi software."},{"label":"Customizable","detail":"Form, workflow, report, dan aplikasi dapat disesuaikan."},{"label":"Integration ready","detail":"Sistem eksternal dapat terhubung melalui API dan custom integration."}],"mode":"one-to-one","verticals":[{"id":"erp-flow","code":"[04A / FLOW]","title":"Aktivitas operasional menjadi kebenaran akuntansi.","component":"process","steps":["Sales Order","Delivery","Invoice","Payment","General Ledger"],"feature":true},{"id":"erp-indonesia-tax","code":"[04D / INDONESIA]","title":"Localized for Indonesia.","subtitle":"Agile Technica memperluas ERPNext untuk kebutuhan operasional dan pajak Indonesia.","points":[{"label":"CoreTax E-Faktur generator","detail":"Generate output pajak dari data ERP."},{"label":"CoreTax XML exporter","detail":"Siapkan file pajak terstruktur tanpa input ulang manual."},{"label":"CoreTax result importer","detail":"Masukkan hasil proses pajak kembali ke sistem."},{"label":"Indonesian reports","detail":"Mengurangi pekerjaan reporting manual dan meningkatkan traceability."}],"component":"process","steps":["ERP transaction","Tax data","XML export","CoreTax result","ERP traceability"],"mode":"one-to-one"}]}]},{"id":"erpnext-operating-system","code":"[G / GOALS - ERPNext]","title":"ERPNext adalah business operating system.","subtitle":"ERPNext menghubungkan pekerjaan di seluruh perusahaan agar setiap tim bekerja dari realita bisnis yang sama.","brandIds":["agile-technica"],"component":"topology","map":{"illustrated":true,"sceneAsset":"erpnext-operation-scenes","left":["Sales","Purchasing","Manufacturing"],"center":"ERPNext","right":["Accounting","Stock","HR"]},"mode":"feature"},{"id":"birdtec-hero","code":"[G / GOALS - BIRDTEC]","title":"BirdTec dibuat untuk bisnis poultry, dari hulu ke hilir.","subtitle":"Layer. Broiler. Kemitraan. Rumah potong ayam.","layout":"birdtec-hero","brandIds":["birdtec"],"component":"illustration","illustrationId":"birdtec-poultry-operations","mode":"feature"},{"id":"birdtec","code":"[G / GOALS - BIRDTEC]","title":"BirdTec menghubungkan bisnis poultry dari hulu ke hilir.","subtitle":"Dari performa farm hingga inventory, costing, settlement, dan finance - satu business view.","layout":"birdtec-dashboard","brandIds":["birdtec"],"component":"product","productId":"birdtec-farm-analyzer","points":["Melihat performa farm dan flock dalam satu tampilan praktis.","Membandingkan feed, FCR, produksi, dan earnings tanpa management harus mengejar spreadsheet."],"mode":"feature"},{"id":"delivery-depth","code":"[G / GOALS - DELIVERY DEPTH]","title":"Bread, cheese, meat.","subtitle":"Kedalaman pekerjaan kami mengikuti kedalaman kebutuhan bisnis.","component":"offerings","offerings":[{"level":"Bread","tagline":"Siap digunakan","items":["BizTec: ERPNext yang disederhanakan, tanpa modifikasi.","Subscription server bulanan mencakup 3 jam support; konsultasi bersifat opsional.","TemanHR dan Frappe HR juga dapat menggunakan model tanpa modifikasi."]},{"level":"Cheese","tagline":"Implementasi full assisted","items":["Implementasi ERPNext yang disesuaikan.","Implementasi BirdTec untuk operasi poultry.","Deployment TemanHR skala besar dengan pendampingan penuh."]},{"level":"Meat","tagline":"Transformasi enterprise","items":["ERPNext dengan modifikasi besar dan integrasi ke sistem lain.","Pekerjaan enterprise backbone: konsultasi mendalam dan pemetaan proses bisnis ke sistem digital.","BirdTec yang sangat disesuaikan untuk contract farming."]}],"mode":"feature"},{"id":"gains-skills-main","code":"[S / SKILLS]","title":"Apa yang saya bawa ke meja.","subtitle":"Karier saya berkembang dari coding dan architecture, ke multi-team delivery, lalu memimpin perusahaan. Sekarang kami official Frappe / ERPNext partner di Indonesia.","component":"gains","gainsSection":"skills","mode":"feature","verticals":[{"id":"proof","code":"[05A / SKILLS - PROOF]","title":"Kredibilitas Skills: bukti yang bisa diverifikasi.","subtitle":"Kredibilitasnya mencakup official partner status, publikasi, dan client reference yang perlu dipakai dengan tepat.","brandIds":["bni-firefly"],"component":"evidence","claimIds":["official-frappe-partner","trobos-cover","agrina-cover","client-proof"],"mode":"one-to-one"},{"id":"implementation","code":"[05B / SKILLS - DELIVERY]","title":"ERPNext adalah platform. Agile Technica mengubahnya menjadi operating system bisnis.","subtitle":"Business consulting, ERP implementation, dan software engineering dalam satu tim.","component":"process","steps":["Discover","Design","Implement","Extend","Connect","Improve"],"points":[{"label":"Discover","detail":"Memahami cara bisnis menghasilkan uang, memindahkan stok, mengontrol cost, dan mengambil keputusan."},{"label":"Design","detail":"Memetakan proses, role, approval, kontrol, dan reporting."},{"label":"Implement","detail":"Konfigurasi ERPNext, persiapan data, dan training user."},{"label":"Extend","detail":"Membangun aplikasi custom dan fungsi khusus."}],"mode":"one-to-one"},{"id":"translator","code":"[03 / TRANSLATOR]","title":"Saya berbicara dalam dua bahasa: bisnis dan teknologi.","subtitle":"Satu operating model. Satu sistem terhubung. Satu sumber kebenaran.","points":[{"label":"Business","detail":"Strategy, reporting manajemen, costing, profitabilitas, governance, dan kontrol."},{"label":"Operations","detail":"Sales, purchasing, inventory, gudang, manufacturing, dan supply chain."},{"label":"Technology","detail":"Arsitektur ERP, custom software, API, integrasi, automation, dan analytics."}],"component":"topology","map":{"left":["Tujuan manajemen","Realita operasional","Kontrol akuntansi"],"center":"Architecture","right":["ERPNext","Custom apps","Integration"]},"mode":"one-to-one"}]},{"id":"career-journey","code":"[A / ACHIEVEMENTS]","title":"Saya memahami bisnis dari setiap sisi delivery.","subtitle":"Perjalanan ini membuat saya bisa berbicara dengan owner, memahami operasi, dan tetap masuk cukup dalam bersama tim teknis.","component":"process","steps":["Software engineer","Delivery leader","Company builder","ERP business owner"],"points":[{"label":"Engineer","detail":"Membangun high-performance wagering systems di Australia, saat kecepatan, reliability, dan perubahan bisnis sangat menentukan."},{"label":"Delivery Lead","detail":"Melatih dan memimpin beberapa tim onshore dan offshore untuk menemukan, membangun, dan merilis product secara iterative."},{"label":"Founder","detail":"Mendirikan Agile Technica pada 2019 dan mengembangkan tim dari 3 menjadi lebih dari 30 orang."},{"label":"Sekarang","detail":"Menggabungkan pengalaman sebagai business owner, ERPNext, custom software, integration, dan change leadership dalam satu percakapan."}],"mode":"feature"},{"id":"proof-trobos","code":"[A / ACHIEVEMENTS - PUBLISHED]","title":"Diakui karena membawa data ke dalam operasi poultry.","subtitle":"Trobos Livestock, Oktober 2021 - artikel tentang integrated farm management, analisa performa, dan data bisnis yang terhubung.","component":"publication","publicationId":"trobos-livestock-2021","mode":"feature"},{"id":"proof-agrina","code":"[A / ACHIEVEMENTS - COVER STORY]","title":"Cerita teknologi ini menjadi cerita bisnis.","subtitle":"Agrina Magazine, Oktober 2023 - Arvy dan BirdTec tampil di cover untuk profitabilitas bisnis unggas yang lebih cerdas.","component":"publication","publicationId":"agrina-cover-2023","mode":"feature"},{"id":"gains-networks-main","code":"[N / NETWORKS]","title":"Cara paling mudah mengenali referral untuk saya.","subtitle":"Kalau Anda mendengar salah satu ini, ingat Arvy.","component":"process","steps":["Kami sedang ekspansi.","Stok kami tidak pernah cocok.","Kami tidak tahu uangnya ke mana.","Kami butuh kontrol yang lebih baik."],"mode":"feature"},{"id":"referral","code":"[06 / LISTEN FOR]","title":"Dengarkan bragging atau complaining.","subtitle":"Anda tidak perlu mendiagnosis sistemnya. Cukup tangkap sinyalnya dan perkenalkan decision-maker.","component":"referrals","referralIds":["business-expansion","stock-mismatch","money-leakage","theft-risk"],"mode":"one-to-one"},{"id":"intro-script","code":"[07 / INTRO]","title":"Anda bisa memperkenalkan saya seperti ini.","component":"quote","quote":{"text":"Saya kenal seseorang yang membantu perusahaan bertumbuh membuat finance, stok, dan operations bekerja dari satu sistem yang dapat dipercaya. Namanya Arvy dari Agile Technica.","author":"Cukup begitu. Selanjutnya biar saya yang lanjutkan."},"mode":"feature"},{"id":"built","code":"[08 / BUILT]","title":"BUILT adalah cara kami bekerja.","subtitle":"Bold. United. Integrity. Lasting. Trust.","layout":"values","brandIds":["agile-technica"],"component":"values","values":[{"letter":"B","name":"Bold","behaviour":"Berani masuk ke masalah sulit dan menantang cara kerja yang tidak lagi efektif.","imageId":"built-bold"},{"letter":"U","name":"United","behaviour":"Satukan business, finance, operations, dan technology dalam satu tim.","imageId":"built-united"},{"letter":"I","name":"Integrity","behaviour":"Professional integrity: tidak bisa dibeli dan selalu lurus.","imageId":"built-integrity"},{"letter":"L","name":"Lasting","behaviour":"Membangun sistem yang tahan lama, terus membaik, dan ikut berkembang.","imageId":"built-lasting"},{"letter":"T","name":"Trust","behaviour":"Memberi klien keyakinan bahwa project akan selesai dengan benar.","imageId":"built-trust"}],"mode":"feature"},{"id":"gains-interests-main","code":"[I / INTERESTS]","title":"Minat saya.","component":"gains","gainsSection":"interests","labelsOnly":true,"hideSectionTitle":true,"mode":"feature","verticals":[{"id":"personal","code":"[09A / PERSONAL]","title":"Bold berarti berani mengambil kesempatan.","subtitle":"Cerita personal masuk setelah relevansi bisnis jelas.","component":"quote","quote":{"text":"You miss 100% of the shots you don't take.","author":"Wayne Gretzky","connection":"Membangun Agile Technica, masuk ke industri yang kompleks, dan mengambil tanggung jawab implementasi yang sulit membutuhkan keberanian untuk mengambil kesempatan yang bernilai."},"points":["Software engineering","Retro computers and cameras","Agile, Neuro-linguistic programming (NLP), AI, dan teaching","Curiosity yang menghubungkan business dan technology"],"mode":"one-to-one"}]},{"id":"client-portfolio","code":"[A / ACHIEVEMENTS - CLIENT PORTFOLIO]","title":"Portofolio klien lintas industri.","subtitle":"Implementasi dan kustomisasi ERPNext, custom integration dan development, serta Agile training, seminar, dan CSR.","layout":"portfolio","component":"portfolio","portfolioId":"clients-2026","mode":"feature"},{"id":"partnership-journey","code":"[10 / PARTNERING]","title":"Bekerja sama dengan Agile Technica.","subtitle":"Jalur yang jelas dan kolaboratif dari percakapan awal hingga continuous support.","brandIds":["agile-technica"],"component":"partnership","stages":["Free pre-sales analysis","Proposal dan contract","Project kickoff","Kesepakatan business requirements","Collaborative development","Training, migration, dan go-live","Continuous support"],"mode":"feature"},{"id":"weekly","code":"[10 / WEEKLY]","title":"Pitch BNI mingguan.","subtitle":"Satu masalah. Satu solusi. Satu request.","component":"weekly","mode":"weekly"},{"id":"close","code":"[11 / CLOSE]","title":"Complex business. Clear systems. BUILT to last.","subtitle":"Saat bisnis punya sistem terputus, stok tidak akurat, costing tidak jelas, laporan lambat, atau kompleksitas operasional, perkenalkan mereka kepada Arvy.","brandIds":["agile-technica","bni-firefly"],"component":"contact","monthlyRequest":true,"mode":"all"}]`),Li={weekly:Ti,slides:Ci},Ii="Arvy Budiarto",Pi="Agile Technica",Ni="ERP System Implementor - Business Systems Architect",$i="I turn complex business operations into one connected system.",Mi={email:"arvy@agiletechnica.com",whatsapp:"+62 811 131 8918",website:"https://agiletechnica.com",instagram:"@arvy.budiarto"},Bi={name:Ii,company:Pi,title:Ni,positioning:$i,contact:Mi},Oi="Arvy Budiarto",zi="Agile Technica",Hi="ERP System Implementor - Business Systems Architect",Di="Saya mengubah kompleksitas operasional bisnis menjadi satu sistem yang terhubung.",qi={email:"arvy@agiletechnica.com",whatsapp:"+62 811 131 8918",website:"https://agiletechnica.com",instagram:"@arvy.budiarto"},Fi={name:Oi,company:zi,title:Hi,positioning:Di,contact:qi},ji={"agile-technica":{label:"Agile Technica",src:"./assets/brand/agile-technica.png?v=2",alt:"Agile Technica logo"},"bni-firefly":{label:"BNI Firefly",src:"./assets/brand/bni-firefly.png?v=2",alt:"BNI Firefly logo"},birdtec:{label:"BirdTec",src:"./assets/brand/birdtec.png",alt:"BirdTec logo"},biztec:{label:"BizTec",src:"./assets/brand/biztec.png",alt:"BizTec logo"},temanhr:{label:"TemanHR",src:"./assets/brand/temanhr.png",alt:"TemanHR logo"}},_i={whatsappQr:{src:"./assets/contact/whatsapp-qr.png",alt:"QR code for contacting Arvy Budiarto on WhatsApp"}},Ui={"growth-outpaces-systems":{src:"./assets/illustrations/growth-outpaces-systems-v2.webp",alt:"A growing Indonesian business expanding faster than its system while finance staff reconcile data manually and the owner sees conflicting reports"},"different-truths":{src:"./assets/illustrations/different-truths.webp",alt:"Warehouse, finance, and management teams comparing conflicting business information"},"systems-pain":{src:"./assets/illustrations/systems-pain.webp",alt:"Employees dealing with duplicate entry, slow reports, missing stock, money leakage, and weak controls"},"internal-fraud":{src:"./assets/illustrations/internal-fraud-v2.webp",alt:"Weak purchasing controls allowing fake material and equipment purchases, inflated invoices, and a concealed kickback"},"birdtec-poultry-operations":{src:"./assets/illustrations/birdtec-poultry-operations.png",alt:"An Art Deco illustration of layer farming, broiler farming, contract farming, and poultry processing in Indonesia"}},Wi={"built-bold":{src:"./assets/values/built-bold.png",alt:"A 1920s optimism poster style explorer looking across an unknown frontier"},"built-united":{src:"./assets/values/built-united.png",alt:"A 1920s optimism poster style team working together around a blueprint"},"built-integrity":{src:"./assets/values/built-integrity.png",alt:"A 1920s optimism poster style professional following a straight arrow through confusion"},"built-lasting":{src:"./assets/values/built-lasting.png",alt:"A 1920s optimism poster style skyscraper system being built to last and evolve"},"built-trust":{src:"./assets/values/built-trust.png",alt:"A 1920s optimism poster style man and woman standing confidently after project delivery"}},Vi={"trobos-livestock-2021":{label:"Trobos Livestock article",src:"./assets/publications/trobos-livestock-magazine-2x.jpg",thumb:"./assets/publications/trobos-livestock-magazine-thumb.jpg",alt:"Trobos Livestock article page featuring Arvy Budiarto, Edisi 265, Oktober 2021"},"agrina-cover-2023":{label:"Agrina Magazine cover",src:"./assets/publications/agrina-cover-2023-2x.jpg",thumb:"./assets/publications/agrina-cover-2023-thumb.jpg",alt:"Agrina Magazine cover featuring Arvy Budiarto, Vol. 19 No. 352, Oktober 2023"}},Ki={"clients-2026":{label:"Agile Technica clients portfolio",src:"./assets/portfolio/clients-portfolio.png",alt:"Agile Technica client portfolio showing organisations served across ERPNext implementations, custom integrations, development, training, seminars, and CSR"}},Gi={"birdtec-farm-analyzer":{src:"./assets/products/birdtec-farm-analyzer.png",alt:"BirdTec Farm Layer Analyzer showing weekly flock performance, HD percentage, HH percentage, feed per bird, FCR, egg production, and estimated earnings",caption:"Farm Analyzer: performance, feed, FCR, production, and earnings in one view."}},Yi={"erpnext-operation-scenes":{src:"./assets/modules/erpnext-operation-scenes-v2.png",alt:"Six 1920s optimism poster scenes for Sales, Purchasing, Manufacturing, Accounting, Stock, and HR"}},mn={logos:ji,contact:_i,illustrations:Ui,valueImages:Wi,publications:Vi,portfolio:Ki,products:Gi,moduleIllustrations:Yi},Xi=[{id:"case-study-placeholder",title:"From fragmented operations to one connected view",industry:"Distribution",permissionStatus:"pending",before:["Multiple spreadsheets","Separate operational and accounting data"],intervention:["Process discovery","ERPNext implementation","Integration"],after:["Shared master data","Connected transactions","Improved visibility"],metrics:[]}],fn=[{id:"official-frappe-partner",claim:"Agile Technica is an official Frappe partner for ERPNext implementation in Indonesia",status:"verified",sourceType:"official",sourceLabel:"Frappe Partner Directory; Agile Technica partner profile and Frappe partner list",verifiedAt:"2026-07-12",publicUrl:"https://frappe.io/partners/indonesia/agile-technica",asset:"frappe-partner-profile.png",displayOnSlide:7},{id:"trobos-cover",claim:"Trobos Livestock article on poultry management systems",status:"verified",sourceType:"publication",sourceLabel:"Trobos Livestock, Edisi 265, Tahun XXIII, Oktober 2021, page 36; provided article scan",verifiedAt:"2026-07-11",publicUrl:"",asset:"trobos-livestock-2021",displayOnSlide:7},{id:"agrina-cover",claim:"Agrina Magazine cover feature on poultry business profit",status:"verified",sourceType:"publication",sourceLabel:"Agrina, Vol. 19 No. 352, Oktober 2023; cover headline: Bisnis Unggas: Cara Pintar Kejar Profit; provided cover scan",verifiedAt:"2026-07-11",publicUrl:"",asset:"agrina-cover-2023",displayOnSlide:7},{id:"client-proof",claim:"Enterprise implementation and training references",status:"approved-private",sourceType:"client evidence",sourceLabel:"Current pitch deck references client/project names; permission and logo assets required before public display",verifiedAt:null,publicUrl:"",asset:"client-logos",displayOnSlide:8},{id:"fifteen-years-experience",claim:"Arvy has 15+ years in IT and ERP",status:"pending-verification",sourceType:"profile",sourceLabel:"BIO GAINS V7 and current pitch deck",verifiedAt:null,publicUrl:"",asset:"",displayOnSlide:null}],Ji=[{label:"One connected operating core",detail:"Use ERPNext as the open platform that connects finance, inventory, sales, purchasing, manufacturing, HR, approvals, and management reporting."},{label:"A trusted ERP company in Indonesia",detail:"Establish Agile Technica as a trusted implementation partner for operationally complex companies."},{label:"Deep solutions for complex industries",detail:"Use ERPNext, BirdTec, and custom software to solve industry-specific operational problems."},{label:"Strong Indonesian technology talent",detail:"Build a team that combines business process thinking, software engineering, and implementation discipline."}],Zi=[{label:"15+ years in IT and ERP",detail:"A career spanning software engineering, high-performance wagering platforms, Agile delivery leadership, ERP implementation, and business ownership."},{label:"Built Agile Technica from 3 to 30+ people",detail:"Co-founded the company in 2019 and grew it into a multidisciplinary ERP and custom software delivery team."},{label:"Official Frappe / ERPNext partner in Indonesia",detail:"Agile Technica is listed by Frappe as an official partner, so ERPNext implementation is not a side experiment for us."},{label:"Creator and implementor of BirdTec",detail:"A poultry ERP platform for broiler, layer, contract farming, and processing operations."},{label:"Enterprise implementation exposure",detail:"Current deck references Datacomm, Netcity, Coway, Unirama, Pertamina projects, Japfa, and Great Giant Pineapple. Confirm permission before public display."},{label:"Industry publication credibility",detail:"Current materials reference Agrina and Trobos/Terobos coverage. Issue metadata and cover images still need verification."}],Qi=[{label:"Software engineering, data science, and AI",detail:"A technical curiosity that supports better architecture and automation decisions."},{label:"Vintage technology, cameras, and high-performance PCs",detail:"A personal thread that signals craft, systems thinking, and attention to detail."},{label:"Agile, Neuro-linguistic programming (NLP), coaching, and teaching",detail:"Useful for change management, facilitation, communication, stakeholder alignment, and helping teams understand new ways of working."},{label:"Lived and worked in Australia",detail:"That experience brought a different perspective on communication, work culture, professionalism, and how people approach business problems."},{label:"Movies, games, comics, and audiobooks",detail:"Human connection points for one-to-one conversations after business relevance is clear."}],ta=[{label:"BNI and business contact spheres",detail:"Owners, CFOs, COOs, directors, finance consultants, tax consultants, IT providers, and operations leaders."},{label:"Target industries",detail:"Poultry, trading, import/export, distribution, manufacturing, telecom infrastructure, oil and gas, and specialty industries."},{label:"ERPNext and Frappe ecosystem",detail:"ERPNext Indonesia, global Frappe community, partners, developers, and implementation networks."},{label:"Agile, Scrum, and NLP communities",detail:"Professional communities that support delivery, facilitation, leadership, and transformation work."}],ea=[{label:"I understand both business and technology",detail:"I can talk with owners about growth and control, then work with the technical team on the system that supports it."},{label:"I have built systems where performance matters",detail:"My engineering and delivery background includes high-traffic platforms in Australia, multi-team leadership, and system architecture."},{label:"We know ERPNext",detail:"Agile Technica is an official Frappe / ERPNext partner in Indonesia, with implementation, customization, integration, and industry-specific experience."},{label:"I help people through change",detail:"Agile coaching, facilitation, teaching, and NLP help management and users adopt a better way of working."}],na=[{label:"Bread",detail:"ERP health check, standard ERPNext implementation, TemanHR, small integration, reporting, or existing ERPNext support."},{label:"Cheese",detail:"Full ERPNext implementation, BirdTec implementation, manufacturing or distribution ERP, multi-warehouse, dedicated TemanHR, or significant integration."},{label:"Meat",detail:"Multi-company ERP, enterprise customization, multiple-system integration, BirdTec across multiple operations, or large transformation across finance, supply chain, production, HR, and reporting."}],ia=[{label:"Only wants free consulting",detail:"No implementation intention or decision-maker commitment."},{label:"Too early-stage for ERP",detail:"Solo or very small businesses may not yet have enough operational complexity."},{label:"Refuses process change",detail:"ERP success requires willingness to improve workflows, data, roles, and controls."},{label:"Expects instant results",detail:"Professional ERP work needs discovery, data preparation, validation, training, and stabilization."}],aa=[{label:"General",detail:"Looking for an ERP consultant who understands your industry and not just the software? Talk to Arvy."},{label:"Problem-led",detail:"If you need to solve missing stock, unbalanced accounting, high COGS, or misconduct risk, Arvy can help map the system."},{label:"Poultry",detail:"Agile Technica specializes in digital solutions for poultry farming, from broiler and layer farm management to processing and distribution."},{label:"Manufacturing and distribution",detail:"If you run a manufacturing or distribution business and need ERP that grows with you, talk to Arvy."}],sa={goals:Ji,achievements:Zi,interests:Qi,networks:ta,skills:ea,offers:na,notReady:ia,introScripts:aa},ra=[{id:"business-expansion",quote:"We are opening new branches, warehouses, or channels.",meaning:"Bragging about growth can mean the current system is about to be stretched beyond its design.",idealContacts:["Owner","CEO","CFO","COO"],lane:"expansion"},{id:"stock-mismatch",quote:"Our stock never matches.",meaning:"Inventory transactions, warehouse controls, and accounting may be disconnected.",idealContacts:["Owner","CFO","COO","Supply Chain Director"],lane:"manufacturing-distribution"},{id:"money-leakage",quote:"We do not know where the margin is leaking.",meaning:"Unclear costing, manual reconciliation, and disconnected finance data can hide real profit loss.",idealContacts:["Owner","CFO","Finance Director","COO"],lane:"finance"},{id:"theft-risk",quote:"We are worried stock, money, or people are not being controlled.",meaning:"ERP can create approval trails, inventory controls, role separation, and management visibility.",idealContacts:["Owner","CFO","COO","Internal Audit"],lane:"control"},{id:"late-reporting",quote:"Management reports are always late.",meaning:"The business may rely on manual consolidation instead of connected operational data.",idealContacts:["Owner","CFO","Finance Director"],lane:"finance"},{id:"spreadsheet-company",quote:"Every department has its own spreadsheet.",meaning:"The company may have outgrown disconnected tools and needs one source of truth.",idealContacts:["Owner","COO","Operations Director"],lane:"operations"},{id:"poultry-performance",quote:"Farm performance and finance do not use the same numbers.",meaning:"Poultry operational data may not be connected to costing, settlement, and accounting.",idealContacts:["Owner","Farm Director","CFO"],lane:"poultry"}],oa="2026-07",la="An introduction to an owner, CFO, or COO of a poultry, manufacturing, distribution, or trading company experiencing stock, costing, reporting, or integration problems.",ca=!0,da={month:oa,request:la,active:ca},ua="My job is to understand how a business actually operates and turn that complexity into a system that people can rely on.",ha="Ask who knows a company where warehouse, finance, and management each have a different number.",pa="A successful ERP implementation cannot be treated as only an IT project.",ga="ERPNext is open source, but implementation, hosting, migration, support, and professional expertise still have real cost and value.",ma="ERPNext is the platform; Agile Technica designs the operating model around it.",fa="Farm data should not stop at the farm. It should become operational insight and financial truth.",va="Make this easy for BNI members: symptoms, decision-maker, and exact words to use.",ba={identity:ua,problem:ha,translator:pa,erpnext:ga,implementation:ma,birdtec:fa,referral:va};function ya(){const r=new URLSearchParams(window.location.search);return{mode:r.get("mode")||"feature",lang:r.get("lang")||"en"}}const Qe={feature:new Set(["feature","all"]),weekly:new Set(["weekly","all"]),"one-to-one":new Set(["feature","one-to-one","all"]),"leave-behind":new Set(["feature","one-to-one","leave-behind","all"])};function wa(r,t="feature"){const e=Qe[t]||Qe.feature;return r.filter(n=>e.has(n.mode||"feature")).map(n=>({...n,verticals:(n.verticals||[]).filter(i=>t==="feature"?i.feature===!0:e.has(i.mode||"one-to-one"))}))}function y(r){return String(r??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function ka(r,t){const e=r.map?.left||["Finance","Inventory","Operations"],n=r.map?.right||["ERP","API","Analytics"],i=r.map?.center||"Arvy",a=r.map?.illustrated===!0,s=t.assets.moduleIllustrations?.[r.map?.sceneAsset],l=(o,c)=>{const h=String(o).toLowerCase().replaceAll(/[^a-z0-9]+/g,"-").replaceAll(/(^-|-$)/g,"");return`
    ...
    <div class="system-map${a?" system-map-illustrated":""}" aria-label="Business and technology connection map">
      ...
      <div class="node-column">
        ${n.map(o=>l(o,"tech")).join("")}
      </div>
    </div>
  `}function Sa(r){return`
    <ol class="process-rail" aria-label="Process flow">
      ${(r.steps||[]).map((e,n)=>`<li><span>${String(n+1).padStart(2,"0")}</span><strong>${y(e)}</strong></li>`).join("")}
    </ol>
  `}function Ea(r,t){return`
    <div class="evidence-grid">
      ${(r.claimIds||[]).map(i=>t.claims.find(a=>a.id===i)).filter(Boolean).map(i=>xa(i,t)).join("")}
    </div>
  `}function xa(r,t){const e=r.asset?t.assets.publications?.[r.asset]:null;return`
    <article class="evidence-card ${r.status} ${e?"has-evidence-image":""}">
      ${e?`<img src="${y(e.thumb||e.src)}" alt="${y(e.alt)}" />`:""}
      <span>${y(r.sourceType)}</span>
      <h3>${y(r.claim)}</h3>
      <p>${y(r.sourceLabel||"Source required")}</p>
      <small>${r.verifiedAt?`Verified ${y(r.verifiedAt)}`:"Pending verification"}</small>
    </article>
  `}function Aa(r,t){return`
    <div class="referral-grid">
      ${(r.referralIds||t.referrals.map(n=>n.id)).map(n=>t.referrals.find(i=>i.id===n)).filter(Boolean).map(n=>`
        <article class="referral-card">
          <span>They say</span>
          <h3>"${y(n.quote)}"</h3>
          <p>${y(n.meaning)}</p>
          <small>${y(n.idealContacts.join(", "))}</small>
        </article>
      `).join("")}
    </div>
  `}function Ra(r){return`
    <div class="built-values">
      ${(r.values||[]).map(t=>{const e=mn.valueImages?.[t.imageId];return`
        <article class="value-card">
          ${e?`
            <figure class="value-card-art">
              <img src="${y(e.src)}" alt="${y(e.alt)}" loading="lazy" />
              <strong>${y(t.letter)}</strong>
            </figure>
          `:`<strong>${y(t.letter)}</strong>`}
          <div>
            <h3>${y(t.name)}</h3>
  ...
  `}function Ta(r){return`
    <figure class="quote-card">
      <blockquote>${y(r.quote.text)}</blockquote>
      ${r.quote.author?`<figcaption>${y(r.quote.author)}</figcaption>`:""}
      ${r.quote.connection?`<p>${y(r.quote.connection)}</p>`:""}
    </figure>
    ...
    <div class="metric-stack">
      ${(r.metrics||[]).map(t=>`
        <article class="metric-card">
          ...
          <span>${y(t.label)}</span>
          <small>${y(t.context)}</small>
        </article>
      `).join("")}
    </div>
  `}const La={overview:"What to remember",goals:"Goals",achievements:"Achievements",interests:"Interests",networks:"Networks",skills:"Skills",offers:"Bread, Cheese, Meat",notReady:"When a company may not be ready yet",introScripts:"BNI introduction scripts"};function Ia(r,t){const e=r.gainsSection||"overview";if(e==="overview")return Pa(r);const n=t.gains[e]||[];return`
    <div class="gains-chapter ${r.labelsOnly?"labels-only":""}">
      ${r.hideSectionTitle?"":`<h2>${y(La[e]||e)}</h2>`}
      <div class="gains-list">
        ${n.map(i=>`
              <article class="gains-item">
                <strong>${y(i.label)}</strong>
                ${r.labelsOnly?"":`<p>${y(i.detail)}</p>`}
              </article>
            `).join("")}
      </div>
    </div>
  `}function Pa(r){const t=r.overviewTiles||[{index:"01",label:"Goals"},{index:"02",label:"Achievements"},{index:"03",label:"Interests"},{index:"04",label:"Networks"},{index:"05",label:"Skills"}],e=r.overviewCta||{label:"BNI",detail:"Referral enablement"};return`
    <div class="gains-overview" aria-label="BNI referral memory points">
      ${t.map((n,i)=>`
            <article class="gains-tile">
              <span>${y(n.index||String(i+1).padStart(2,"0"))}</span>
              <strong>${y(n.label||n)}</strong>
              ${n.detail?`<p>${y(n.detail)}</p>`:""}
            </article>
          `).join("")}
      <article class="gains-tile referral-tile">
        <span>${y(e.label)}</span>
        <strong>${y(e.detail)}</strong>
      </article>
    </div>
  `}function Na(r,t){return r.logoIds?.length?`
      <div class="logo-strip brand-logo-strip" aria-label="Brand logo strip">
        ${r.logoIds.map(n=>t.assets.logos[n]).filter(Boolean).map(n=>`
          <figure>
            <img src="${y(n.src)}" alt="${y(n.alt)}" />
            <figcaption>${y(n.label)}</figcaption>
          </figure>
        `).join("")}
      </div>
    `:`
    <div class="logo-strip" aria-label="Client logo placeholders">
      ${(r.logos||["Client proof pending","Project photo pending","Case evidence pending"]).map(e=>`<span>${y(e)}</span>`).join("")}
    </div>
  `}function $a(r){return`<span class="section-label">${y(r)}</span>`}function Ma(r,t){const e=t.assets.logos["agile-technica"],n=t.assets.logos["bni-firefly"],i=t.assets.contact?.whatsappQr;return`
    <div class="contact-panel">
      <div class="contact-brand-pair">
        <img src="${y(e.src)}" alt="${y(e.alt)}" />
        <img src="${y(n.src)}" alt="${y(n.alt)}" />
      </div>
      ${i?`
        <img class="contact-qr" src="${y(i.src)}" alt="${y(i.alt)}" />
      `:`
        <div class="qr-placeholder" role="img" aria-label="QR code placeholder for ${y(t.profile.contact.website)}">QR</div>
      `}
      <h3>${y(t.profile.name)}</h3>
      <p>${y(t.profile.contact.email)}</p>
      <p>${y(t.profile.contact.whatsapp)}</p>
      <p>${y(t.profile.contact.website)}</p>
    </div>
  `}function Ba(r,t){const e=t.assets.publications?.[r.publicationId];return e?`
    <figure class="publication-image">
      <img src="${y(e.src)}" alt="${y(e.alt)}" />
      <figcaption>${y(e.label)}</figcaption>
    </figure>
  `:'<div class="publication-missing">Publication asset missing</div>'}function Oa(r){return`
    <div class="pillar-grid" aria-label="Agile Technica product pillars">
      ${(r.pillars||[]).map(t=>`
            <article class="pillar-item">
              <i data-lucide="${y(t.icon)}" aria-hidden="true"></i>
              <strong>${y(t.label)}</strong>
            </article>
          `).join("")}
    </div>
  `}function za(r,t){const e=t.assets.illustrations?.[r.illustrationId];return e?`
    <figure class="story-illustration">
      <img src="${y(e.src)}" alt="${y(e.alt)}" />
    </figure>
  `:'<div class="illustration-missing">Illustration asset missing</div>'}function Ha(r){return`
    <div class="offering-stack" aria-label="Service delivery depth">
      ${(r.offerings||[]).map(t=>`
            <article class="offering-card offering-${y(t.level||"standard").toLowerCase()}">
              <header>
                <span>${y(t.level)}</span>
                <strong>${y(t.tagline)}</strong>
              </header>
              <ul>
                ${(t.items||[]).map(e=>`<li>${y(e)}</li>`).join("")}
              </ul>
            </article>
          `).join("")}
    </div>
  ...
  `}function qa(r,t){const e=t.assets.portfolio?.[r.portfolioId];return e?`
    <figure class="client-portfolio-image">
      <img src="${y(e.src)}" alt="${y(e.alt)}" />
      <figcaption>${y(e.label)}</figcaption>
    </figure>
  `:'<div class="publication-missing">Client portfolio asset missing</div>'}function Fa(r,t){const e=t.assets.products?.[r.productId];return e?`
    <figure class="product-screenshot">
      <img src="${y(e.src)}" alt="${y(e.alt)}" />
      <figcaption>${y(e.caption)}</figcaption>
    </figure>
  `:'<div class="publication-missing">Product screenshot missing</div>'}const ja={topology:ka,process:Sa,evidence:Ea,referrals:Aa,values:Ra,quote:Ta,metric:Ca,gains:Ia,logos:Na,contact:Ma,publication:Ba,pillars:Oa,illustration:za,offerings:Ha,partnership:Da,portfolio:qa,product:Fa};function tn(r,t){const e=r.theme||"dark",n=[_a(r),Ua(r,t),Ga(r,t),Ya(r,t)].join("");return`<section class="slide slide-${e} slide-${r.layout||"statement"}" data-section="${y(r.code||"")}">${n}</section>`}function _a(r){return`
    <div class="slide-topline">
      ${$a(r.code||r.parentCode||"")}
      <span class="micro-label">${y(r.status||"BNI GAINS PITCH")}</span>
    </div>
  `}function Ua(r,t){const e=r.kicker?`<p class="kicker">${y(r.kicker)}</p>`:"",n=r.title?`<h1>${y(r.title)}</h1>`:"",i=r.subtitle?`<p class="subtitle">${y(r.subtitle)}</p>`:"",a=Wa(r,t),s=Ka(r,t),l=Va(r,t);return`
  ...
  `}function Wa(r,t){return r.brandIds?.length?`
    <div class="brand-row" aria-label="Brand marks">
      ${r.brandIds.map(e=>t.assets.logos[e]).filter(Boolean).map(e=>`<img src="${y(e.src)}" alt="${y(e.alt)}" />`).join("")}
    </div>
  `:""}function Va(r,t){return r.component==="weekly"?`
      <div class="weekly-pitch">
        <p>${y(t.weekly.problem)}</p>
        <p>${y(t.weekly.solution)}</p>
        <strong>${y(t.weekly.request)}</strong>
      </div>
    `:r.monthlyRequest?`<div class="request-panel"><strong>Current request</strong><p>${y(t.monthlyRequest.request)}</p></div>`:r.points?`
    <div class="point-grid ${r.points.length>4?"compact":""}">
      ${r.points.map(e=>`<div class="point-card"><span>${y(e.label||e)}</span>${e.detail?`<p>${y(e.detail)}</p>`:""}</div>`).join("")}
    </div>
  `:""}function Ka(r,t){if(!r.component&&!r.visual)return'<div class="visual-panel empty-panel" aria-hidden="true"></div>';const e=ja[r.component||r.visual];return e?`<div class="visual-panel">${e(r,t)}</div>`:`<div class="visual-panel text-visual">${y(r.visualText||"")}</div>`}function Ga(r,t){const e=r.note||t.speakerNotes[r.id];return e?`<aside class="notes">${y(e)}</aside>`:""}function Ya(r,t){return`
    <footer>
      <span>${y(t.profile.contact.email)} | ${y(t.profile.contact.whatsapp)}</span>
    </footer>
  `}function Xa(r,t){return`
    <div class="deck-index" data-deck-index hidden>
      ...
      <aside class="deck-index-panel" role="dialog" aria-modal="true" aria-labelledby="deck-index-title">
        ...
        <nav class="deck-index-list" aria-label="Presentation slides" data-index-list>
          ${r.flatMap((n,i)=>{const a={horizontalIndex:i,verticalIndex:0,code:n.code||"",title:n.title||"Untitled slide",level:"main"},s=(n.verticals||[]).map((l,o)=>({horizontalIndex:i,verticalIndex:o+1,code:l.code||n.code||"",title:l.title||"Untitled detail",level:"detail"}));return[a,...s]}).map((n,i)=>`
                <button
                  ...
                  data-search="${y(`${n.code} ${n.title}`.toLowerCase())}"
                >
                  <span class="deck-index-number">${String(i+1).padStart(2,"0")}</span>
                  <span class="deck-index-copy">
                    <small>${y(n.code)}</small>
                    <strong>${y(n.title)}</strong>
                  </span>
                </button>
              `).join("")}
        </nav>
  ...
  `}function Ja(r){const t=r.slides.map(e=>{const n=tn(e,r),i=(e.verticals||[]).map(a=>tn({...a,parentCode:e.code},r));return i.length===0?n:`<section>${n}${i.join("")}</section>`});return`
    <div class="reveal deck-shell" data-mode="${r.mode}" data-lang="${r.lang}">
      <div class="slides">
        ${t.join("")}
      </div>
    </div>
    ${Xa(r.slides,r.lang)}
  `}function Za(r){const t=r.filter(e=>e.status!=="verified"&&e.displayOnSlide);t.length>0&&console.warn("Claims need verification before public use:",t.map(e=>`${e.id}: ${e.status}`))}const vn=ya(),Ft=vn.lang==="id"?"id":"en",re=vn.mode,en=Ft==="id"?Li:Ri,bn=Ft==="id"?Fi:Bi;document.documentElement.lang=Ft;document.title=`${bn.name} | BNI GAINS ${re}`;const Qa=document.querySelector("#app");Qa.innerHTML=Ja({slides:wa(en.slides,re),weekly:en.weekly,mode:re,lang:Ft,profile:bn,assets:mn,referrals:ra,gains:sa,cases:Xi,claims:fn,monthlyRequest:da,speakerNotes:ba});Ei({icons:{Database:vi,RefreshCw:yi,Bird:mi,Users:ki,ContactRound:fi,List:bi,Search:wi,X:Si}});Za(fn);it.initialize({width:1600,height:900,margin:.04,minScale:.2,maxScale:2,hash:!0,history:!0,controls:!0,progress:!0,center:!1,transition:"slide",transitionSpeed:"fast",backgroundTransition:"slide",navigationMode:"default",slideNumber:"c/t",pdfSeparateFragments:!1,plugins:[ri,oi,ci]});ts();es();function ts(){const r=document.querySelector("[data-deck-index]"),t=document.querySelector("[data-index-open]"),e=document.querySelector("[data-index-search]"),n=[...document.querySelectorAll("[data-index-item]")],i=document.querySelector("[data-index-empty]");if(!r||!t||!e||!i)return;const a=()=>{r.hidden=!0,t.setAttribute("aria-expanded","false"),t.focus()},s=()=>{r.hidden=!1,t.setAttribute("aria-expanded","true"),e.value="",l(),requestAnimationFrame(()=>e.focus())},l=()=>{const o=e.value.trim().toLowerCase();let c=0;n.forEach(h=>{const u=!o||h.dataset.search.includes(o);h.hidden=!u,u&&(c+=1)}),i.hidden=c!==0};t.addEventListener("click",s),r.querySelectorAll("[data-index-close]").forEach(o=>o.addEventListener("click",a)),e.addEventListener("input",l),n.forEach(o=>{o.addEventListener("click",()=>{it.slide(Number(o.dataset.horizontal),Number(o.dataset.vertical)),a()})}),document.addEventListener("keydown",o=>{const c=["INPUT","TEXTAREA","SELECT"].includes(document.activeElement?.tagName);if(o.key==="Escape"&&!r.hidden){o.preventDefault(),a();return}o.key.toLowerCase()==="i"&&!c&&(o.preventDefault(),r.hidden?s():a())},!0)}function es(){[...document.querySelectorAll("[data-language]")].forEach(t=>{t.addEventListener("click",()=>{const e=t.dataset.language,{h:n,v:i}=it.getIndices(),a=new URL(window.location.href);e==="en"?a.searchParams.delete("lang"):a.searchParams.set("lang",e),a.hash=`#/${n}${i>0?`/${i}`:""}`,window.location.assign(a.toString())})})}
