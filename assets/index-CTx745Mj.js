...
`+i))});const n=document.querySelector("head");n.insertBefore(e,n.lastChild)};class Vn{constructor(t){this.Reveal=t,this.state="idle",this.registeredPlugins={},this.asyncDependencies=[]}load(t,e){return this.state="loading",t.forEach(this.registerPlugin.bind(this)),new Promise((n=>{let i=[],a=0;if(e.forEach((r=>{r.condition&&!r.condition()||(r.async?this.asyncDependencies.push(r):i.push(r))})),i.length){a=i.length;const r=l=>{l&&typeof l.callback=="function"&&l.callback(),--a==0&&this.initPlugins().then(n)};i.forEach((l=>{typeof l.id=="string"?(this.registerPlugin(l),r(l)):typeof l.src=="string"?We(l.src,(()=>r(l))):(console.warn("Unrecognized plugin format",l),r())}))}else this.initPlugins().then(n)}))}initPlugins(){return new Promise((t=>{let e=Object.values(this.registeredPlugins),n=e.length;if(n===0)this.loadAsync().then(t);else{let i,a=()=>{--n==0?this.loadAsync().then(t):i()},r=0;i=()=>{let l=e[r++];if(typeof l.init=="function"){let o=l.init(this.Reveal);o&&typeof o.then=="function"?o.then(a):a()}else a()},i()}}))}loadAsync(){return this.state="loaded",this.asyncDependencies.length&&this.asyncDependencies.forEach((t=>{We(t.src,t.callback)})),Promise.resolve()}registerPlugin(t){arguments.length===2&&typeof arguments[0]=="string"?(t=arguments[1]).id=arguments[0]:typeof t=="function"&&(t=t());let e=t.id;typeof e!="string"?console.warn("Unrecognized plugin format; can't find plugin.id",t):this.registeredPlugins[e]===void 0?(this.registeredPlugins[e]=t,this.state==="loaded"&&typeof t.init=="function"&&t.init(this.Reveal)):console.warn('reveal.js: "'+e+'" plugin has already been registered')}hasPlugin(t){return!!this.registeredPlugins[t]}getPlugin(t){return this.registeredPlugins[t]}getRegisteredPlugins(){return this.registeredPlugins}destroy(){Object.values(this.registeredPlugins).forEach((t=>{typeof t.destroy=="function"&&t.destroy()})),this.registeredPlugins={},this.asyncDependencies=[]}}class Kn{constructor(t){this.Reveal=t,this.onSlidesClicked=this.onSlidesClicked.bind(this),this.iframeTriggerSelector=null,this.mediaTriggerSelector="[data-preview-image], [data-preview-video]",this.stateProps=["previewIframe","previewImage","previewVideo","previewFit"],this.state={}}update(){this.Reveal.getConfig().previewLinks?this.iframeTriggerSelector="a[href]:not([data-preview-link=false]), [data-preview-link]:not(a):not([data-preview-link=false])":this.iframeTriggerSelector="[data-preview-link]:not([data-preview-link=false])";const t=this.Reveal.getSlidesElement().querySelectorAll(this.iframeTriggerSelector).length>0,e=this.Reveal.getSlidesElement().querySelectorAll(this.mediaTriggerSelector).length>0;t||e?this.Reveal.getSlidesElement().addEventListener("click",this.onSlidesClicked,!1):this.Reveal.getSlidesElement().removeEventListener("click",this.onSlidesClicked,!1)}createOverlay(t){this.dom=document.createElement("div"),this.dom.classList.add("r-overlay"),this.dom.classList.add(t),this.viewport=document.createElement("div"),this.viewport.classList.add("r-overlay-viewport"),this.dom.appendChild(this.viewport),this.Reveal.getRevealElement().appendChild(this.dom)}previewIframe(t){this.close(),this.state={previewIframe:t},this.createOverlay("r-overlay-preview"),this.dom.dataset.state="loading",this.viewport.innerHTML=`<header class="r-overlay-header">
			...
			`,this.dom.querySelector(".r-overlay-close").addEventListener("click",(i=>{this.close(),i.preventDefault()}),!1),this.Reveal.dispatchEvent({type:"showhelp"})}}isOpen(){return!!this.dom}close(){return!!this.dom&&(this.dom.remove(),this.dom=null,this.state={},this.Reveal.dispatchEvent({type:"closeoverlay"}),!0)}getState(){return this.state}setState(t){this.stateProps.every((e=>this.state[e]===t[e]))||(t.previewIframe?this.previewIframe(t.previewIframe):t.previewImage?this.previewImage(t.previewImage,t.previewFit):t.previewVideo?this.previewVideo(t.previewVideo,t.previewFit):this.close())}onSlidesClicked(t){const e=t.target,n=e.closest(this.iframeTriggerSelector),i=e.closest(this.mediaTriggerSelector);if(n){if(t.metaKey||t.shiftKey||t.altKey)return;let a=n.getAttribute("href")||n.getAttribute("data-preview-link");a&&(this.previewIframe(a),t.preventDefault())}else if(i){if(i.hasAttribute("data-preview-image")){let a=i.dataset.previewImage||i.getAttribute("src");a&&(this.previewImage(a,i.dataset.previewFit),t.preventDefault())}else if(i.hasAttribute("data-preview-video")){let a=i.dataset.previewVideo||i.getAttribute("src");if(!a){let r=i.querySelector("source");r&&(a=r.getAttribute("src"))}a&&(this.previewVideo(a,i.dataset.previewFit),t.preventDefault())}}}destroy(){this.close()}}let Gn=class{constructor(t){this.Reveal=t,this.touchStartX=0,this.touchStartY=0,this.touchStartCount=0,this.touchCaptured=!1,this.onPointerDown=this.onPointerDown.bind(this),this.onPointerMove=this.onPointerMove.bind(this),this.onPointerUp=this.onPointerUp.bind(this),this.onTouchStart=this.onTouchStart.bind(this),this.onTouchMove=this.onTouchMove.bind(this),this.onTouchEnd=this.onTouchEnd.bind(this)}bind(){let t=this.Reveal.getRevealElement();"onpointerdown"in window?(t.addEventListener("pointerdown",this.onPointerDown,!1),t.addEventListener("pointermove",this.onPointerMove,!1),t.addEventListener("pointerup",this.onPointerUp,!1)):window.navigator.msPointerEnabled?(t.addEventListener("MSPointerDown",this.onPointerDown,!1),t.addEventListener("MSPointerMove",this.onPointerMove,!1),t.addEventListener("MSPointerUp",this.onPointerUp,!1)):(t.addEventListener("touchstart",this.onTouchStart,!1),t.addEventListener("touchmove",this.onTouchMove,!1),t.addEventListener("touchend",this.onTouchEnd,!1))}unbind(){let t=this.Reveal.getRevealElement();t.removeEventListener("pointerdown",this.onPointerDown,!1),t.removeEventListener("pointermove",this.onPointerMove,!1),t.removeEventListener("pointerup",this.onPointerUp,!1),t.removeEventListener("MSPointerDown",this.onPointerDown,!1),t.removeEventListener("MSPointerMove",this.onPointerMove,!1),t.removeEventListener("MSPointerUp",this.onPointerUp,!1),t.removeEventListener("touchstart",this.onTouchStart,!1),t.removeEventListener("touchmove",this.onTouchMove,!1),t.removeEventListener("touchend",this.onTouchEnd,!1)}isSwipePrevented(t){if(Dt(t,"video[controls], audio[controls]"))return!0;for(;t&&typeof t.hasAttribute=="function";){if(t.hasAttribute("data-prevent-swipe"))return!0;t=t.parentNode}return!1}onTouchStart(t){if(this.touchCaptured=!1,this.isSwipePrevented(t.target))return!0;this.touchStartX=t.touches[0].clientX,this.touchStartY=t.touches[0].clientY,this.touchStartCount=t.touches.length}onTouchMove(t){if(this.isSwipePrevented(t.target))return!0;let e=this.Reveal.getConfig();if(this.touchCaptured)ln&&t.preventDefault();else{this.Reveal.onUserInput(t);let n=t.touches[0].clientX,i=t.touches[0].clientY;if(t.touches.length===1&&this.touchStartCount!==2){let a=this.Reveal.availableRoutes({includeFragments:!0}),r=n-this.touchStartX,l=i-this.touchStartY;r>40&&Math.abs(r)>Math.abs(l)?(this.touchCaptured=!0,e.navigationMode==="linear"?e.rtl?this.Reveal.next():this.Reveal.prev():this.Reveal.left()):r<-40&&Math.abs(r)>Math.abs(l)?(this.touchCaptured=!0,e.navigationMode==="linear"?e.rtl?this.Reveal.prev():this.Reveal.next():this.Reveal.right()):l>40&&a.up?(this.touchCaptured=!0,e.navigationMode==="linear"?this.Reveal.prev():this.Reveal.up()):l<-40&&a.down&&(this.touchCaptured=!0,e.navigationMode==="linear"?this.Reveal.next():this.Reveal.down()),e.embedded?(this.touchCaptured||this.Reveal.isVerticalSlide())&&t.preventDefault():t.preventDefault()}}}onTouchEnd(t){this.touchCaptured=!1}onPointerDown(t){t.pointerType!==t.MSPOINTER_TYPE_TOUCH&&t.pointerType!=="touch"||(t.touches=[{clientX:t.clientX,clientY:t.clientY}],this.onTouchStart(t))}onPointerMove(t){t.pointerType!==t.MSPOINTER_TYPE_TOUCH&&t.pointerType!=="touch"||(t.touches=[{clientX:t.clientX,clientY:t.clientY}],this.onTouchMove(t))}onPointerUp(t){t.pointerType!==t.MSPOINTER_TYPE_TOUCH&&t.pointerType!=="touch"||(t.touches=[{clientX:t.clientX,clientY:t.clientY}],this.onTouchEnd(t))}};const ie="focus",Ve="blur";class Yn{constructor(t){this.Reveal=t,this.onRevealPointerDown=this.onRevealPointerDown.bind(this),this.onDocumentPointerDown=this.onDocumentPointerDown.bind(this)}configure(t,e){t.embedded?this.blur():(this.focus(),this.unbind())}bind(){this.Reveal.getConfig().embedded&&this.Reveal.getRevealElement().addEventListener("pointerdown",this.onRevealPointerDown,!1)}unbind(){this.Reveal.getRevealElement().removeEventListener("pointerdown",this.onRevealPointerDown,!1),document.removeEventListener("pointerdown",this.onDocumentPointerDown,!1)}focus(){this.state!==ie&&(this.Reveal.getRevealElement().classList.add("focused"),document.addEventListener("pointerdown",this.onDocumentPointerDown,!1)),this.state=ie}blur(){this.state!==Ve&&(this.Reveal.getRevealElement().classList.remove("focused"),document.removeEventListener("pointerdown",this.onDocumentPointerDown,!1)),this.state=Ve}isFocused(){return this.state===ie}destroy(){this.Reveal.getRevealElement().classList.remove("focused")}onRevealPointerDown(t){this.focus()}onDocumentPointerDown(t){let e=G(t.target,".reveal");e&&e===this.Reveal.getRevealElement()||this.blur()}}class Xn{constructor(t){this.Reveal=t}render(){this.element=document.createElement("div"),this.element.className="speaker-notes",this.element.setAttribute("data-prevent-swipe",""),this.element.setAttribute("tabindex","0"),this.Reveal.getRevealElement().appendChild(this.element)}configure(t,e){t.showNotes&&this.element.setAttribute("data-layout",typeof t.showNotes=="string"?t.showNotes:"inline")}update(){this.Reveal.getConfig().showNotes&&this.element&&this.Reveal.getCurrentSlide()&&!this.Reveal.isScrollView()&&!this.Reveal.isPrintView()&&(this.element.innerHTML=this.getSlideNotes()||'<span class="notes-placeholder">No notes on this slide.</span>')}updateVisibility(){this.Reveal.getConfig().showNotes&&this.hasNotes()&&!this.Reveal.isScrollView()&&!this.Reveal.isPrintView()?this.Reveal.getRevealElement().classList.add("show-notes"):this.Reveal.getRevealElement().classList.remove("show-notes")}hasNotes(){return this.Reveal.getSlidesElement().querySelectorAll("[data-notes], aside.notes").length>0}isSpeakerNotesWindow(){return!!window.location.search.match(/receiver/gi)}getSlideNotes(t=this.Reveal.getCurrentSlide()){if(t.hasAttribute("data-notes"))return t.getAttribute("data-notes");let e=t.querySelectorAll("aside.notes");return e?Array.from(e).map((n=>n.innerHTML)).join(`
`):null}destroy(){this.element.remove()}}class Jn{constructor(t,e){this.diameter=100,this.diameter2=this.diameter/2,this.thickness=6,this.playing=!1,this.progress=0,this.progressOffset=1,this.container=t,this.progressCheck=e,this.canvas=document.createElement("canvas"),this.canvas.className="playback",this.canvas.width=this.diameter,this.canvas.height=this.diameter,this.canvas.style.width=this.diameter2+"px",this.canvas.style.height=this.diameter2+"px",this.context=this.canvas.getContext("2d"),this.container.appendChild(this.canvas),this.render()}setPlaying(t){const e=this.playing;this.playing=t,!e&&this.playing?this.animate():this.render()}animate(){const t=this.progress;this.progress=this.progressCheck(),t>.8&&this.progress<.2&&(this.progressOffset=this.progress),this.render(),this.playing&&requestAnimationFrame(this.animate.bind(this))}render(){let t=this.playing?this.progress:0,e=this.diameter2-this.thickness,n=this.diameter2,i=this.diameter2,a=28;this.progressOffset+=.1*(1-this.progressOffset);const r=-Math.PI/2+t*(2*Math.PI),l=-Math.PI/2+this.progressOffset*(2*Math.PI);this.context.save(),this.context.clearRect(0,0,this.diameter,this.diameter),this.context.beginPath(),this.context.arc(n,i,e+4,0,2*Math.PI,!1),this.context.fillStyle="rgba( 0, 0, 0, 0.4 )",this.context.fill(),this.context.beginPath(),this.context.arc(n,i,e,0,2*Math.PI,!1),this.context.lineWidth=this.thickness,this.context.strokeStyle="rgba( 255, 255, 255, 0.2 )",this.context.stroke(),this.playing&&(this.context.beginPath(),this.context.arc(n,i,e,l,r,!1),this.context.lineWidth=this.thickness,this.context.strokeStyle="#fff",this.context.stroke()),this.context.translate(n-14,i-14),this.playing?(this.context.fillStyle="#fff",this.context.fillRect(0,0,10,a),this.context.fillRect(18,0,10,a)):(this.context.beginPath(),this.context.translate(4,0),this.context.moveTo(0,0),this.context.lineTo(24,14),this.context.lineTo(0,a),this.context.fillStyle="#fff",this.context.fill()),this.context.restore()}on(t,e){this.canvas.addEventListener(t,e,!1)}off(t,e){this.canvas.removeEventListener(t,e,!1)}destroy(){this.playing=!1,this.canvas.parentNode&&this.container.removeChild(this.canvas)}}var Zn={width:960,height:700,margin:.04,minScale:.2,maxScale:2,controls:!0,controlsTutorial:!0,controlsLayout:"bottom-right",controlsBackArrows:"faded",progress:!0,slideNumber:!1,showSlideNumber:"all",hashOneBasedIndex:!1,hash:!1,respondToHashChanges:!0,jumpToSlide:!0,history:!1,keyboard:!0,keyboardCondition:null,disableLayout:!1,overview:!0,center:!0,touch:!0,loop:!1,rtl:!1,navigationMode:"default",shuffle:!1,fragments:!0,fragmentInURL:!0,embedded:!1,help:!0,pause:!0,showNotes:!1,showHiddenSlides:!1,autoPlayMedia:null,preloadIframes:null,autoAnimate:!0,autoAnimateMatcher:null,autoAnimateEasing:"ease",autoAnimateDuration:1,autoAnimateUnmatched:!0,autoAnimateStyles:["opacity","color","background-color","padding","font-size","line-height","letter-spacing","border-width","border-color","border-radius","outline","outline-offset"],autoSlide:0,autoSlideStoppable:!0,autoSlideMethod:null,defaultTiming:null,mouseWheel:!1,previewLinks:!1,postMessage:!0,postMessageEvents:!1,focusBodyOnPageVisibilityChange:!0,transition:"slide",transitionSpeed:"default",backgroundTransition:"fade",parallaxBackgroundImage:"",parallaxBackgroundSize:"",parallaxBackgroundRepeat:"",parallaxBackgroundPosition:"",parallaxBackgroundHorizontal:null,parallaxBackgroundVertical:null,view:null,scrollLayout:"full",scrollSnap:"mandatory",scrollProgress:"auto",scrollActivationWidth:435,pdfMaxPagesPerSlide:Number.POSITIVE_INFINITY,pdfSeparateFragments:!0,pdfPageHeightOffset:-1,viewDistance:3,mobileViewDistance:2,display:"block",hideInactiveCursor:!0,hideCursorTime:5e3,sortFragmentsOnSync:!0,dependencies:[],plugins:[]};const cn="5.2.1";function dn(s,t){arguments.length<2&&(t=arguments[0],s=document.querySelector(".reveal"));const e={};let n,i,a,r,l,o={},c=!1,h=!1,u={hasNavigatedHorizontally:!1,hasNavigatedVertically:!1},g=[],v=1,L={layout:"",overview:""},p={},F="idle",x=0,q=0,J=-1,M=!1,R=new Pn(e),E=new $n(e),B=new Mn(e),U=new On(e),P=new Bn(e),f=new zn(e),I=new Hn(e),N=new Dn(e),O=new qn(e),_=new Fn(e),V=new jn(e),K=new _n(e),st=new Un(e),ce=new Wn(e),it=new Vn(e),W=new Kn(e),gt=new Yn(e),_t=new Gn(e),nt=new Xn(e);function xn(){c!==!1&&(h=!0,o.showHiddenSlides||A(p.wrapper,'section[data-visibility="hidden"]').forEach((d=>{const m=d.parentNode;m.childElementCount===1&&/section/i.test(m.nodeName)?m.remove():d.remove()})),(function(){p.slides.classList.add("no-transition"),St?p.wrapper.classList.add("no-hover"):p.wrapper.classList.remove("no-hover"),P.render(),E.render(),B.render(),K.render(),st.render(),nt.render(),p.pauseOverlay=((d,m,b,y="")=>{let w=d.querySelectorAll("."+b);for(let z=0;z<w.length;z++){let D=w[z];if(D.parentNode===d)return D}let $=document.createElement(m);return $.className=b,$.innerHTML=y,d.appendChild($),$})(p.wrapper,"div","pause-overlay",o.controls?'<button class="resume-button">Resume presentation</button>':null),p.statusElement=(function(){let d=p.wrapper.querySelector(".aria-status");return d||(d=document.createElement("div"),d.style.position="absolute",d.style.height="1px",d.style.width="1px",d.style.overflow="hidden",d.style.clip="rect( 1px, 1px, 1px, 1px )",d.classList.add("aria-status"),d.setAttribute("aria-live","polite"),d.setAttribute("aria-atomic","true"),p.wrapper.appendChild(d)),d})(),p.wrapper.setAttribute("role","application")})(),o.postMessage&&window.addEventListener("message",Oe,!1),setInterval((()=>{(!f.isActive()&&p.wrapper.scrollTop!==0||p.wrapper.scrollLeft!==0)&&(p.wrapper.scrollTop=0,p.wrapper.scrollLeft=0)}),1e3),document.addEventListener("fullscreenchange",Mt),document.addEventListener("webkitfullscreenchange",Mt),ct().forEach((d=>{A(d,"section").forEach(((m,b)=>{b>0&&(m.classList.remove("present"),m.classList.remove("past"),m.classList.add("future"),m.setAttribute("aria-hidden","true"))}))})),de(),P.update(!0),(function(){const d=o.view==="print",m=o.view==="scroll"||o.view==="reader";(d||m)&&(d?Tt():_t.unbind(),p.viewport.classList.add("loading-scroll-mode"),d?document.readyState==="complete"?I.activate():window.addEventListener("load",(()=>I.activate())):f.activate())})(),V.readURL(),setTimeout((()=>{p.slides.classList.remove("no-transition"),p.wrapper.classList.add("ready"),et({type:"ready",data:{indexh:n,indexv:i,currentSlide:r}})}),1))}function Ut(d){p.statusElement.textContent=d}function Rt(d){let m="";if(d.nodeType===3)m+=d.textContent;else if(d.nodeType===1){let b=d.getAttribute("aria-hidden"),y=window.getComputedStyle(d).display==="none";b==="true"||y||Array.from(d.childNodes).forEach((w=>{m+=Rt(w)}))}return m=m.trim(),m===""?"":m+" "}function de(d){const m={...o};if(typeof d=="object"&&kt(o,d),e.isReady()===!1)return;const b=p.wrapper.querySelectorAll(ft).length;p.wrapper.classList.remove(m.transition),p.wrapper.classList.add(o.transition),p.wrapper.setAttribute("data-transition-speed",o.transitionSpeed),p.wrapper.setAttribute("data-background-transition",o.backgroundTransition),p.viewport.style.setProperty("--slide-width",typeof o.width=="string"?o.width:o.width+"px"),p.viewport.style.setProperty("--slide-height",typeof o.height=="string"?o.height:o.height+"px"),o.shuffle&&Gt(),ee(p.wrapper,"embedded",o.embedded),ee(p.wrapper,"rtl",o.rtl),ee(p.wrapper,"center",o.center),o.pause===!1&&xt(),U.reset(),l&&(l.destroy(),l=null),b>1&&o.autoSlide&&o.autoSlideStoppable&&(l=new Jn(p.wrapper,(()=>Math.min(Math.max((Date.now()-J)/x,0),1))),l.on("click",An),M=!1),o.navigationMode!=="default"?p.wrapper.setAttribute("data-navigation-mode",o.navigationMode):p.wrapper.removeAttribute("data-navigation-mode"),nt.configure(o,m),gt.configure(o,m),ce.configure(o,m),K.configure(o,m),st.configure(o,m),_.configure(o,m),N.configure(o,m),E.configure(o,m),Ee()}function ue(){window.addEventListener("resize",De,!1),o.touch&&_t.bind(),o.keyboard&&_.bind(),o.progress&&st.bind(),o.respondToHashChanges&&V.bind(),K.bind(),gt.bind(),p.slides.addEventListener("click",He,!1),p.slides.addEventListener("transitionend",ze,!1),p.pauseOverlay.addEventListener("click",xt,!1),o.focusBodyOnPageVisibilityChange&&document.addEventListener("visibilitychange",qe,!1)}function Tt(){_t.unbind(),gt.unbind(),_.unbind(),K.unbind(),st.unbind(),V.unbind(),window.removeEventListener("resize",De,!1),p.slides.removeEventListener("click",He,!1),p.slides.removeEventListener("transitionend",ze,!1),p.pauseOverlay.removeEventListener("click",xt,!1)}function he(d,m,b){s.addEventListener(d,m,b)}function pe(d,m,b){s.removeEventListener(d,m,b)}function Wt(d){typeof d.layout=="string"&&(L.layout=d.layout),typeof d.overview=="string"&&(L.overview=d.overview),L.layout?ut(p.slides,L.layout+" "+L.overview):ut(p.slides,L.overview)}function et({target:d=p.wrapper,type:m,data:b,bubbles:y=!0}){let w=document.createEvent("HTMLEvents",1,2);return w.initEvent(m,y,!0),kt(w,b),d.dispatchEvent(w),d===p.wrapper&&me(m),w}function ge(d){et({type:"slidechanged",data:{indexh:n,indexv:i,previousSlide:a,currentSlide:r,origin:d}})}function me(d,m){if(o.postMessageEvents&&window.parent!==window.self){let b={namespace:"reveal",eventName:d,state:Me()};kt(b,m),window.parent.postMessage(JSON.stringify(b),"*")}}function bt(){if(p.wrapper&&!I.isActive()){const d=p.viewport.offsetWidth,m=p.viewport.offsetHeight;if(!o.disableLayout){St&&!o.embedded&&document.documentElement.style.setProperty("--vh",.01*window.innerHeight+"px");const b=f.isActive()?Ct(d,m):Ct(),y=v;fe(o.width,o.height),p.slides.style.width=b.width+"px",p.slides.style.height=b.height+"px",v=Math.min(b.presentationWidth/b.width,b.presentationHeight/b.height),v=Math.max(v,o.minScale),v=Math.min(v,o.maxScale),v===1||f.isActive()?(p.slides.style.zoom="",p.slides.style.left="",p.slides.style.top="",p.slides.style.bottom="",p.slides.style.right="",Wt({layout:""})):(p.slides.style.zoom="",p.slides.style.left="50%",p.slides.style.top="50%",p.slides.style.bottom="auto",p.slides.style.right="auto",Wt({layout:"translate(-50%, -50%) scale("+v+")"}));const w=Array.from(p.wrapper.querySelectorAll(ft));for(let $=0,z=w.length;$<z;$++){const D=w[$];D.style.display!=="none"&&(o.center||D.classList.contains("center")?D.classList.contains("stack")?D.style.top=0:D.style.top=Math.max((b.height-D.scrollHeight)/2,0)+"px":D.style.top="")}y!==v&&et({type:"resize",data:{oldScale:y,scale:v,size:b}})}(function(){if(p.wrapper&&!o.disableLayout&&!I.isActive()&&typeof o.scrollActivationWidth=="number"&&o.view!=="scroll"){const b=Ct();b.presentationWidth>0&&b.presentationWidth<=o.scrollActivationWidth?f.isActive()||(P.create(),f.activate()):f.isActive()&&f.deactivate()}})(),p.viewport.style.setProperty("--slide-scale",v),p.viewport.style.setProperty("--viewport-width",d+"px"),p.viewport.style.setProperty("--viewport-height",m+"px"),f.layout(),st.update(),P.updateParallax(),O.isActive()&&O.update()}}function fe(d,m){A(p.slides,"section > .stretch, section > .r-stretch").forEach((b=>{let y=((w,$=0)=>{if(w){let z,D=w.style.height;return w.style.height="0px",w.parentNode.style.height="auto",z=$-w.parentNode.offsetHeight,w.style.height=D+"px",w.parentNode.style.removeProperty("height"),z}return $})(b,m);if(/(img|video)/gi.test(b.nodeName)){const w=b.naturalWidth||b.videoWidth,$=b.naturalHeight||b.videoHeight,z=Math.min(d/w,y/$);b.style.width=w*z+"px",b.style.height=$*z+"px"}else b.style.width=d+"px",b.style.height=y+"px"}))}function Ct(d,m){let b=o.width,y=o.height;o.disableLayout&&(b=p.slides.offsetWidth,y=p.slides.offsetHeight);const w={width:b,height:y,presentationWidth:d||p.wrapper.offsetWidth,presentationHeight:m||p.wrapper.offsetHeight};return w.presentationWidth-=w.presentationWidth*o.margin,w.presentationHeight-=w.presentationHeight*o.margin,typeof w.width=="string"&&/%$/.test(w.width)&&(w.width=parseInt(w.width,10)/100*w.presentationWidth),typeof w.height=="string"&&/%$/.test(w.height)&&(w.height=parseInt(w.height,10)/100*w.presentationHeight),w}function ve(d,m){typeof d=="object"&&typeof d.setAttribute=="function"&&d.setAttribute("data-previous-indexv",m||0)}function be(d){if(typeof d=="object"&&typeof d.setAttribute=="function"&&d.classList.contains("stack")){const m=d.hasAttribute("data-start-indexv")?"data-start-indexv":"data-previous-indexv";return parseInt(d.getAttribute(m)||0,10)}return 0}function Et(d=r){return d&&d.parentNode&&!!d.parentNode.nodeName.match(/section/i)}function ye(){return!(!r||!Et(r))&&!r.nextElementSibling}function we(){return n===0&&i===0}function Vt(){return!!r&&!r.nextElementSibling&&(!Et(r)||!r.parentNode.nextElementSibling)}function ke(){if(o.pause){const d=p.wrapper.classList.contains("paused");Lt(),p.wrapper.classList.add("paused"),d===!1&&et({type:"paused"})}}function xt(){const d=p.wrapper.classList.contains("paused");p.wrapper.classList.remove("paused"),yt(),d&&et({type:"resumed"})}function Se(d){typeof d=="boolean"?d?ke():xt():At()?xt():ke()}function At(){return p.wrapper.classList.contains("paused")}function at(d,m,b,y){if(et({type:"beforeslidechange",data:{indexh:d===void 0?n:d,indexv:m===void 0?i:m,origin:y}}).defaultPrevented)return;a=r;const w=p.wrapper.querySelectorAll(dt);if(f.isActive()){const tt=f.getSlideByIndices(d,m);return void(tt&&f.scrollToSlide(tt))}if(w.length===0)return;m!==void 0||O.isActive()||(m=be(w[d])),a&&a.parentNode&&a.parentNode.classList.contains("stack")&&ve(a.parentNode,i);const $=g.concat();g.length=0;let z=n||0,D=i||0;n=xe(dt,d===void 0?n:d),i=xe(_e,m===void 0?i:m);let ot=n!==z||i!==D;ot||(a=null);let mt=w[n],Z=mt.querySelectorAll("section");s.classList.toggle("is-vertical-slide",Z.length>1),r=Z[i]||mt;let j=!1;ot&&a&&r&&!O.isActive()&&(F="running",j=Kt(a,r,z,D),j&&p.slides.classList.add("disable-slide-transitions")),Yt(),bt(),O.isActive()&&O.update(),b!==void 0&&N.goto(b),a&&a!==r&&(a.classList.remove("present"),a.setAttribute("aria-hidden","true"),we()&&setTimeout((()=>{A(p.wrapper,dt+".stack").forEach((tt=>{ve(tt,0)}))}),0));t:for(let tt=0,Rn=g.length;tt<Rn;tt++){for(let Bt=0;Bt<$.length;Bt++)if($[Bt]===g[tt]){$.splice(Bt,1);continue t}p.viewport.classList.add(g[tt]),et({type:g[tt]})}for(;$.length;)p.viewport.classList.remove($.pop());ot&&ge(y),!ot&&a||(R.stopEmbeddedContent(a),R.startEmbeddedContent(r)),requestAnimationFrame((()=>{Ut(Rt(r))})),st.update(),K.update(),nt.update(),P.update(),P.updateParallax(),E.update(),N.update(),V.writeURL(),yt(),j&&(setTimeout((()=>{p.slides.classList.remove("disable-slide-transitions")}),0),o.autoAnimate&&U.run(a,r))}function Kt(d,m,b,y){return d.hasAttribute("data-auto-animate")&&m.hasAttribute("data-auto-animate")&&d.getAttribute("data-auto-animate-id")===m.getAttribute("data-auto-animate-id")&&!(n>b||i>y?m:d).hasAttribute("data-auto-animate-restart")}function Ee(){Tt(),ue(),bt(),x=o.autoSlide,yt(),P.create(),V.writeURL(),o.sortFragmentsOnSync===!0&&N.sortAll(),K.update(),st.update(),Yt(),nt.update(),nt.updateVisibility(),W.update(),P.update(!0),E.update(),R.formatEmbeddedContent(),o.autoPlayMedia===!1?R.stopEmbeddedContent(r,{unloadIframes:!1}):R.startEmbeddedContent(r),O.isActive()&&O.layout()}function Gt(d=ct()){d.forEach(((m,b)=>{let y=d[Math.floor(Math.random()*d.length)];y.parentNode===m.parentNode&&m.parentNode.insertBefore(m,y);let w=m.querySelectorAll("section");w.length&&Gt(w)}))}function xe(d,m){let b=A(p.wrapper,d),y=b.length,w=f.isActive()||I.isActive(),$=!1,z=!1;if(y){o.loop&&(m>=y&&($=!0),(m%=y)<0&&(m=y+m,z=!0)),m=Math.max(Math.min(m,y-1),0);for(let Z=0;Z<y;Z++){let j=b[Z],tt=o.rtl&&!Et(j);j.classList.remove("past"),j.classList.remove("present"),j.classList.remove("future"),j.setAttribute("hidden",""),j.setAttribute("aria-hidden","true"),j.querySelector("section")&&j.classList.add("stack"),w?j.classList.add("present"):Z<m?(j.classList.add(tt?"future":"past"),o.fragments&&Ae(j)):Z>m?(j.classList.add(tt?"past":"future"),o.fragments&&Re(j)):Z===m&&o.fragments&&($?Re(j):z&&Ae(j))}let D=b[m],ot=D.classList.contains("present");D.classList.add("present"),D.removeAttribute("hidden"),D.removeAttribute("aria-hidden"),ot||et({target:D,type:"visible",bubbles:!1});let mt=D.getAttribute("data-state");mt&&(g=g.concat(mt.split(" ")))}else m=0;return m}function Ae(d){A(d,".fragment").forEach((m=>{m.classList.add("visible"),m.classList.remove("current-fragment")}))}function Re(d){A(d,".fragment.visible").forEach((m=>{m.classList.remove("visible","current-fragment")}))}function Yt(){let d,m,b=ct(),y=b.length;if(y&&n!==void 0){let w=O.isActive()?10:o.viewDistance;St&&(w=O.isActive()?6:o.mobileViewDistance),I.isActive()&&(w=Number.MAX_VALUE);for(let $=0;$<y;$++){let z=b[$],D=A(z,"section"),ot=D.length;if(d=Math.abs((n||0)-$)||0,o.loop&&(d=Math.abs(((n||0)-$)%(y-w))||0),d<w?R.load(z):R.unload(z),ot){let mt=be(z);for(let Z=0;Z<ot;Z++){let j=D[Z];m=Math.abs($===(n||0)?(i||0)-Z:Z-mt),d+m<w?R.load(j):R.unload(j)}}}Pe()?p.wrapper.classList.add("has-vertical-slides"):p.wrapper.classList.remove("has-vertical-slides"),Ie()?p.wrapper.classList.add("has-horizontal-slides"):p.wrapper.classList.remove("has-horizontal-slides")}}function rt({includeFragments:d=!1}={}){let m=p.wrapper.querySelectorAll(dt),b=p.wrapper.querySelectorAll(_e),y={left:n>0,right:n<m.length-1,up:i>0,down:i<b.length-1};if(o.loop&&(m.length>1&&(y.left=!0,y.right=!0),b.length>1&&(y.up=!0,y.down=!0)),m.length>1&&o.navigationMode==="linear"&&(y.right=y.right||y.down,y.left=y.left||y.up),d===!0){let w=N.availableRoutes();y.left=y.left||w.prev,y.up=y.up||w.prev,y.down=y.down||w.next,y.right=y.right||w.next}if(o.rtl){let w=y.left;y.left=y.right,y.right=w}return y}function Te(d=r){let m=ct(),b=0;t:for(let y=0;y<m.length;y++){let w=m[y],$=w.querySelectorAll("section");for(let z=0;z<$.length;z++){if($[z]===d)break t;$[z].dataset.visibility!=="uncounted"&&b++}if(w===d)break;w.classList.contains("stack")===!1&&w.dataset.visibility!=="uncounted"&&b++}return b}function Ce(d){let m,b=n,y=i;if(d)if(f.isActive())b=parseInt(d.getAttribute("data-index-h"),10),d.getAttribute("data-index-v")&&(y=parseInt(d.getAttribute("data-index-v"),10));else{let w=Et(d),$=w?d.parentNode:d,z=ct();b=Math.max(z.indexOf($),0),y=void 0,w&&(y=Math.max(A(d.parentNode,"section").indexOf(d),0))}if(!d&&r&&r.querySelectorAll(".fragment").length>0){let w=r.querySelector(".current-fragment");m=w&&w.hasAttribute("data-fragment-index")?parseInt(w.getAttribute("data-fragment-index"),10):r.querySelectorAll(".fragment.visible").length-1}return{h:b,v:y,f:m}}function Xt(){return A(p.wrapper,ft+':not(.stack):not([data-visibility="uncounted"])')}function ct(){return A(p.wrapper,dt)}function Le(){return A(p.wrapper,".slides>section>section")}function Ie(){return ct().length>1}function Pe(){return Le().length>1}function Ne(){return Xt().length}function $e(d,m){let b=ct()[d],y=b&&b.querySelectorAll("section");return y&&y.length&&typeof m=="number"?y?y[m]:void 0:b}function Me(){let d=Ce();return{indexh:d.h,indexv:d.v,indexf:d.f,paused:At(),overview:O.isActive(),...W.getState()}}function yt(){if(Lt(),r&&o.autoSlide!==!1){let d=r.querySelector(".current-fragment[data-autoslide]"),m=d?d.getAttribute("data-autoslide"):null,b=r.parentNode?r.parentNode.getAttribute("data-autoslide"):null,y=r.getAttribute("data-autoslide");m?x=parseInt(m,10):y?x=parseInt(y,10):b?x=parseInt(b,10):(x=o.autoSlide,r.querySelectorAll(".fragment").length===0&&A(r,"video, audio").forEach((w=>{w.hasAttribute("data-autoplay")&&x&&1e3*w.duration/w.playbackRate>x&&(x=1e3*w.duration/w.playbackRate+1e3)}))),!x||M||At()||O.isActive()||Vt()&&!N.availableRoutes().next&&o.loop!==!0||(q=setTimeout((()=>{typeof o.autoSlideMethod=="function"?o.autoSlideMethod():Qt(),yt()}),x),J=Date.now()),l&&l.setPlaying(q!==-1)}}function Lt(){clearTimeout(q),q=-1}function It(){x&&!M&&(M=!0,et({type:"autoslidepaused"}),clearTimeout(q),l&&l.setPlaying(!1))}function Pt(){x&&M&&(M=!1,et({type:"autoslideresumed"}),yt())}function Nt({skipFragments:d=!1}={}){if(u.hasNavigatedHorizontally=!0,f.isActive())return f.prev();o.rtl?(O.isActive()||d||N.next()===!1)&&rt().left&&at(n+1,o.navigationMode==="grid"?i:void 0):(O.isActive()||d||N.prev()===!1)&&rt().left&&at(n-1,o.navigationMode==="grid"?i:void 0)}function $t({skipFragments:d=!1}={}){if(u.hasNavigatedHorizontally=!0,f.isActive())return f.next();o.rtl?(O.isActive()||d||N.prev()===!1)&&rt().right&&at(n-1,o.navigationMode==="grid"?i:void 0):(O.isActive()||d||N.next()===!1)&&rt().right&&at(n+1,o.navigationMode==="grid"?i:void 0)}function Jt({skipFragments:d=!1}={}){if(f.isActive())return f.prev();(O.isActive()||d||N.prev()===!1)&&rt().up&&at(n,i-1)}function Zt({skipFragments:d=!1}={}){if(u.hasNavigatedVertically=!0,f.isActive())return f.next();(O.isActive()||d||N.next()===!1)&&rt().down&&at(n,i+1)}function Be({skipFragments:d=!1}={}){if(f.isActive())return f.prev();if(d||N.prev()===!1)if(rt().up)Jt({skipFragments:d});else{let m;if(m=o.rtl?A(p.wrapper,dt+".future").pop():A(p.wrapper,dt+".past").pop(),m&&m.classList.contains("stack")){let b=m.querySelectorAll("section").length-1||void 0;at(n-1,b)}else o.rtl?$t({skipFragments:d}):Nt({skipFragments:d})}}function Qt({skipFragments:d=!1}={}){if(u.hasNavigatedHorizontally=!0,u.hasNavigatedVertically=!0,f.isActive())return f.next();if(d||N.next()===!1){let m=rt();m.down&&m.right&&o.loop&&ye()&&(m.down=!1),m.down?Zt({skipFragments:d}):o.rtl?Nt({skipFragments:d}):$t({skipFragments:d})}}function Oe(d){let m=d.data;if(typeof m=="string"&&m.charAt(0)==="{"&&m.charAt(m.length-1)==="}"&&(m=JSON.parse(m),m.method&&typeof e[m.method]=="function"))if(Nn.test(m.method)===!1){const b=e[m.method].apply(e,m.args);me("callback",{method:m.method,result:b})}else console.warn('reveal.js: "'+m.method+'" is is blacklisted from the postMessage API')}function ze(d){F==="running"&&/section/gi.test(d.target.nodeName)&&(F="idle",et({type:"slidetransitionend",data:{indexh:n,indexv:i,previousSlide:a,currentSlide:r}}))}function He(d){const m=G(d.target,'a[href^="#"]');if(m){const b=m.getAttribute("href"),y=V.getIndicesFromHash(b);y&&(e.slide(y.h,y.v,y.f),d.preventDefault())}}function De(d){bt()}function qe(d){document.hidden===!1&&document.activeElement!==document.body&&(typeof document.activeElement.blur=="function"&&document.activeElement.blur(),document.body.focus())}function Mt(d){(document.fullscreenElement||document.webkitFullscreenElement)===p.wrapper&&(d.stopImmediatePropagation(),setTimeout((()=>{e.layout(),e.focus.focus()}),1))}function An(d){Vt()&&o.loop===!1?(at(0,0),Pt()):M?Pt():It()}const Fe={VERSION:cn,initialize:function(d){if(!s)throw'Unable to find presentation root (<div class="reveal">).';if(c)throw"Reveal.js has already been initialized.";if(c=!0,p.wrapper=s,p.slides=s.querySelector(".slides"),!p.slides)throw'Unable to find slides container (<div class="slides">).';return o={...Zn,...o,...t,...d,...je()},/print-pdf/gi.test(window.location.search)&&(o.view="print"),(function(){o.embedded===!0?p.viewport=G(s,".reveal-viewport")||s:(p.viewport=document.body,document.documentElement.classList.add("reveal-full-page")),p.viewport.classList.add("reveal-viewport")})(),window.addEventListener("load",bt,!1),it.load(o.plugins,o.dependencies).then(xn),new Promise((m=>e.on("ready",m)))},configure:de,destroy:function(){c=!1,h!==!1&&(Tt(),Lt(),nt.destroy(),gt.destroy(),W.destroy(),it.destroy(),ce.destroy(),K.destroy(),st.destroy(),P.destroy(),E.destroy(),B.destroy(),document.removeEventListener("fullscreenchange",Mt),document.removeEventListener("webkitfullscreenchange",Mt),document.removeEventListener("visibilitychange",qe,!1),window.removeEventListener("message",Oe,!1),window.removeEventListener("load",bt,!1),p.pauseOverlay&&p.pauseOverlay.remove(),p.statusElement&&p.statusElement.remove(),document.documentElement.classList.remove("reveal-full-page"),p.wrapper.classList.remove("ready","center","has-horizontal-slides","has-vertical-slides"),p.wrapper.removeAttribute("data-transition-speed"),p.wrapper.removeAttribute("data-background-transition"),p.viewport.classList.remove("reveal-viewport"),p.viewport.style.removeProperty("--slide-width"),p.viewport.style.removeProperty("--slide-height"),p.slides.style.removeProperty("width"),p.slides.style.removeProperty("height"),p.slides.style.removeProperty("zoom"),p.slides.style.removeProperty("left"),p.slides.style.removeProperty("top"),p.slides.style.removeProperty("bottom"),p.slides.style.removeProperty("right"),p.slides.style.removeProperty("transform"),Array.from(p.wrapper.querySelectorAll(ft)).forEach((d=>{d.style.removeProperty("display"),d.style.removeProperty("top"),d.removeAttribute("hidden"),d.removeAttribute("aria-hidden")})))},sync:Ee,syncSlide:function(d=r){P.sync(d),N.sync(d),R.load(d),P.update(),nt.update()},syncFragments:N.sync.bind(N),slide:at,left:Nt,right:$t,up:Jt,down:Zt,prev:Be,next:Qt,navigateLeft:Nt,navigateRight:$t,navigateUp:Jt,navigateDown:Zt,navigatePrev:Be,navigateNext:Qt,navigateFragment:N.goto.bind(N),prevFragment:N.prev.bind(N),nextFragment:N.next.bind(N),on:he,off:pe,addEventListener:he,removeEventListener:pe,layout:bt,shuffle:Gt,availableRoutes:rt,availableFragments:N.availableRoutes.bind(N),toggleHelp:W.toggleHelp.bind(W),toggleOverview:O.toggle.bind(O),toggleScrollView:f.toggle.bind(f),togglePause:Se,toggleAutoSlide:function(d){typeof d=="boolean"?d?Pt():It():M?Pt():It()},toggleJumpToSlide:function(d){typeof d=="boolean"?d?B.show():B.hide():B.isVisible()?B.hide():B.show()},isFirstSlide:we,isLastSlide:Vt,isLastVerticalSlide:ye,isVerticalSlide:Et,isVerticalStack:function(d=r){return d.classList.contains(".stack")||d.querySelector("section")!==null},isPaused:At,isAutoSliding:function(){return!(!x||M)},isSpeakerNotes:nt.isSpeakerNotesWindow.bind(nt),isOverview:O.isActive.bind(O),isFocused:gt.isFocused.bind(gt),isOverlayOpen:W.isOpen.bind(W),isScrollView:f.isActive.bind(f),isPrintView:I.isActive.bind(I),isReady:()=>h,loadSlide:R.load.bind(R),unloadSlide:R.unload.bind(R),startEmbeddedContent:()=>R.startEmbeddedContent(r),stopEmbeddedContent:()=>R.stopEmbeddedContent(r,{unloadIframes:!1}),previewIframe:W.previewIframe.bind(W),previewImage:W.previewImage.bind(W),previewVideo:W.previewVideo.bind(W),showPreview:W.previewIframe.bind(W),hidePreview:W.close.bind(W),addEventListeners:ue,removeEventListeners:Tt,dispatchEvent:et,getState:Me,setState:function(d){if(typeof d=="object"){at(wt(d.indexh),wt(d.indexv),wt(d.indexf));let m=wt(d.paused),b=wt(d.overview);typeof m=="boolean"&&m!==At()&&Se(m),typeof b=="boolean"&&b!==O.isActive()&&O.toggle(b),W.setState(d)}},getProgress:function(){let d=Ne(),m=Te();if(r){let b=r.querySelectorAll(".fragment");b.length>0&&(m+=r.querySelectorAll(".fragment.visible").length/b.length*.9)}return Math.min(m/(d-1),1)},getIndices:Ce,getSlidesAttributes:function(){return Xt().map((d=>{let m={};for(let b=0;b<d.attributes.length;b++){let y=d.attributes[b];m[y.name]=y.value}return m}))},getSlidePastCount:Te,getTotalSlides:Ne,getSlide:$e,getPreviousSlide:()=>a,getCurrentSlide:()=>r,getSlideBackground:function(d,m){let b=typeof d=="number"?$e(d,m):d;if(b)return b.slideBackgroundElement},getSlideNotes:nt.getSlideNotes.bind(nt),getSlides:Xt,getHorizontalSlides:ct,getVerticalSlides:Le,hasHorizontalSlides:Ie,hasVerticalSlides:Pe,hasNavigatedHorizontally:()=>u.hasNavigatedHorizontally,hasNavigatedVertically:()=>u.hasNavigatedVertically,shouldAutoAnimateBetween:Kt,addKeyBinding:_.addKeyBinding.bind(_),removeKeyBinding:_.removeKeyBinding.bind(_),triggerKey:_.triggerKey.bind(_),registerKeyboardShortcut:_.registerKeyboardShortcut.bind(_),getComputedSlideSize:Ct,setCurrentScrollPage:function(d,m,b){let y=n||0;n=m,i=b;const w=r!==d;a=r,r=d,r&&a&&o.autoAnimate&&Kt(a,r,y,i)&&U.run(a,r),w&&(a&&(R.stopEmbeddedContent(a),R.stopEmbeddedContent(a.slideBackgroundElement)),R.startEmbeddedContent(r),R.startEmbeddedContent(r.slideBackgroundElement)),requestAnimationFrame((()=>{Ut(Rt(r))})),ge()},getScale:()=>v,getConfig:()=>o,getQueryHash:je,getSlidePath:V.getHash.bind(V),getRevealElement:()=>s,getSlidesElement:()=>p.slides,getViewportElement:()=>p.viewport,getBackgroundsElement:()=>P.element,registerPlugin:it.registerPlugin.bind(it),hasPlugin:it.hasPlugin.bind(it),getPlugin:it.getPlugin.bind(it),getPlugins:it.getRegisteredPlugins.bind(it)};return kt(e,{...Fe,announceStatus:Ut,getStatusText:Rt,focus:gt,scroll:f,progress:st,controls:K,location:V,overview:O,keyboard:_,fragments:N,backgrounds:P,slideContent:R,slideNumber:E,onUserInput:function(d){o.autoSlideStoppable&&It()},closeOverlay:W.close.bind(W),updateSlidesVisibility:Yt,layoutSlideContents:fe,transformSlides:Wt,cueAutoSlide:yt,cancelAutoSlide:Lt}),Fe}let X=dn,Ke=[];X.initialize=s=>(Object.assign(X,new dn(document.querySelector(".reveal"),s)),Ke.map((t=>t(X))),X.initialize()),["configure","on","off","addEventListener","removeEventListener","registerPlugin"].forEach((s=>{X[s]=(...t)=>{Ke.push((e=>e[s].call(null,...t)))}})),X.isReady=()=>!1,X.VERSION=cn;function Qn(){return{async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1}}let vt={async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1};const un=/[&<>"']/,ti=new RegExp(un.source,"g"),hn=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,ei=new RegExp(hn.source,"g"),ni={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Ge=s=>ni[s];function Y(s,t){if(t){if(un.test(s))return s.replace(ti,Ge)}else if(hn.test(s))return s.replace(ei,Ge);return s}const ii=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi;function pn(s){return s.replace(ii,((t,e)=>(e=e.toLowerCase())==="colon"?":":e.charAt(0)==="#"?e.charAt(1)==="x"?String.fromCharCode(parseInt(e.substring(2),16)):String.fromCharCode(+e.substring(1)):""))}const ai=/(^|[^\[])\^/g;function H(s,t){s=typeof s=="string"?s:s.source,t=t||"";const e={replace:(n,i)=>(i=(i=i.source||i).replace(ai,"$1"),s=s.replace(n,i),e),getRegex:()=>new RegExp(s,t)};return e}const si=/[^\w:]/g,ri=/^$|^[a-z][a-z0-9+.-]*:|^[?#]/i;function Ye(s,t,e){if(s){let n;try{n=decodeURIComponent(pn(e)).replace(si,"").toLowerCase()}catch{return null}if(n.indexOf("javascript:")===0||n.indexOf("vbscript:")===0||n.indexOf("data:")===0)return null}t&&!ri.test(e)&&(e=(function(n,i){Ot[" "+n]||(oi.test(n)?Ot[" "+n]=n+"/":Ot[" "+n]=zt(n,"/",!0)),n=Ot[" "+n];const a=n.indexOf(":")===-1;return i.substring(0,2)==="//"?a?i:n.replace(li,"$1")+i:i.charAt(0)==="/"?a?i:n.replace(ci,"$1")+i:n+i})(t,e));try{e=encodeURI(e).replace(/%25/g,"%")}catch{return null}return e}const Ot={},oi=/^[^:]+:\/*[^/]*$/,li=/^([^:]+:)[\s\S]*$/,ci=/^([^:]+:\/*[^/]*)[\s\S]*$/,qt={exec:function(){}};function Xe(s,t){const e=s.replace(/\|/g,((i,a,r)=>{let l=!1,o=a;for(;--o>=0&&r[o]==="\\";)l=!l;return l?"|":" |"})).split(/ \|/);let n=0;if(e[0].trim()||e.shift(),e.length>0&&!e[e.length-1].trim()&&e.pop(),e.length>t)e.splice(t);else for(;e.length<t;)e.push("");for(;n<e.length;n++)e[n]=e[n].trim().replace(/\\\|/g,"|");return e}function zt(s,t,e){const n=s.length;if(n===0)return"";let i=0;for(;i<n;){const a=s.charAt(n-i-1);if(a!==t||e){if(a===t||!e)break;i++}else i++}return s.slice(0,n-i)}function Je(s,t){if(t<1)return"";let e="";for(;t>1;)1&t&&(e+=s),t>>=1,s+=s;return e+s}function Ze(s,t,e,n){const i=t.href,a=t.title?Y(t.title):null,r=s[1].replace(/\\([\[\]])/g,"$1");if(s[0].charAt(0)!=="!"){n.state.inLink=!0;const l={type:"link",raw:e,href:i,title:a,text:r,tokens:n.inlineTokens(r)};return n.state.inLink=!1,l}return{type:"image",raw:e,href:i,title:a,text:Y(r)}}class re{constructor(t){this.options=t||vt}space(t){const e=this.rules.block.newline.exec(t);if(e&&e[0].length>0)return{type:"space",raw:e[0]}}code(t){const e=this.rules.block.code.exec(t);if(e){const n=e[0].replace(/^ {1,4}/gm,"");return{type:"code",raw:e[0],codeBlockStyle:"indented",text:this.options.pedantic?n:zt(n,`
...
`+n.raw,i.text+=`
`+n.text,this.inlineQueue.pop(),this.inlineQueue[this.inlineQueue.length-1].src=i.text):e.push(n);else if(t){const l="Infinite loop on byte: "+t.charCodeAt(0);if(this.options.silent){console.error(l);break}throw new Error(l)}}return this.state.top=!0,e}inline(t,e=[]){return this.inlineQueue.push({src:t,tokens:e}),e}inlineTokens(t,e=[]){let n,i,a,r,l,o,c=t;if(this.tokens.links){const h=Object.keys(this.tokens.links);if(h.length>0)for(;(r=this.tokenizer.rules.inline.reflinkSearch.exec(c))!=null;)h.includes(r[0].slice(r[0].lastIndexOf("[")+1,-1))&&(c=c.slice(0,r.index)+"["+Je("a",r[0].length-2)+"]"+c.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(r=this.tokenizer.rules.inline.blockSkip.exec(c))!=null;)c=c.slice(0,r.index)+"["+Je("a",r[0].length-2)+"]"+c.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);for(;(r=this.tokenizer.rules.inline.escapedEmSt.exec(c))!=null;)c=c.slice(0,r.index+r[0].length-2)+"++"+c.slice(this.tokenizer.rules.inline.escapedEmSt.lastIndex),this.tokenizer.rules.inline.escapedEmSt.lastIndex--;for(;t;)if(l||(o=""),l=!1,!(this.options.extensions&&this.options.extensions.inline&&this.options.extensions.inline.some((h=>!!(n=h.call({lexer:this},t,e))&&(t=t.substring(n.raw.length),e.push(n),!0)))))if(n=this.tokenizer.escape(t))t=t.substring(n.raw.length),e.push(n);else if(n=this.tokenizer.tag(t))t=t.substring(n.raw.length),i=e[e.length-1],i&&n.type==="text"&&i.type==="text"?(i.raw+=n.raw,i.text+=n.text):e.push(n);else if(n=this.tokenizer.link(t))t=t.substring(n.raw.length),e.push(n);else if(n=this.tokenizer.reflink(t,this.tokens.links))t=t.substring(n.raw.length),i=e[e.length-1],i&&n.type==="text"&&i.type==="text"?(i.raw+=n.raw,i.text+=n.text):e.push(n);else if(n=this.tokenizer.emStrong(t,c,o))t=t.substring(n.raw.length),e.push(n);else if(n=this.tokenizer.codespan(t))t=t.substring(n.raw.length),e.push(n);else if(n=this.tokenizer.br(t))t=t.substring(n.raw.length),e.push(n);else if(n=this.tokenizer.del(t))t=t.substring(n.raw.length),e.push(n);else if(n=this.tokenizer.autolink(t,Qe))t=t.substring(n.raw.length),e.push(n);else if(this.state.inLink||!(n=this.tokenizer.url(t,Qe))){if(a=t,this.options.extensions&&this.options.extensions.startInline){let h=1/0;const u=t.slice(1);let g;this.options.extensions.startInline.forEach((function(v){g=v.call({lexer:this},u),typeof g=="number"&&g>=0&&(h=Math.min(h,g))})),h<1/0&&h>=0&&(a=t.substring(0,h+1))}if(n=this.tokenizer.inlineText(a,di))t=t.substring(n.raw.length),n.raw.slice(-1)!=="_"&&(o=n.raw.slice(-1)),l=!0,i=e[e.length-1],i&&i.type==="text"?(i.raw+=n.raw,i.text+=n.text):e.push(n);else if(t){const h="Infinite loop on byte: "+t.charCodeAt(0);if(this.options.silent){console.error(h);break}throw new Error(h)}}else t=t.substring(n.raw.length),e.push(n);return e}}class oe{constructor(t){this.options=t||vt}code(t,e,n){const i=(e||"").match(/\S*/)[0];if(this.options.highlight){const a=this.options.highlight(t,i);a!=null&&a!==t&&(n=!0,t=a)}return t=t.replace(/\n$/,"")+`
...
`}strong(t){return`<strong>${t}</strong>`}em(t){return`<em>${t}</em>`}codespan(t){return`<code>${t}</code>`}br(){return this.options.xhtml?"<br/>":"<br>"}del(t){return`<del>${t}</del>`}link(t,e,n){if((t=Ye(this.options.sanitize,this.options.baseUrl,t))===null)return n;let i='<a href="'+t+'"';return e&&(i+=' title="'+e+'"'),i+=">"+n+"</a>",i}image(t,e,n){if((t=Ye(this.options.sanitize,this.options.baseUrl,t))===null)return n;let i=`<img src="${t}" alt="${n}"`;return e&&(i+=` title="${e}"`),i+=this.options.xhtml?"/>":">",i}text(t){return t}}class gn{strong(t){return t}em(t){return t}codespan(t){return t}del(t){return t}html(t){return t}text(t){return t}link(t,e,n){return""+n}image(t,e,n){return""+n}br(){return""}}class mn{constructor(){this.seen={}}serialize(t){return t.toLowerCase().trim().replace(/<[!\/a-z].*?>/gi,"").replace(/[\u2000-\u206F\u2E00-\u2E7F\\'!"#$%&()*+,./:;<=>?@[\]^`{|}~]/g,"").replace(/\s/g,"-")}getNextSafeSlug(t,e){let n=t,i=0;if(this.seen.hasOwnProperty(n)){i=this.seen[t];do i++,n=t+"-"+i;while(this.seen.hasOwnProperty(n))}return e||(this.seen[t]=i,this.seen[n]=0),n}slug(t,e={}){const n=this.serialize(t);return this.getNextSafeSlug(n,e.dryrun)}}class pt{constructor(t){this.options=t||vt,this.options.renderer=this.options.renderer||new oe,this.renderer=this.options.renderer,this.renderer.options=this.options,this.textRenderer=new gn,this.slugger=new mn}static parse(t,e){return new pt(e).parse(t)}static parseInline(t,e){return new pt(e).parseInline(t)}parse(t,e=!0){let n,i,a,r,l,o,c,h,u,g,v,L,p,F,x,q,J,M,R,E="";const B=t.length;for(n=0;n<B;n++)if(g=t[n],this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[g.type]&&(R=this.options.extensions.renderers[g.type].call({parser:this},g),R!==!1||!["space","hr","heading","code","table","blockquote","list","html","paragraph","text"].includes(g.type)))E+=R||"";else switch(g.type){case"space":continue;case"hr":E+=this.renderer.hr();continue;case"heading":E+=this.renderer.heading(this.parseInline(g.tokens),g.depth,pn(this.parseInline(g.tokens,this.textRenderer)),this.slugger);continue;case"code":E+=this.renderer.code(g.text,g.lang,g.escaped);continue;case"table":for(h="",c="",r=g.header.length,i=0;i<r;i++)c+=this.renderer.tablecell(this.parseInline(g.header[i].tokens),{header:!0,align:g.align[i]});for(h+=this.renderer.tablerow(c),u="",r=g.rows.length,i=0;i<r;i++){for(o=g.rows[i],c="",l=o.length,a=0;a<l;a++)c+=this.renderer.tablecell(this.parseInline(o[a].tokens),{header:!1,align:g.align[a]});u+=this.renderer.tablerow(c)}E+=this.renderer.table(h,u);continue;case"blockquote":u=this.parse(g.tokens),E+=this.renderer.blockquote(u);continue;case"list":for(v=g.ordered,L=g.start,p=g.loose,r=g.items.length,u="",i=0;i<r;i++)x=g.items[i],q=x.checked,J=x.task,F="",x.task&&(M=this.renderer.checkbox(q),p?x.tokens.length>0&&x.tokens[0].type==="paragraph"?(x.tokens[0].text=M+" "+x.tokens[0].text,x.tokens[0].tokens&&x.tokens[0].tokens.length>0&&x.tokens[0].tokens[0].type==="text"&&(x.tokens[0].tokens[0].text=M+" "+x.tokens[0].tokens[0].text)):x.tokens.unshift({type:"text",text:M}):F+=M),F+=this.parse(x.tokens,p),u+=this.renderer.listitem(F,J,q);E+=this.renderer.list(u,v,L);continue;case"html":E+=this.renderer.html(g.text);continue;case"paragraph":E+=this.renderer.paragraph(this.parseInline(g.tokens));continue;case"text":for(u=g.tokens?this.parseInline(g.tokens):g.text;n+1<B&&t[n+1].type==="text";)g=t[++n],u+=`
`+(g.tokens?this.parseInline(g.tokens):g.text);E+=e?this.renderer.paragraph(u):u;continue;default:{const U='Token with "'+g.type+'" type was not found.';if(this.options.silent)return void console.error(U);throw new Error(U)}}return E}parseInline(t,e){e=e||this.renderer;let n,i,a,r="";const l=t.length;for(n=0;n<l;n++)if(i=t[n],this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[i.type]&&(a=this.options.extensions.renderers[i.type].call({parser:this},i),a!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(i.type)))r+=a||"";else switch(i.type){case"escape":case"text":r+=e.text(i.text);break;case"html":r+=e.html(i.text);break;case"link":r+=e.link(i.href,i.title,this.parseInline(i.tokens,e));break;case"image":r+=e.image(i.href,i.title,i.text);break;case"strong":r+=e.strong(this.parseInline(i.tokens,e));break;case"em":r+=e.em(this.parseInline(i.tokens,e));break;case"codespan":r+=e.codespan(i.text);break;case"br":r+=e.br();break;case"del":r+=e.del(this.parseInline(i.tokens,e));break;default:{const o='Token with "'+i.type+'" type was not found.';if(this.options.silent)return void console.error(o);throw new Error(o)}}return r}}class Ht{constructor(t){this.options=t||vt}preprocess(t){return t}postprocess(t){return t}}te(Ht,"passThroughHooks",new Set(["preprocess","postprocess"]));function fn(s,t){return(e,n,i)=>{typeof n=="function"&&(i=n,n=null);const a={...n},r=(function(l,o,c){return h=>{if(h.message+=`
Please report this to https://github.com/markedjs/marked.`,l){const u="<p>An error occurred:</p><pre>"+Y(h.message+"",!0)+"</pre>";return o?Promise.resolve(u):c?void c(null,u):u}if(o)return Promise.reject(h);if(!c)throw h;c(h)}})((n={...T.defaults,...a}).silent,n.async,i);if(e==null)return r(new Error("marked(): input parameter is undefined or null"));if(typeof e!="string")return r(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(e)+", string expected"));if((function(l){l&&l.sanitize&&!l.silent&&console.warn("marked(): sanitize and sanitizer parameters are deprecated since version 0.7.0, should not be used and will be removed in the future. Read more here: https://marked.js.org/#/USING_ADVANCED.md#options")})(n),n.hooks&&(n.hooks.options=n),i){const l=n.highlight;let o;try{n.hooks&&(e=n.hooks.preprocess(e)),o=s(e,n)}catch(u){return r(u)}const c=function(u){let g;if(!u)try{n.walkTokens&&T.walkTokens(o,n.walkTokens),g=t(o,n),n.hooks&&(g=n.hooks.postprocess(g))}catch(v){u=v}return n.highlight=l,u?r(u):i(null,g)};if(!l||l.length<3||(delete n.highlight,!o.length))return c();let h=0;return T.walkTokens(o,(function(u){u.type==="code"&&(h++,setTimeout((()=>{l(u.text,u.lang,(function(g,v){if(g)return c(g);v!=null&&v!==u.text&&(u.text=v,u.escaped=!0),h--,h===0&&c()}))}),0))})),void(h===0&&c())}if(n.async)return Promise.resolve(n.hooks?n.hooks.preprocess(e):e).then((l=>s(l,n))).then((l=>n.walkTokens?Promise.all(T.walkTokens(l,n.walkTokens)).then((()=>l)):l)).then((l=>t(l,n))).then((l=>n.hooks?n.hooks.postprocess(l):l)).catch(r);try{n.hooks&&(e=n.hooks.preprocess(e));const l=s(e,n);n.walkTokens&&T.walkTokens(l,n.walkTokens);let o=t(l,n);return n.hooks&&(o=n.hooks.postprocess(o)),o}catch(l){return r(l)}}}function T(s,t,e){return fn(ht.lex,pt.parse)(s,t,e)}T.options=T.setOptions=function(s){var t;return T.defaults={...T.defaults,...s},t=T.defaults,vt=t,T},T.getDefaults=Qn,T.defaults=vt,T.use=function(...s){const t=T.defaults.extensions||{renderers:{},childTokens:{}};s.forEach((e=>{const n={...e};if(n.async=T.defaults.async||n.async||!1,e.extensions&&(e.extensions.forEach((i=>{if(!i.name)throw new Error("extension name required");if(i.renderer){const a=t.renderers[i.name];t.renderers[i.name]=a?function(...r){let l=i.renderer.apply(this,r);return l===!1&&(l=a.apply(this,r)),l}:i.renderer}if(i.tokenizer){if(!i.level||i.level!=="block"&&i.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");t[i.level]?t[i.level].unshift(i.tokenizer):t[i.level]=[i.tokenizer],i.start&&(i.level==="block"?t.startBlock?t.startBlock.push(i.start):t.startBlock=[i.start]:i.level==="inline"&&(t.startInline?t.startInline.push(i.start):t.startInline=[i.start]))}i.childTokens&&(t.childTokens[i.name]=i.childTokens)})),n.extensions=t),e.renderer){const i=T.defaults.renderer||new oe;for(const a in e.renderer){const r=i[a];i[a]=(...l)=>{let o=e.renderer[a].apply(i,l);return o===!1&&(o=r.apply(i,l)),o}}n.renderer=i}if(e.tokenizer){const i=T.defaults.tokenizer||new re;for(const a in e.tokenizer){const r=i[a];i[a]=(...l)=>{let o=e.tokenizer[a].apply(i,l);return o===!1&&(o=r.apply(i,l)),o}}n.tokenizer=i}if(e.hooks){const i=T.defaults.hooks||new Ht;for(const a in e.hooks){const r=i[a];Ht.passThroughHooks.has(a)?i[a]=l=>{if(T.defaults.async)return Promise.resolve(e.hooks[a].call(i,l)).then((c=>r.call(i,c)));const o=e.hooks[a].call(i,l);return r.call(i,o)}:i[a]=(...l)=>{let o=e.hooks[a].apply(i,l);return o===!1&&(o=r.apply(i,l)),o}}n.hooks=i}if(e.walkTokens){const i=T.defaults.walkTokens;n.walkTokens=function(a){let r=[];return r.push(e.walkTokens.call(this,a)),i&&(r=r.concat(i.call(this,a))),r}}T.setOptions(n)}))},T.walkTokens=function(s,t){let e=[];for(const n of s)switch(e=e.concat(t.call(T,n)),n.type){case"table":for(const i of n.header)e=e.concat(T.walkTokens(i.tokens,t));for(const i of n.rows)for(const a of i)e=e.concat(T.walkTokens(a.tokens,t));break;case"list":e=e.concat(T.walkTokens(n.items,t));break;default:T.defaults.extensions&&T.defaults.extensions.childTokens&&T.defaults.extensions.childTokens[n.type]?T.defaults.extensions.childTokens[n.type].forEach((function(i){e=e.concat(T.walkTokens(n[i],t))})):n.tokens&&(e=e.concat(T.walkTokens(n.tokens,t)))}return e},T.parseInline=fn(ht.lexInline,pt.parseInline),T.Parser=pt,T.parser=pt.parse,T.Renderer=oe,T.TextRenderer=gn,T.Lexer=ht,T.lexer=ht.lex,T.Tokenizer=re,T.Slugger=mn,T.Hooks=Ht,T.parse=T,T.options,T.setOptions,T.use,T.walkTokens,T.parseInline,pt.parse,ht.lex;const ui=()=>{let s,t,e=null;function n(){if(e&&!e.closed)e.focus();else{if(e=window.open("about:blank","reveal.js - Notes","width=1100,height=700"),e.marked=T,e.document.write(`<!--
 ...
 */const hi=()=>{let s,t,e,n,i,a,r;function l(){t=document.createElement("div"),t.classList.add("searchbox"),t.style.position="absolute",t.style.top="10px",t.style.right="10px",t.style.zIndex=10,t.innerHTML=`<input type="search" class="searchinput" placeholder="Search..." style="vertical-align: top;"/>
		</span>`,e=t.querySelector(".searchinput"),e.style.width="240px",e.style.fontSize="14px",e.style.padding="4px 6px",e.style.color="#000",e.style.background="#fff",e.style.borderRadius="2px",e.style.border="0",e.style.outline="0",e.style.boxShadow="0 2px 18px rgba(0, 0, 0, 0.2)",e.style["-webkit-appearance"]="none",s.getRevealElement().appendChild(t),e.addEventListener("keyup",(function(g){g.keyCode===13?(g.preventDefault(),(function(){if(a){var v=e.value;v===""?(r&&r.remove(),n=null):(r=new u("slidecontent"),n=r.apply(v),i=0)}n&&(n.length&&n.length<=i&&(i=0),n.length>i&&(s.slide(n[i].h,n[i].v),i++))})(),a=!1):a=!0}),!1),c()}function o(){t||l(),t.style.display="inline",e.focus(),e.select()}function c(){t||l(),t.style.display="none",r&&r.remove()}function h(){t||l(),t.style.display!=="inline"?o():c()}function u(g,v){var L=document.getElementById(g)||document.body,p=v||"EM",F=new RegExp("^(?:"+p+"|SCRIPT|FORM)$"),x=["#ff6","#a0ffff","#9f9","#f99","#f6f"],q=[],J=0,M="",R=[];this.setRegex=function(E){E=E.trim(),M=new RegExp("("+E+")","i")},this.getRegex=function(){return M.toString().replace(/^\/\\b\(|\)\\b\/i$/g,"").replace(/\|/g," ")},this.hiliteWords=function(E){if(E!=null&&E&&M&&!F.test(E.nodeName)){if(E.hasChildNodes())for(var B=0;B<E.childNodes.length;B++)this.hiliteWords(E.childNodes[B]);var U,P;if(E.nodeType==3&&(U=E.nodeValue)&&(P=M.exec(U))){for(var f=E;f!=null&&f.nodeName!="SECTION";)f=f.parentNode;var I=s.getIndices(f),N=R.length,O=!1;for(B=0;B<N;B++)R[B].h===I.h&&R[B].v===I.v&&(O=!0);O||R.push(I),q[P[0].toLowerCase()]||(q[P[0].toLowerCase()]=x[J++%x.length]);var _=document.createElement(p);_.appendChild(document.createTextNode(P[0])),_.style.backgroundColor=q[P[0].toLowerCase()],_.style.fontStyle="inherit",_.style.color="#000";var V=E.splitText(P.index);V.nodeValue=V.nodeValue.substring(P[0].length),E.parentNode.insertBefore(_,V)}}},this.remove=function(){for(var E,B=document.getElementsByTagName(p);B.length&&(E=B[0]);)E.parentNode.replaceChild(E.firstChild,E)},this.apply=function(E){if(E!=null&&E)return this.remove(),this.setRegex(E),this.hiliteWords(L),R}}return{id:"search",init:g=>{s=g,s.registerKeyboardShortcut("CTRL + Shift + F","Search"),document.addEventListener("keydown",(function(v){v.key=="F"&&(v.ctrlKey||v.metaKey)&&(v.preventDefault(),h())}),!1)},open:o,close:c,toggle:h}};/*!
 * reveal.js Zoom plugin
 */const pi={id:"zoom",init:function(s){s.getRevealElement().addEventListener("mousedown",(function(t){var e=/Linux/.test(window.navigator.platform)?"ctrl":"alt",n=(s.getConfig().zoomKey?s.getConfig().zoomKey:e)+"Key",i=s.getConfig().zoomLevel?s.getConfig().zoomLevel:2;t[n]&&!s.isOverview()&&(t.preventDefault(),Ft.to({x:t.clientX,y:t.clientY,scale:i,pan:!1}))}))},destroy:()=>{Ft.reset()}};var gi=()=>pi,Ft=(function(){var s=1,t=0,e=0,n=-1,i=-1,a="transform"in document.body.style;function r(c,h){var u=o();if(c.width=c.width||1,c.height=c.height||1,c.x-=(window.innerWidth-c.width*h)/2,c.y-=(window.innerHeight-c.height*h)/2,a)if(h===1)document.body.style.transform="";else{var g=u.x+"px "+u.y+"px",v="translate("+-c.x+"px,"+-c.y+"px) scale("+h+")";document.body.style.transformOrigin=g,document.body.style.transform=v}else h===1?(document.body.style.position="",document.body.style.left="",document.body.style.top="",document.body.style.width="",document.body.style.height="",document.body.style.zoom=""):(document.body.style.position="relative",document.body.style.left=-(u.x+c.x)/h+"px",document.body.style.top=-(u.y+c.y)/h+"px",document.body.style.width=100*h+"%",document.body.style.height=100*h+"%",document.body.style.zoom=h);s=h,document.documentElement.classList&&(s!==1?document.documentElement.classList.add("zoomed"):document.documentElement.classList.remove("zoomed"))}function l(){var c=.12*window.innerWidth,h=.12*window.innerHeight,u=o();e<h?window.scroll(u.x,u.y-14/s*(1-e/h)):e>window.innerHeight-h&&window.scroll(u.x,u.y+(1-(window.innerHeight-e)/h)*(14/s)),t<c?window.scroll(u.x-14/s*(1-t/c),u.y):t>window.innerWidth-c&&window.scroll(u.x+(1-(window.innerWidth-t)/c)*(14/s),u.y)}function o(){return{x:window.scrollX!==void 0?window.scrollX:window.pageXOffset,y:window.scrollY!==void 0?window.scrollY:window.pageYOffset}}return a&&(document.body.style.transition="transform 0.8s ease"),document.addEventListener("keyup",(function(c){s!==1&&c.keyCode===27&&Ft.out()})),document.addEventListener("mousemove",(function(c){s!==1&&(t=c.clientX,e=c.clientY)})),{to:function(c){if(s!==1)Ft.out();else{if(c.x=c.x||0,c.y=c.y||0,c.element){var h=c.element.getBoundingClientRect();c.x=h.left-20,c.y=h.top-20,c.width=h.width+40,c.height=h.height+40}c.width!==void 0&&c.height!==void 0&&(c.scale=Math.max(Math.min(window.innerWidth/c.width,window.innerHeight/c.height),1)),c.scale>1&&(c.x*=c.scale,c.y*=c.scale,r(c,c.scale),c.pan!==!1&&(n=setTimeout((function(){i=setInterval(l,1e3/60)}),800)))}},out:function(){clearTimeout(n),clearInterval(i),r({x:0,y:0},1),s=1},magnify:function(c){this.to(c)},reset:function(){this.out()},zoomLevel:function(){return s}}})();/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const vn=(s,t,e=[])=>{const n=document.createElementNS("http://www.w3.org/2000/svg",s);return Object.keys(t).forEach(i=>{n.setAttribute(i,String(t[i]))}),e.length&&e.forEach(i=>{const a=vn(...i);n.appendChild(a)}),n};var mi=([s,t,e])=>vn(s,t,e);/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const fi=s=>Array.from(s.attributes).reduce((t,e)=>(t[e.name]=e.value,t),{}),vi=s=>typeof s=="string"?s:!s||!s.class?"":s.class&&typeof s.class=="string"?s.class.split(" "):s.class&&Array.isArray(s.class)?s.class:"",bi=s=>s.flatMap(vi).map(e=>e.trim()).filter(Boolean).filter((e,n,i)=>i.indexOf(e)===n).join(" "),yi=s=>s.replace(/(\w)(\w*)(_|-|\s*)/g,(t,e,n)=>e.toUpperCase()+n.toLowerCase()),tn=(s,{nameAttr:t,icons:e,attrs:n})=>{const i=s.getAttribute(t);if(i==null)return;const a=yi(i),r=e[a];if(!r)return console.warn(`${s.outerHTML} icon name was not found in the provided icons object.`);const l=fi(s),[o,c,h]=r,u={...c,"data-lucide":i,...n,...l},g=bi(["lucide",`lucide-${i}`,l,n]);g&&Object.assign(u,{class:g});const v=mi([o,u,h]);return s.parentNode?.replaceChild(v,s)};/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
lucide.createIcons({icons});\``);if(typeof document>"u")throw new Error("`createIcons()` only works in a browser environment.");const n=document.querySelectorAll(`[${t}]`);if(Array.from(n).forEach(i=>tn(i,{nameAttr:t,icons:s,attrs:e})),t==="data-lucide"){const i=document.querySelectorAll("[icon-name]");i.length>0&&(console.warn("[Lucide] Some icons were found with the now deprecated icon-name attribute. These will still be replaced for backwards compatibility, but will no longer be supported in v1.0 and you should switch to data-lucide"),Array.from(i).forEach(a=>tn(a,{nameAttr:"icon-name",icons:s,attrs:e})))}},Ii={problem:"Many growing companies have finance, stock, sales, purchasing, and operations running on different versions of the truth.",solution:"I help them map the business process, choose the right ERPNext/BirdTec/custom-system approach, and connect it into one reliable operating model.",request:"This month, please introduce me to an owner, CFO, or COO whose business has changed faster than their systems can adapt."},Pi=JSON.parse(`[{"id":"identity","code":"[01 / IDENTITY]","title":"Arvy Budiarto","subtitle":"ERPNext and business systems that grow with your business.","kicker":"AGILE TECHNICA","layout":"hero","brandIds":["agile-technica","bni-firefly"],"component":"pillars","heroImageSrc":"./assets/hero/arvy-art-deco-portrait.webp","heroImageAlt":"Arvy Budiarto in an Art Deco portrait against an optimistic city backdrop","pillars":[{"label":"ERP System Implementation, powered by ERPNext","icon":"database"},{"label":"Digital Transformation","icon":"refresh-cw"},{"label":"Poultry Management Systems","icon":"bird"},{"label":"ERPNext CoreTax Compatibility","icon":"receipt-text"},{"label":"CRM","icon":"contact-round"},{"label":"HR","icon":"users"}],"mode":"all"},{"id":"problem","code":"[02 / PROBLEM]","title":"Business growth is great. But your systems must keep up.","subtitle":"More branches, products, channels, warehouses, and people create new ways of working.","layout":"visual-story","component":"illustration","illustrationId":"growth-outpaces-systems","mode":"feature"},{"id":"problem-truths","code":"[02A / DIFFERENT TRUTHS]","title":"Then every team sees a different truth.","subtitle":"Warehouse, finance, and management start defending different numbers.","layout":"visual-story","component":"illustration","illustrationId":"different-truths","mode":"feature"},{"id":"problem-pain","code":"[02B / THE PAIN]","title":"The pain appears in daily work.","subtitle":"Duplicate entry. Late reports. Missing stock. Money leakage. Weak controls.","layout":"visual-story","component":"illustration","illustrationId":"systems-pain","mode":"feature"},{"id":"problem-fraud","code":"[02C / INTERNAL FRAUD]","title":"Weak controls create room for internal fraud.","subtitle":"Fake transactions. Inflated material and equipment purchases. Kickbacks. Company money redirected for personal gain.","layout":"visual-story","component":"illustration","illustrationId":"internal-fraud","mode":"feature"},{"id":"gains-goals-main","code":"[G / GOALS]","title":"Goals: What I'm Building Towards!","subtitle":"Businesses where management, finance, stock, sales, and operations work from the same reality.","component":"gains","gainsSection":"goals","goalImageId":"optimistic-road","labelsOnly":true,"hideSectionTitle":true,"brandIds":["agile-technica"],"mode":"feature","verticals":[{"id":"erpnext","code":"[03A / GOALS - ERPNext]","title":"Goals detail: ERPNext as the connected operating core.","subtitle":"ERPNext supports the goal of one source of truth across finance, stock, operations, HR, approvals, and reporting.","component":"topology","map":{"left":["Accounting","Sales","Purchasing","Inventory","Manufacturing"],"center":"ERPNext","right":["CRM","Projects","Assets","HR","Reports"]},"points":[{"label":"Integrated","detail":"Transactions flow from operations into finance."},{"label":"Open source","detail":"The platform can be extended and controlled."},{"label":"No traditional per-user licensing burden","detail":"Growth does not automatically multiply software-license fees with every user."},{"label":"Customizable","detail":"Forms, workflows, reports, and applications can be adapted."},{"label":"Integration ready","detail":"External systems can connect through APIs and custom integrations."}],"mode":"one-to-one","verticals":[{"id":"erp-flow","code":"[04A / FLOW]","title":"Operational events become accounting truth.","component":"process","steps":["Sales Order","Delivery","Invoice","Payment","General Ledger"],"feature":true},{"id":"erp-architecture","code":"[04B / ARCHITECTURE]","title":"Open architecture means the system can grow.","component":"process","steps":["ERPNext Core","Custom App","External API","Business Intelligence"],"mode":"one-to-one"},{"id":"erp-commercial","code":"[04C / COMMERCIAL]","title":"Open source changes the commercial model.","points":["Hosting has a cost.","Implementation has a cost.","Migration has a cost.","Support has a cost.","Customization has a cost.","Professional expertise has value."],"component":"metric","metrics":[{"value":"0","label":"traditional per-user license pressure","context":"Conceptual model only; not competitor pricing."}],"mode":"one-to-one"},{"id":"erp-indonesia-tax","code":"[04D / INDONESIA]","title":"Localized for Indonesia.","subtitle":"Agile Technica extends ERPNext with Indonesian operational and tax requirements.","points":[{"label":"CoreTax E-Faktur generator","detail":"Generate Indonesian tax-ready outputs from ERP data."},{"label":"CoreTax XML exporter","detail":"Prepare structured tax files without manual retyping."},{"label":"CoreTax result importer","detail":"Bring tax processing results back into the system."},{"label":"Indonesian reports","detail":"Reduce manual reporting work and improve traceability."}],"component":"process","steps":["ERP transaction","Tax data","XML export","CoreTax result","ERP traceability"],"mode":"one-to-one"}]}]},{"id":"erpnext-operating-system","code":"[G / GOALS - ERPNext]","title":"ERPNext is the business operating system.","subtitle":"It connects the work that happens across the company, so every team works from the same business reality.","brandIds":["agile-technica"],"component":"topology","map":{"illustrated":true,"sceneAsset":"erpnext-operation-scenes","bottomLogos":["erpnext","frappe-certified-partner"],"left":["Sales","Purchasing","Manufacturing"],"center":"ERPNext","right":["Accounting","Stock","HR"]},"mode":"feature"},{"id":"birdtec-hero","code":"[G / GOALS - POULTRY]","title":"Our Flagship Product: BirdTec.","subtitle":"BirdTec is made for poultry industry end to end.","layout":"birdtec-hero","brandIds":["birdtec"],"component":"illustration","illustrationId":"birdtec-poultry-operations","mode":"feature"},{"id":"birdtec","code":"[G / GOALS - POULTRY]","title":"BirdTec connects the poultry business end to end.","subtitle":"From farm performance to inventory, costing, settlement, and finance - one business view.","layout":"birdtec-dashboard","brandIds":["birdtec"],"component":"product","productId":"birdtec-farm-analyzer","points":["See farm and flock performance in one practical view.","Compare feed, FCR, production, and earnings before management has to chase spreadsheets."],"mode":"feature","verticals":[{"id":"birdtec-layer","code":"[06A / LAYER]","title":"Layer operations need daily operational discipline.","component":"process","steps":["Flock lifecycle","Daily egg production","Feed","Mortality","Grading","Performance","Profitability"],"mode":"one-to-one"},{"id":"birdtec-broiler","code":"[06B / BROILER]","title":"Broiler and kemitraan need connected performance and settlement.","component":"process","steps":["Placement","DOC","Feed distribution","Medicine","Weight","FCR","Harvest","Settlement"],"mode":"one-to-one"},{"id":"birdtec-processing","code":"[06C / PROCESSING]","title":"Processing connects production yield with inventory, sales, and costing.","component":"process","steps":["Live-bird receiving","Production yield","Grading","Cold storage","Inventory","Sales","Costing"],"mode":"one-to-one"}]},{"id":"delivery-depth","code":"[G / GOALS - DELIVERY DEPTH]","title":"Bread, cheese, meat.","subtitle":"The depth of our work follows the depth of the business need.","component":"offerings","offerings":[{"level":"Bread","tagline":"Ready to use","items":["BizTec: a simplified ERPNext system, with no modifications.","Monthly server subscription includes 3 support hours; consultation is optional.","TemanHR and Frappe HR can follow the same no-modification model."]},{"level":"Cheese","tagline":"Fully assisted implementation","items":["Customized ERPNext implementation.","BirdTec implementation for poultry operations.","Large-scale TemanHR deployment, fully assisted."]},{"level":"Meat","tagline":"Enterprise transformation","items":["ERPNext with significant modification and integration into other systems.","Enterprise backbone work: deep consultation and business-process mapping into digital systems.","Highly tailored BirdTec for contract farming."]}],"mode":"feature"},{"id":"gains-skills-main","code":"[S / SKILLS]","title":"What I bring to the table.","subtitle":"I have worked from code and architecture to multi-team delivery and company leadership. Today, we are an official Frappe / ERPNext partner in Indonesia.","component":"gains","gainsSection":"skills","mode":"feature","verticals":[{"id":"proof","code":"[05A / SKILLS - PROOF]","title":"Skills credibility: proof you can verify.","subtitle":"Credibility belongs under Skills: official partner status, publications, and client references must be visible and properly verified.","brandIds":["bni-firefly"],"component":"evidence","claimIds":["official-frappe-partner","trobos-cover","agrina-cover","client-proof"],"mode":"one-to-one"},{"id":"implementation","code":"[05B / SKILLS - DELIVERY]","title":"Skills detail: Agile Technica turns system goals into delivery.","subtitle":"Business consulting, ERP implementation, and software engineering in one team.","component":"process","steps":["Discover","Design","Implement","Extend","Connect","Improve"],"points":[{"label":"Discover","detail":"Understand how the business earns money, moves stock, controls cost, and makes decisions."},{"label":"Design","detail":"Map processes, roles, approvals, controls, and reporting."},{"label":"Implement","detail":"Configure ERPNext, prepare data, and train users."},{"label":"Extend","detail":"Build custom applications and specialized functionality."}],"mode":"one-to-one","verticals":[{"id":"delivery-journey","code":"[05A / DELIVERY]","title":"From discovery to stabilization.","component":"process","steps":["Discovery","Blueprint","Configuration","Validation","Migration","Training","Go-live","Stabilization"],"mode":"one-to-one"},{"id":"consultant-risk","code":"[05C / DELIVERY RISK]","title":"A good system project also manages consultant risk.","subtitle":"The company profile names the frustrations buyers already fear: poor business understanding, weak communication, overpromising, delays, hidden costs, and insufficient training.","points":[{"label":"Business-first discovery","detail":"Understand how the company actually works before proposing configuration or customization."},{"label":"Collaborative delivery","detail":"Regular planning, testing, showcases, and user validation reduce surprise."},{"label":"Training and stabilization","detail":"Go-live is not the finish line; users need support as the new operating model settles."}],"component":"process","steps":["Free pre-sales analysis","Proposal and contract","Kickoff","Requirements","Collaborative development","Training and migration","Go-live and support"],"mode":"one-to-one"},{"id":"adaptation-levels","code":"[05B / ADAPTATION]","title":"Adapt only where the business case is real.","component":"process","steps":["Configuration","Custom fields","Workflow","Reports","Custom application","External integration"],"mode":"one-to-one"}]},{"id":"difference","code":"[05C / SKILLS - DIFFERENCE]","title":"We design the process before we automate it.","subtitle":"That is the difference between installing software and building a reliable business system.","component":"logos","logoIds":["agile-technica","birdtec","biztec","temanhr"],"points":[{"label":"Consulting","detail":"Clarify business logic, roles, controls, and decisions."},{"label":"ERP implementation","detail":"Configure and deploy the integrated platform."},{"label":"Software engineering","detail":"Build the extensions and integrations the business truly needs."}],"mode":"one-to-one"},{"id":"translator","code":"[05D / SKILLS - TRANSLATOR]","title":"I speak both languages: business and technology.","subtitle":"One operating model. One connected system. One source of truth.","points":[{"label":"Business","detail":"Strategy, management reporting, cost, profitability, governance, and control."},{"label":"Operations","detail":"Sales, purchasing, inventory, warehouses, manufacturing, and supply chain."},{"label":"Technology","detail":"ERP architecture, custom software, APIs, integration, automation, and analytics."}],"component":"topology","map":{"left":["Management intent","Operational reality","Accounting controls"],"center":"Architecture","right":["ERPNext","Custom apps","Integration"]},"mode":"one-to-one"}]},{"id":"career-journey","code":"[A / ACHIEVEMENTS]","title":"I learned the business from every side of delivery.","subtitle":"That journey is why I can talk with the owner, understand the operation, and still go deep with the technical team.","component":"process","steps":["Software engineer","Delivery leader","Company builder","ERP business owner"],"points":[{"label":"Engineer","detail":"Built high-performance wagering systems in Australia where speed, reliability, and constant business change mattered."},{"label":"Delivery Lead","detail":"Coached and led several onshore and offshore teams to discover, build, and release products iteratively."},{"label":"Founder","detail":"Co-founded Agile Technica in 2019 and grew the team from 3 people to more than 30."},{"label":"Today","detail":"Combine business ownership, ERPNext, custom software, integration, and change leadership in one conversation."}],"mode":"feature"},{"id":"proof-trobos","code":"[A / ACHIEVEMENTS - PUBLISHED]","title":"Recognized for bringing data into poultry operations.","subtitle":"Trobos Livestock, October 2021 - an article on integrated farm management, performance analysis, and connected business data.","layout":"publication","component":"publication","publicationId":"trobos-livestock-2021","mode":"feature"},{"id":"proof-agrina","code":"[A / ACHIEVEMENTS - COVER STORY]","title":"The technology story became a business story.","subtitle":"Agrina Magazine, October 2023 - Arvy and BirdTec featured on the cover for smarter poultry profitability.","layout":"publication","component":"publication","publicationId":"agrina-cover-2023","mode":"feature"},{"id":"gains-networks-main","code":"[N / NETWORKS]","title":"The easiest way to spot a referral for me.","subtitle":"You hear one of these. You think of Arvy.","component":"process","steps":["We're expanding.","Our stock never matches.","We don't know where the money goes.","We need better control."],"mode":"feature"},{"id":"referral","code":"[06 / LISTEN FOR]","title":"Listen for the brag or the complaint.","subtitle":"You do not need to diagnose the system. Just catch the signal and introduce the decision-maker.","component":"referrals","referralIds":["business-expansion","stock-mismatch","money-leakage","theft-risk"],"mode":"one-to-one"},{"id":"intro-script","code":"[07 / INTRO]","title":"You can introduce me like this.","component":"quote","quote":{"text":"I know someone who helps growing companies get finance, stock, and operations working from one reliable system. His name is Arvy from Agile Technica.","author":"That's enough. I'll take it from there."},"mode":"feature"},{"id":"built","code":"[08 / BUILT]","title":"BUILT is how we work.","subtitle":"Bold. United. Integrity. Lasting. Trust.","layout":"values","brandIds":["agile-technica"],"component":"values","values":[{"letter":"B","name":"Bold","behaviour":"Push into hard problems and challenge what no longer works.","imageId":"built-bold"},{"letter":"U","name":"United","behaviour":"Bring business, finance, operations, and technology into one team.","imageId":"built-united"},{"letter":"I","name":"Integrity","behaviour":"Stay professional, incorruptible, and always fly straight.","imageId":"built-integrity"},{"letter":"L","name":"Lasting","behaviour":"Create systems that last, improve, and evolve with the business.","imageId":"built-lasting"},{"letter":"T","name":"Trust","behaviour":"Give clients confidence that the project will be finished properly.","imageId":"built-trust"}],"mode":"feature"},{"id":"gains-interests-main","code":"[I / INTERESTS]","title":"My interests.","component":"gains","gainsSection":"interests","labelsOnly":true,"hideSectionTitle":true,"mode":"feature","verticals":[{"id":"personal","code":"[09A / PERSONAL]","title":"Bold means taking the shot.","subtitle":"The personal story comes after the business relevance.","component":"quote","quote":{"text":"You miss 100% of the shots you don't take.","author":"Wayne Gretzky","connection":"Starting Agile Technica, entering complicated industries, and taking responsibility for difficult implementations all require the courage to take worthwhile shots."},"points":["Software engineering","Retro computers and cameras","Agile, Neuro-linguistic programming (NLP), AI, and teaching","Curiosity that connects business and technology"],"mode":"one-to-one"}]},{"id":"client-portfolio","code":"[A / ACHIEVEMENTS - CLIENT PORTFOLIO]","title":"A client portfolio across industries.","subtitle":"A selection of organisations we have supported across ERP, custom software, training, seminars, and CSR.","layout":"portfolio","component":"portfolio","clientLogos":[5,4,6,15,18,20,19,28,2,7,9,10,11,13,17,21,22,24,26,27,29,32,3,12,16],"portfolioId":"clients-2026","mode":"feature"},{"id":"partnership-journey","code":"[10 / PARTNERING]","title":"Partnering with Agile Technica.","subtitle":"A clear, collaborative path from the first conversation through continuous support.","brandIds":["agile-technica"],"component":"partnership","stages":["Free pre-sales analysis","Proposal and contract","Project kickoff","Business-requirements agreement","Collaborative development","Training, migration, and go-live","Continuous support"],"mode":"feature"},{"id":"weekly","code":"[11 / WEEKLY]","title":"Weekly BNI pitch.","subtitle":"One problem. One solution. One request.","component":"weekly","mode":"weekly"},{"id":"close","code":"[12 / CLOSE]","title":"Complex business. Clear systems. BUILT to last.","subtitle":"When a business has disconnected systems, unreliable stock, unclear costing, slow reporting, or operational complexity, introduce them to Arvy.","brandIds":["agile-technica","bni-firefly"],"component":"contact","monthlyRequest":true,"mode":"all"}]`),Ni={weekly:Ii,slides:Pi},$i={problem:"Banyak perusahaan yang bertumbuh memakai data finance, stok, sales, purchasing, dan operasional yang tidak lagi sama.",solution:"Saya membantu memetakan proses bisnis, memilih pendekatan ERPNext/BirdTec/custom system yang tepat, lalu menghubungkannya menjadi operating model yang reliable.",request:"Bulan ini, mohon perkenalkan saya kepada owner, CFO, atau COO yang bisnisnya berubah lebih cepat daripada sistemnya bisa menyesuaikan."},Mi=JSON.parse(`[{"id":"identity","code":"[01 / IDENTITY]","title":"Arvy Budiarto","subtitle":"ERPNext dan business systems yang berkembang bersama bisnis Anda.","kicker":"AGILE TECHNICA","layout":"hero","brandIds":["agile-technica","bni-firefly"],"component":"pillars","heroImageSrc":"./assets/hero/arvy-art-deco-portrait.webp","heroImageAlt":"Arvy Budiarto dalam potret Art Deco dengan latar kota optimistis","pillars":[{"label":"ERP System Implementation","icon":"database"},{"label":"Digital Transformation","icon":"refresh-cw"},{"label":"Poultry Management Systems","icon":"bird"},{"label":"Kompatibilitas ERPNext CoreTax","icon":"receipt-text"},{"label":"CRM","icon":"contact-round"},{"label":"HR","icon":"users"}],"mode":"all"},{"id":"problem","code":"[02 / PROBLEM]","title":"Pertumbuhan bisnis itu baik. Tetapi sistem Anda harus mampu mengikutinya.","subtitle":"Cabang, produk, channel, gudang, dan tim baru menciptakan cara kerja baru.","layout":"visual-story","component":"illustration","illustrationId":"growth-outpaces-systems","mode":"feature"},{"id":"problem-truths","code":"[02A / DIFFERENT TRUTHS]","title":"Masing-masing tim bekerja dari versi data yang berbeda.","subtitle":"Gudang, finance, dan manajemen mulai berdebat dengan data versi masing-masing.","layout":"visual-story","component":"illustration","illustrationId":"different-truths","mode":"feature"},{"id":"problem-pain","code":"[02B / THE PAIN]","title":"Frustrasi  muncul dalam pekerjaan sehari-hari.","subtitle":"Input berulang. Laporan lambat. Stok hilang. Uang bocor. Kontrol lemah.","layout":"visual-story","component":"illustration","illustrationId":"systems-pain","mode":"feature"},{"id":"problem-fraud","code":"[02C / INTERNAL FRAUD]","title":"Kontrol yang lemah membuka ruang untuk kecurangan internal.","subtitle":"Transaksi palsu. Harga material dan peralatan dinaikkan. Kickback. Uang perusahaan dialihkan untuk keuntungan pribadi.","layout":"visual-story","component":"illustration","illustrationId":"internal-fraud","mode":"feature"},{"id":"gains-goals-main","code":"[G / GOALS]","title":"Apa yang sedang saya bangun.","subtitle":"Bisnis tempat management, finance, stok, sales, dan operations bekerja dari realita yang sama.","component":"gains","gainsSection":"goals","labelsOnly":true,"hideSectionTitle":true,"brandIds":["agile-technica"],"mode":"feature","verticals":[{"id":"erpnext","code":"[03A / GOALS - ERPNext]","title":"Goals detail: ERPNext sebagai operating core yang terhubung.","subtitle":"Terintegrasi, dapat dikembangkan, dan siap menghubungkan operasi dengan finance.","component":"topology","map":{"left":["Accounting","Sales","Purchasing","Inventory","Manufacturing"],"center":"ERPNext","right":["CRM","Projects","Assets","HR","Reports"]},"points":[{"label":"Integrated","detail":"Transaksi mengalir dari operasional ke finance."},{"label":"Open source","detail":"Platform dapat dikontrol dan dikembangkan."},{"label":"Tanpa beban lisensi per-user tradisional","detail":"Pertumbuhan user tidak otomatis menggandakan biaya lisensi software."},{"label":"Customizable","detail":"Form, workflow, report, dan aplikasi dapat disesuaikan."},{"label":"Integration ready","detail":"Sistem eksternal dapat terhubung melalui API dan custom integration."}],"mode":"one-to-one","verticals":[{"id":"erp-flow","code":"[04A / FLOW]","title":"Aktivitas operasional menjadi kebenaran akuntansi.","component":"process","steps":["Sales Order","Delivery","Invoice","Payment","General Ledger"],"feature":true},{"id":"erp-indonesia-tax","code":"[04D / INDONESIA]","title":"Localized for Indonesia.","subtitle":"Agile Technica memperluas ERPNext untuk kebutuhan operasional dan pajak Indonesia.","points":[{"label":"CoreTax E-Faktur generator","detail":"Generate output pajak dari data ERP."},{"label":"CoreTax XML exporter","detail":"Siapkan file pajak terstruktur tanpa input ulang manual."},{"label":"CoreTax result importer","detail":"Masukkan hasil proses pajak kembali ke sistem."},{"label":"Indonesian reports","detail":"Mengurangi pekerjaan reporting manual dan meningkatkan traceability."}],"component":"process","steps":["ERP transaction","Tax data","XML export","CoreTax result","ERP traceability"],"mode":"one-to-one"}]}]},{"id":"erpnext-operating-system","code":"[G / GOALS - ERPNext]","title":"ERPNext adalah business operating system.","subtitle":"ERPNext menghubungkan pekerjaan di seluruh perusahaan agar setiap tim bekerja dari realita bisnis yang sama.","brandIds":["agile-technica"],"component":"topology","map":{"illustrated":true,"sceneAsset":"erpnext-operation-scenes","bottomLogos":["erpnext","frappe-certified-partner"],"left":["Sales","Purchasing","Manufacturing"],"center":"ERPNext","right":["Accounting","Stock","HR"]},"mode":"feature"},{"id":"birdtec-hero","code":"[G / GOALS - BIRDTEC]","title":"BirdTec dibuat untuk bisnis poultry, dari hulu ke hilir.","subtitle":"Layer. Broiler. Kemitraan. Rumah potong ayam.","layout":"birdtec-hero","brandIds":["birdtec"],"component":"illustration","illustrationId":"birdtec-poultry-operations","mode":"feature"},{"id":"birdtec","code":"[G / GOALS - BIRDTEC]","title":"BirdTec menghubungkan bisnis poultry dari hulu ke hilir.","subtitle":"Dari performa farm hingga inventory, costing, settlement, dan finance - satu business view.","layout":"birdtec-dashboard","brandIds":["birdtec"],"component":"product","productId":"birdtec-farm-analyzer","points":["Melihat performa farm dan flock dalam satu tampilan praktis.","Membandingkan feed, FCR, produksi, dan earnings tanpa management harus mengejar spreadsheet."],"mode":"feature"},{"id":"delivery-depth","code":"[G / GOALS - DELIVERY DEPTH]","title":"Bread, cheese, meat.","subtitle":"Kedalaman pekerjaan kami mengikuti kedalaman kebutuhan bisnis.","component":"offerings","offerings":[{"level":"Bread","tagline":"Siap digunakan","items":["BizTec: ERPNext yang disederhanakan, tanpa modifikasi.","Subscription server bulanan mencakup 3 jam support; konsultasi bersifat opsional.","TemanHR dan Frappe HR juga dapat menggunakan model tanpa modifikasi."]},{"level":"Cheese","tagline":"Implementasi full assisted","items":["Implementasi ERPNext yang disesuaikan.","Implementasi BirdTec untuk operasi poultry.","Deployment TemanHR skala besar dengan pendampingan penuh."]},{"level":"Meat","tagline":"Transformasi enterprise","items":["ERPNext dengan modifikasi besar dan integrasi ke sistem lain.","Pekerjaan enterprise backbone: konsultasi mendalam dan pemetaan proses bisnis ke sistem digital.","BirdTec yang sangat disesuaikan untuk contract farming."]}],"mode":"feature"},{"id":"gains-skills-main","code":"[S / SKILLS]","title":"Apa yang saya bawa ke meja.","subtitle":"Karier saya berkembang dari coding dan architecture, ke multi-team delivery, lalu memimpin perusahaan. Sekarang kami official Frappe / ERPNext partner di Indonesia.","component":"gains","gainsSection":"skills","mode":"feature","verticals":[{"id":"proof","code":"[05A / SKILLS - PROOF]","title":"Kredibilitas Skills: bukti yang bisa diverifikasi.","subtitle":"Kredibilitasnya mencakup official partner status, publikasi, dan client reference yang perlu dipakai dengan tepat.","brandIds":["bni-firefly"],"component":"evidence","claimIds":["official-frappe-partner","trobos-cover","agrina-cover","client-proof"],"mode":"one-to-one"},{"id":"implementation","code":"[05B / SKILLS - DELIVERY]","title":"ERPNext adalah platform. Agile Technica mengubahnya menjadi operating system bisnis.","subtitle":"Business consulting, ERP implementation, dan software engineering dalam satu tim.","component":"process","steps":["Discover","Design","Implement","Extend","Connect","Improve"],"points":[{"label":"Discover","detail":"Memahami cara bisnis menghasilkan uang, memindahkan stok, mengontrol cost, dan mengambil keputusan."},{"label":"Design","detail":"Memetakan proses, role, approval, kontrol, dan reporting."},{"label":"Implement","detail":"Konfigurasi ERPNext, persiapan data, dan training user."},{"label":"Extend","detail":"Membangun aplikasi custom dan fungsi khusus."}],"mode":"one-to-one"},{"id":"translator","code":"[03 / TRANSLATOR]","title":"Saya berbicara dalam dua bahasa: bisnis dan teknologi.","subtitle":"Satu operating model. Satu sistem terhubung. Satu sumber kebenaran.","points":[{"label":"Business","detail":"Strategy, reporting manajemen, costing, profitabilitas, governance, dan kontrol."},{"label":"Operations","detail":"Sales, purchasing, inventory, gudang, manufacturing, dan supply chain."},{"label":"Technology","detail":"Arsitektur ERP, custom software, API, integrasi, automation, dan analytics."}],"component":"topology","map":{"left":["Tujuan manajemen","Realita operasional","Kontrol akuntansi"],"center":"Architecture","right":["ERPNext","Custom apps","Integration"]},"mode":"one-to-one"}]},{"id":"career-journey","code":"[A / ACHIEVEMENTS]","title":"Saya memahami bisnis dari setiap sisi delivery.","subtitle":"Perjalanan ini membuat saya bisa berbicara dengan owner, memahami operasi, dan tetap masuk cukup dalam bersama tim teknis.","component":"process","steps":["Software engineer","Delivery leader","Company builder","ERP business owner"],"points":[{"label":"Engineer","detail":"Membangun high-performance wagering systems di Australia, saat kecepatan, reliability, dan perubahan bisnis sangat menentukan."},{"label":"Delivery Lead","detail":"Melatih dan memimpin beberapa tim onshore dan offshore untuk menemukan, membangun, dan merilis product secara iterative."},{"label":"Founder","detail":"Mendirikan Agile Technica pada 2019 dan mengembangkan tim dari 3 menjadi lebih dari 30 orang."},{"label":"Sekarang","detail":"Menggabungkan pengalaman sebagai business owner, ERPNext, custom software, integration, dan change leadership dalam satu percakapan."}],"mode":"feature"},{"id":"proof-trobos","code":"[A / ACHIEVEMENTS - PUBLISHED]","title":"Diakui karena membawa data ke dalam operasi poultry.","subtitle":"Trobos Livestock, Oktober 2021 - artikel tentang integrated farm management, analisa performa, dan data bisnis yang terhubung.","layout":"publication","component":"publication","publicationId":"trobos-livestock-2021","mode":"feature"},{"id":"proof-agrina","code":"[A / ACHIEVEMENTS - COVER STORY]","title":"Cerita teknologi ini menjadi cerita bisnis.","subtitle":"Agrina Magazine, Oktober 2023 - Arvy dan BirdTec tampil di cover untuk profitabilitas bisnis unggas yang lebih cerdas.","layout":"publication","component":"publication","publicationId":"agrina-cover-2023","mode":"feature"},{"id":"gains-networks-main","code":"[N / NETWORKS]","title":"Cara paling mudah mengenali referral untuk saya.","subtitle":"Kalau Anda mendengar salah satu ini, ingat Arvy.","component":"process","steps":["Kami sedang ekspansi.","Stok kami tidak pernah cocok.","Kami tidak tahu uangnya ke mana.","Kami butuh kontrol yang lebih baik."],"mode":"feature"},{"id":"referral","code":"[06 / LISTEN FOR]","title":"Dengarkan bragging atau complaining.","subtitle":"Anda tidak perlu mendiagnosis sistemnya. Cukup tangkap sinyalnya dan perkenalkan decision-maker.","component":"referrals","referralIds":["business-expansion","stock-mismatch","money-leakage","theft-risk"],"mode":"one-to-one"},{"id":"intro-script","code":"[07 / INTRO]","title":"Anda bisa memperkenalkan saya seperti ini.","component":"quote","quote":{"text":"Saya kenal seseorang yang membantu perusahaan bertumbuh membuat finance, stok, dan operations bekerja dari satu sistem yang dapat dipercaya. Namanya Arvy dari Agile Technica.","author":"Cukup begitu. Selanjutnya biar saya yang lanjutkan."},"mode":"feature"},{"id":"built","code":"[08 / BUILT]","title":"BUILT adalah cara kami bekerja.","subtitle":"Bold. United. Integrity. Lasting. Trust.","layout":"values","brandIds":["agile-technica"],"component":"values","values":[{"letter":"B","name":"Bold","behaviour":"Berani masuk ke masalah sulit dan menantang cara kerja yang tidak lagi efektif.","imageId":"built-bold"},{"letter":"U","name":"United","behaviour":"Satukan business, finance, operations, dan technology dalam satu tim.","imageId":"built-united"},{"letter":"I","name":"Integrity","behaviour":"Professional integrity: tidak bisa dibeli dan selalu lurus.","imageId":"built-integrity"},{"letter":"L","name":"Lasting","behaviour":"Membangun sistem yang tahan lama, terus membaik, dan ikut berkembang.","imageId":"built-lasting"},{"letter":"T","name":"Trust","behaviour":"Memberi klien keyakinan bahwa project akan selesai dengan benar.","imageId":"built-trust"}],"mode":"feature"},{"id":"gains-interests-main","code":"[I / INTERESTS]","title":"Minat saya.","component":"gains","gainsSection":"interests","labelsOnly":true,"hideSectionTitle":true,"mode":"feature","verticals":[{"id":"personal","code":"[09A / PERSONAL]","title":"Bold berarti berani mengambil kesempatan.","subtitle":"Cerita personal masuk setelah relevansi bisnis jelas.","component":"quote","quote":{"text":"You miss 100% of the shots you don't take.","author":"Wayne Gretzky","connection":"Membangun Agile Technica, masuk ke industri yang kompleks, dan mengambil tanggung jawab implementasi yang sulit membutuhkan keberanian untuk mengambil kesempatan yang bernilai."},"points":["Software engineering","Retro computers and cameras","Agile, Neuro-linguistic programming (NLP), AI, dan teaching","Curiosity yang menghubungkan business dan technology"],"mode":"one-to-one"}]},{"id":"client-portfolio","code":"[A / ACHIEVEMENTS - CLIENT PORTFOLIO]","title":"Portofolio klien lintas industri.","subtitle":"Pilihan organisasi yang telah kami dukung melalui ERP, custom software, training, seminar, dan CSR.","layout":"portfolio","component":"portfolio","clientLogos":[5,4,6,15,18,20,19,28,2,7,9,10,11,13,17,21,22,24,26,27,29,32,3,12,16],"portfolioId":"clients-2026","mode":"feature"},{"id":"partnership-journey","code":"[10 / PARTNERING]","title":"Bekerja sama dengan Agile Technica.","subtitle":"Jalur yang jelas dan kolaboratif dari percakapan awal hingga continuous support.","brandIds":["agile-technica"],"component":"partnership","stages":["Free pre-sales analysis","Proposal dan contract","Project kickoff","Kesepakatan business requirements","Collaborative development","Training, migration, dan go-live","Continuous support"],"mode":"feature"},{"id":"weekly","code":"[10 / WEEKLY]","title":"Pitch BNI mingguan.","subtitle":"Satu masalah. Satu solusi. Satu request.","component":"weekly","mode":"weekly"},{"id":"close","code":"[11 / CLOSE]","title":"Complex business. Clear systems. BUILT to last.","subtitle":"Saat bisnis punya sistem terputus, stok tidak akurat, costing tidak jelas, laporan lambat, atau kompleksitas operasional, perkenalkan mereka kepada Arvy.","brandIds":["agile-technica","bni-firefly"],"component":"contact","monthlyRequest":true,"mode":"all"}]`),Bi={weekly:$i,slides:Mi},Oi="Arvy Budiarto",zi="Agile Technica",Hi="ERP System Implementor - Business Systems Architect",Di="I turn complex business operations into one connected system.",qi={email:"arvy@agiletechnica.com",whatsapp:"+62 811 131 8918",website:"https://agiletechnica.com",instagram:"@arvy.budiarto"},Fi={name:Oi,company:zi,title:Hi,positioning:Di,contact:qi},ji="Arvy Budiarto",_i="Agile Technica",Ui="ERP System Implementor - Business Systems Architect",Wi="Saya mengubah kompleksitas operasional bisnis menjadi satu sistem yang terhubung.",Vi={email:"arvy@agiletechnica.com",whatsapp:"+62 811 131 8918",website:"https://agiletechnica.com",instagram:"@arvy.budiarto"},Ki={name:ji,company:_i,title:Ui,positioning:Wi,contact:Vi},Gi={"agile-technica":{label:"Agile Technica",src:"./assets/brand/agile-technica.webp?v=2",alt:"Agile Technica logo"},"bni-firefly":{label:"BNI Firefly",src:"./assets/brand/bni-firefly.webp?v=2",alt:"BNI Firefly logo"},erpnext:{label:"ERPNext",src:"./assets/brand/erpnext-logo.svg",alt:"Official ERPNext logo"},"frappe-certified-partner":{label:"Frappe Certified Partner",src:"./assets/brand/frappe-certified-partner.webp",alt:"Frappe Certified Partner logo"},birdtec:{label:"BirdTec",src:"./assets/brand/birdtec.webp",alt:"BirdTec logo"},biztec:{label:"BizTec",src:"./assets/brand/biztec.webp",alt:"BizTec logo"},temanhr:{label:"TemanHR",src:"./assets/brand/temanhr.webp",alt:"TemanHR logo"}},Yi={whatsappQr:{src:"./assets/contact/whatsapp-qr.png",alt:"QR code for contacting Arvy Budiarto on WhatsApp"}},Xi={"growth-outpaces-systems":{src:"./assets/illustrations/growth-outpaces-systems-v2.webp",mobileSrc:"./assets/illustrations/growth-outpaces-systems-mobile.webp",alt:"A growing Indonesian business expanding faster than its system while finance staff reconcile data manually and the owner sees conflicting reports"},"different-truths":{src:"./assets/illustrations/different-truths.webp",mobileSrc:"./assets/illustrations/different-truths-mobile.webp",alt:"Warehouse, finance, and management teams comparing conflicting business information"},"systems-pain":{src:"./assets/illustrations/systems-pain.webp",mobileSrc:"./assets/illustrations/systems-pain-mobile.webp",alt:"Employees dealing with duplicate entry, slow reports, missing stock, money leakage, and weak controls"},"internal-fraud":{src:"./assets/illustrations/internal-fraud-v2.webp",mobileSrc:"./assets/illustrations/internal-fraud-mobile.webp",alt:"Weak purchasing controls allowing fake material and equipment purchases, inflated invoices, and a concealed kickback"},"birdtec-poultry-operations":{src:"./assets/illustrations/birdtec-poultry-operations.webp",mobileSrc:"./assets/illustrations/birdtec-poultry-operations-mobile.webp",alt:"An Art Deco illustration of layer farming, broiler farming, contract farming, and poultry processing in Indonesia"},"optimistic-road":{src:"./assets/illustrations/optimistic-road-wide.webp",mobileSrc:"./assets/illustrations/optimistic-road-mobile.webp",alt:"An optimistic road connecting Indonesian people, farms, industry, and cities toward a bright future"}},Ji={"built-bold":{src:"./assets/values/built-bold.webp",alt:"A 1920s optimism poster style explorer looking across an unknown frontier"},"built-united":{src:"./assets/values/built-united.webp",alt:"A 1920s optimism poster style team working together around a blueprint"},"built-integrity":{src:"./assets/values/built-integrity.webp",alt:"A 1920s optimism poster style professional following a straight arrow through confusion"},"built-lasting":{src:"./assets/values/built-lasting.webp",alt:"A 1920s optimism poster style skyscraper system being built to last and evolve"},"built-trust":{src:"./assets/values/built-trust.webp",alt:"A 1920s optimism poster style man and woman standing confidently after project delivery"}},Zi={"trobos-livestock-2021":{label:"Trobos Livestock article",src:"./assets/publications/trobos-livestock-magazine-2x.webp",thumb:"./assets/publications/trobos-livestock-magazine-thumb.webp",alt:"Trobos Livestock article page featuring Arvy Budiarto, Edisi 265, Oktober 2021"},"agrina-cover-2023":{label:"Agrina Magazine cover",src:"./assets/publications/agrina-cover-2023-2x.webp",thumb:"./assets/publications/agrina-cover-2023-thumb.webp",alt:"Agrina Magazine cover featuring Arvy Budiarto, Vol. 19 No. 352, Oktober 2023"}},Qi={"clients-2026":{label:"Agile Technica clients portfolio",src:"./assets/portfolio/clients-portfolio.webp",alt:"Agile Technica client portfolio showing organisations served across ERPNext implementations, custom integrations, development, training, seminars, and CSR"}},ta={"birdtec-farm-analyzer":{src:"./assets/products/birdtec-farm-analyzer.webp",alt:"BirdTec Farm Layer Analyzer showing weekly flock performance, HD percentage, HH percentage, feed per bird, FCR, egg production, and estimated earnings",caption:"Farm Analyzer: performance, feed, FCR, production, and earnings in one view."}},ea={"erpnext-operation-scenes":{src:"./assets/modules/erpnext-operation-scenes-v2.webp",alt:"Six 1920s optimism poster scenes for Sales, Purchasing, Manufacturing, Accounting, Stock, and HR"}},bn={logos:Gi,contact:Yi,illustrations:Xi,valueImages:Ji,publications:Zi,portfolio:Qi,products:ta,moduleIllustrations:ea},na=[{id:"case-study-placeholder",title:"From fragmented operations to one connected view",industry:"Distribution",permissionStatus:"pending",before:["Multiple spreadsheets","Separate operational and accounting data"],intervention:["Process discovery","ERPNext implementation","Integration"],after:["Shared master data","Connected transactions","Improved visibility"],metrics:[]}],yn=[{id:"official-frappe-partner",claim:"Agile Technica is an official Frappe partner for ERPNext implementation in Indonesia",status:"verified",sourceType:"official",sourceLabel:"Frappe Partner Directory; Agile Technica partner profile and Frappe partner list",verifiedAt:"2026-07-12",publicUrl:"https://frappe.io/partners/indonesia/agile-technica",asset:"frappe-partner-profile.png",displayOnSlide:7},{id:"trobos-cover",claim:"Trobos Livestock article on poultry management systems",status:"verified",sourceType:"publication",sourceLabel:"Trobos Livestock, Edisi 265, Tahun XXIII, Oktober 2021, page 36; provided article scan",verifiedAt:"2026-07-11",publicUrl:"",asset:"trobos-livestock-2021",displayOnSlide:7},{id:"agrina-cover",claim:"Agrina Magazine cover feature on poultry business profit",status:"verified",sourceType:"publication",sourceLabel:"Agrina, Vol. 19 No. 352, Oktober 2023; cover headline: Bisnis Unggas: Cara Pintar Kejar Profit; provided cover scan",verifiedAt:"2026-07-11",publicUrl:"",asset:"agrina-cover-2023",displayOnSlide:7},{id:"client-proof",claim:"Enterprise implementation and training references",status:"approved-private",sourceType:"client evidence",sourceLabel:"Current pitch deck references client/project names; permission and logo assets required before public display",verifiedAt:null,publicUrl:"",asset:"client-logos",displayOnSlide:8},{id:"fifteen-years-experience",claim:"Arvy has 15+ years in IT and ERP",status:"pending-verification",sourceType:"profile",sourceLabel:"BIO GAINS V7 and current pitch deck",verifiedAt:null,publicUrl:"",asset:"",displayOnSlide:null}],ia=[{label:"One connected operating core",detail:"Use ERPNext as the open platform that connects finance, inventory, sales, purchasing, manufacturing, HR, approvals, and management reporting."},{label:"A trusted ERP company in Indonesia",detail:"Establish Agile Technica as a trusted implementation partner for operationally complex companies."},{label:"Deep solutions for complex industries",detail:"Use ERPNext, BirdTec, and custom software to solve industry-specific operational problems."},{label:"Strong Indonesian technology talent",detail:"Build a team that combines business process thinking, software engineering, and implementation discipline."}],aa=[{label:"15+ years in IT and ERP",detail:"A career spanning software engineering, high-performance wagering platforms, Agile delivery leadership, ERP implementation, and business ownership."},{label:"Built Agile Technica from 3 to 30+ people",detail:"Co-founded the company in 2019 and grew it into a multidisciplinary ERP and custom software delivery team."},{label:"Official Frappe / ERPNext partner in Indonesia",detail:"Agile Technica is listed by Frappe as an official partner, so ERPNext implementation is not a side experiment for us."},{label:"Creator and implementor of BirdTec",detail:"A poultry ERP platform for broiler, layer, contract farming, and processing operations."},{label:"Enterprise implementation exposure",detail:"Current deck references Datacomm, Netcity, Coway, Unirama, Pertamina projects, Japfa, and Great Giant Pineapple. Confirm permission before public display."},{label:"Industry publication credibility",detail:"Current materials reference Agrina and Trobos/Terobos coverage. Issue metadata and cover images still need verification."}],sa=[{label:"Software engineering, data science, and AI",detail:"A technical curiosity that supports better architecture and automation decisions."},{label:"Vintage technology, cameras, and high-performance PCs",detail:"A personal thread that signals craft, systems thinking, and attention to detail."},{label:"Agile, Neuro-linguistic programming (NLP), coaching, and teaching",detail:"Useful for change management, facilitation, communication, stakeholder alignment, and helping teams understand new ways of working."},{label:"Lived and worked in Australia",detail:"That experience brought a different perspective on communication, work culture, professionalism, and how people approach business problems."},{label:"Movies, games, comics, and audiobooks",detail:"Human connection points for one-to-one conversations after business relevance is clear."}],ra=[{label:"BNI and business contact spheres",detail:"Owners, CFOs, COOs, directors, finance consultants, tax consultants, IT providers, and operations leaders."},{label:"Target industries",detail:"Poultry, trading, import/export, distribution, manufacturing, telecom infrastructure, oil and gas, and specialty industries."},{label:"ERPNext and Frappe ecosystem",detail:"ERPNext Indonesia, global Frappe community, partners, developers, and implementation networks."},{label:"Agile, Scrum, and NLP communities",detail:"Professional communities that support delivery, facilitation, leadership, and transformation work."}],oa=[{label:"I understand both business and technology",detail:"I can talk with owners about growth and control, then work with the technical team on the system that supports it."},{label:"I have built systems where performance matters",detail:"My engineering and delivery background includes high-traffic platforms in Australia, multi-team leadership, and system architecture."},{label:"We know ERPNext",detail:"Agile Technica is an official Frappe / ERPNext partner in Indonesia, with implementation, customization, integration, and industry-specific experience."},{label:"I help people through change",detail:"Agile coaching, facilitation, teaching, and NLP help management and users adopt a better way of working."}],la=[{label:"Bread",detail:"ERP health check, standard ERPNext implementation, TemanHR, small integration, reporting, or existing ERPNext support."},{label:"Cheese",detail:"Full ERPNext implementation, BirdTec implementation, manufacturing or distribution ERP, multi-warehouse, dedicated TemanHR, or significant integration."},{label:"Meat",detail:"Multi-company ERP, enterprise customization, multiple-system integration, BirdTec across multiple operations, or large transformation across finance, supply chain, production, HR, and reporting."}],ca=[{label:"Only wants free consulting",detail:"No implementation intention or decision-maker commitment."},{label:"Too early-stage for ERP",detail:"Solo or very small businesses may not yet have enough operational complexity."},{label:"Refuses process change",detail:"ERP success requires willingness to improve workflows, data, roles, and controls."},{label:"Expects instant results",detail:"Professional ERP work needs discovery, data preparation, validation, training, and stabilization."}],da=[{label:"General",detail:"Looking for an ERP consultant who understands your industry and not just the software? Talk to Arvy."},{label:"Problem-led",detail:"If you need to solve missing stock, unbalanced accounting, high COGS, or misconduct risk, Arvy can help map the system."},{label:"Poultry",detail:"Agile Technica specializes in digital solutions for poultry farming, from broiler and layer farm management to processing and distribution."},{label:"Manufacturing and distribution",detail:"If you run a manufacturing or distribution business and need ERP that grows with you, talk to Arvy."}],ua={goals:ia,achievements:aa,interests:sa,networks:ra,skills:oa,offers:la,notReady:ca,introScripts:da},ha=[{id:"business-expansion",quote:"We are opening new branches, warehouses, or channels.",meaning:"Bragging about growth can mean the current system is about to be stretched beyond its design.",idealContacts:["Owner","CEO","CFO","COO"],lane:"expansion"},{id:"stock-mismatch",quote:"Our stock never matches.",meaning:"Inventory transactions, warehouse controls, and accounting may be disconnected.",idealContacts:["Owner","CFO","COO","Supply Chain Director"],lane:"manufacturing-distribution"},{id:"money-leakage",quote:"We do not know where the margin is leaking.",meaning:"Unclear costing, manual reconciliation, and disconnected finance data can hide real profit loss.",idealContacts:["Owner","CFO","Finance Director","COO"],lane:"finance"},{id:"theft-risk",quote:"We are worried stock, money, or people are not being controlled.",meaning:"ERP can create approval trails, inventory controls, role separation, and management visibility.",idealContacts:["Owner","CFO","COO","Internal Audit"],lane:"control"},{id:"late-reporting",quote:"Management reports are always late.",meaning:"The business may rely on manual consolidation instead of connected operational data.",idealContacts:["Owner","CFO","Finance Director"],lane:"finance"},{id:"spreadsheet-company",quote:"Every department has its own spreadsheet.",meaning:"The company may have outgrown disconnected tools and needs one source of truth.",idealContacts:["Owner","COO","Operations Director"],lane:"operations"},{id:"poultry-performance",quote:"Farm performance and finance do not use the same numbers.",meaning:"Poultry operational data may not be connected to costing, settlement, and accounting.",idealContacts:["Owner","Farm Director","CFO"],lane:"poultry"}],pa="2026-07",ga="An introduction to an owner, CFO, or COO of a poultry, manufacturing, distribution, or trading company experiencing stock, costing, reporting, or integration problems.",ma=!0,fa={month:pa,request:ga,active:ma},va="My job is to understand how a business actually operates and turn that complexity into a system that people can rely on.",ba="Ask who knows a company where warehouse, finance, and management each have a different number.",ya="A successful ERP implementation cannot be treated as only an IT project.",wa="ERPNext is open source, but implementation, hosting, migration, support, and professional expertise still have real cost and value.",ka="ERPNext is the platform; Agile Technica designs the operating model around it.",Sa="Farm data should not stop at the farm. It should become operational insight and financial truth.",Ea="Make this easy for BNI members: symptoms, decision-maker, and exact words to use.",xa={identity:va,problem:ba,translator:ya,erpnext:wa,implementation:ka,birdtec:Sa,referral:Ea};function Aa(){const s=new URLSearchParams(window.location.search);return{mode:s.get("mode")||"feature",lang:s.get("lang")||"en"}}const en={feature:new Set(["feature","all"]),weekly:new Set(["weekly","all"]),"one-to-one":new Set(["feature","one-to-one","all"]),"leave-behind":new Set(["feature","one-to-one","leave-behind","all"])};function Ra(s,t="feature"){const e=en[t]||en.feature;return s.filter(n=>e.has(n.mode||"feature")).map(n=>({...n,verticals:(n.verticals||[]).filter(i=>t==="feature"?i.feature===!0:e.has(i.mode||"one-to-one"))}))}function k(s){return String(s??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}const Ta="whatsapp-qr.png";function nn(s){return s.endsWith(Ta)||!/^\.\/assets\//.test(s)?null:s.replace(/\.(?:png|jpe?g|webp)(?=(?:\?[^?]*)?$)/i,".avif")}function Q({src:s,alt:t,className:e="",loading:n="lazy",fetchPriority:i,mobileSrc:a,mobileFirst:r=!1}){const l=nn(s),o=a?nn(a):null,c=e?` class="${k(e)}"`:"",h=n?` loading="${n}"`:"",u=i?` fetchpriority="${i}"`:"",g=a?`${o?`<source media="(max-width: 900px) and (orientation: portrait)" srcset="${k(o)}" type="image/avif" />`:""}
    ...
    <div class="system-map${a?" system-map-illustrated":""}${l.length?" has-partners":""}" aria-label="Business and technology connection map">
      ...
      ${l.length?`<div class="system-map-partners" aria-label="ERPNext and Frappe partner credentials">
              ${l.map(c=>`<span class="system-map-partner-badge">${Q({src:c.src,alt:c.alt,className:`partner-logo partner-${c.id}`})}</span>`).join("")}
            </div>`:""}
    </div>
  `}function La(s){return`
    <ol class="process-rail" aria-label="Process flow">
      ${(s.steps||[]).map((e,n)=>`<li><span>${String(n+1).padStart(2,"0")}</span><strong>${k(e)}</strong></li>`).join("")}
    </ol>
  `}function Ia(s,t){return`
    <div class="evidence-grid">
      ${(s.claimIds||[]).map(i=>t.claims.find(a=>a.id===i)).filter(Boolean).map(i=>Pa(i,t)).join("")}
    </div>
  `}function Pa(s,t){const e=s.asset?t.assets.publications?.[s.asset]:null;return`
    <article class="evidence-card ${s.status} ${e?"has-evidence-image":""}">
      ${e?Q({src:e.thumb||e.src,alt:e.alt}):""}
      <span>${k(s.sourceType)}</span>
      <h3>${k(s.claim)}</h3>
      <p>${k(s.sourceLabel||"Source required")}</p>
      <small>${s.verifiedAt?`Verified ${k(s.verifiedAt)}`:"Pending verification"}</small>
    </article>
  `}function Na(s,t){return`
    <div class="referral-grid">
      ${(s.referralIds||t.referrals.map(n=>n.id)).map(n=>t.referrals.find(i=>i.id===n)).filter(Boolean).map(n=>`
        <article class="referral-card">
          ...
          <h3>"${k(n.quote)}"</h3>
          <p>${k(n.meaning)}</p>
          <small>${k(n.idealContacts.join(", "))}</small>
        </article>
      `).join("")}
    </div>
  `}function $a(s){return`
    <div class="built-values">
      ${(s.values||[]).map(t=>{const e=bn.valueImages?.[t.imageId];return`
        <article class="value-card">
          ${e?`
            <figure class="value-card-art">
              ${Q({src:e.src,alt:e.alt})}
              <strong>${k(t.letter)}</strong>
            </figure>
          `:`<strong>${k(t.letter)}</strong>`}
          <div>
            <h3>${k(t.name)}</h3>
  ...
  `}function Ma(s){return`
    <figure class="quote-card">
      <blockquote>${k(s.quote.text)}</blockquote>
      ${s.quote.author?`<figcaption>${k(s.quote.author)}</figcaption>`:""}
      ${s.quote.connection?`<p>${k(s.quote.connection)}</p>`:""}
    </figure>
  `}function Ba(s){return`
    <div class="metric-stack">
      ${(s.metrics||[]).map(t=>`
        <article class="metric-card">
          <strong>${k(t.value)}</strong>
          <span>${k(t.label)}</span>
          <small>${k(t.context)}</small>
        </article>
      `).join("")}
    </div>
  `}const Oa={overview:"What to remember",goals:"Goals",achievements:"Achievements",interests:"Interests",networks:"Networks",skills:"Skills",offers:"Bread, Cheese, Meat",notReady:"When a company may not be ready yet",introScripts:"BNI introduction scripts"};function za(s,t){const e=s.gainsSection||"overview";if(e==="overview")return Ha(s);const n=t.gains[e]||[],i=e==="goals"&&s.goalImageId?t.assets.illustrations?.[s.goalImageId]:null;return`
    <div class="gains-chapter ${s.labelsOnly?"labels-only":""} ${i?"goals-with-image":""}">
      ${s.hideSectionTitle?"":`<h2>${k(Oa[e]||e)}</h2>`}
      <div class="gains-list">
        ${n.map(a=>`
              <article class="gains-item">
                <strong>${k(a.label)}</strong>
                ${s.labelsOnly?"":`<p>${k(a.detail)}</p>`}
              </article>
            `).join("")}
      </div>
      ${i?`<figure class="gains-goals-image">
              ${Q({src:i.src,alt:i.alt,mobileSrc:i.mobileSrc})}
            </figure>`:""}
    </div>
  `}function Ha(s){const t=s.overviewTiles||[{index:"01",label:"Goals"},{index:"02",label:"Achievements"},{index:"03",label:"Interests"},{index:"04",label:"Networks"},{index:"05",label:"Skills"}],e=s.overviewCta||{label:"BNI",detail:"Referral enablement"};return`
    <div class="gains-overview" aria-label="BNI referral memory points">
      ${t.map((n,i)=>`
            <article class="gains-tile">
              <span>${k(n.index||String(i+1).padStart(2,"0"))}</span>
              <strong>${k(n.label||n)}</strong>
              ${n.detail?`<p>${k(n.detail)}</p>`:""}
            </article>
          `).join("")}
      <article class="gains-tile referral-tile">
        <span>${k(e.label)}</span>
        <strong>${k(e.detail)}</strong>
      </article>
    </div>
  `}function Da(s,t){return s.logoIds?.length?`
      <div class="logo-strip brand-logo-strip" aria-label="Brand logo strip">
        ${s.logoIds.map(n=>t.assets.logos[n]).filter(Boolean).map(n=>`
          <figure>
            ${Q({src:n.src,alt:n.alt})}
            <figcaption>${k(n.label)}</figcaption>
          </figure>
        `).join("")}
      </div>
    `:`
    <div class="logo-strip" aria-label="Client logo placeholders">
      ${(s.logos||["Client proof pending","Project photo pending","Case evidence pending"]).map(e=>`<span>${k(e)}</span>`).join("")}
    </div>
  `}function qa(s){return`<span class="section-label">${k(s)}</span>`}function Fa(s,t){const e=t.assets.logos["agile-technica"],n=t.assets.logos["bni-firefly"],i=t.assets.contact?.whatsappQr,l=`https://wa.me/${t.profile.contact.whatsapp.replace(/\D/g,"")}?text=${encodeURIComponent("I found Arvy's BIO Gains and I'm from BNI Chapter ____, please link me to him")}`;return`
    <div class="contact-panel">
      <div class="contact-brand-pair">
        ${Q({src:e.src,alt:e.alt})}
        ${Q({src:n.src,alt:n.alt})}
      </div>
      <div class="contact-action-pair">
        ${i?`
          ${Q({src:i.src,alt:i.alt,className:"contact-qr"})}
        `:`
          <div class="qr-placeholder" role="img" aria-label="QR code placeholder for ${k(t.profile.contact.website)}">QR</div>
        `}
        <a class="contact-whatsapp-button" href="${k(l)}" target="_blank" rel="noopener noreferrer" aria-label="Send Arvy a WhatsApp message">
      ...
      <h3>${k(t.profile.name)}</h3>
      <p>${k(t.profile.contact.email)}</p>
      <p>${k(t.profile.contact.whatsapp)}</p>
      <p>${k(t.profile.contact.website)}</p>
    </div>
  `}function ja(s,t){const e=t.assets.publications?.[s.publicationId];return e?`
    <figure class="publication-image">
      ${Q({src:e.src,alt:e.alt})}
      <figcaption>${k(e.label)}</figcaption>
    </figure>
  `:'<div class="publication-missing">Publication asset missing</div>'}function _a(s){return`
    <div class="pillar-grid${s.heroImageSrc?" pillar-grid-with-portrait":""}" aria-label="Agile Technica product pillars">
      ${(s.pillars||[]).map(t=>`
            <article class="pillar-item">
              ${t.imageSrc?`<span class="pillar-icon-image" style="--pillar-icon-url: url('${k(t.imageSrc)}')" aria-hidden="true"></span>`:`<i data-lucide="${k(t.icon)}" aria-hidden="true"></i>`}
              <strong>${k(t.label)}</strong>
            </article>
          `).join("")}
      ${s.heroImageSrc?`<figure class="hero-portrait-tile">
              ${Q({src:s.heroImageSrc,alt:s.heroImageAlt||"Arvy Budiarto in an Art Deco city portrait",loading:"eager",fetchPriority:"high"})}
            </figure>`:""}
    </div>
  `}function Ua(s,t){const e=t.assets.illustrations?.[s.illustrationId];return e?`
    <figure class="story-illustration">
      ${Q({src:e.src,alt:e.alt,mobileSrc:e.mobileSrc,mobileFirst:!0})}
    </figure>
  `:'<div class="illustration-missing">Illustration asset missing</div>'}function Wa(s){return`
    <div class="offering-stack" aria-label="Service delivery depth">
      ${(s.offerings||[]).map(t=>`
            <article class="offering-card offering-${k(t.level||"standard").toLowerCase()}">
              <header>
                <span>${k(t.level)}</span>
                <strong>${k(t.tagline)}</strong>
              </header>
              <ul>
                ${(t.items||[]).map(e=>`<li>${k(e)}</li>`).join("")}
              </ul>
            </article>
          `).join("")}
    </div>
  ...
  `}function Ka(s,t){if(s.clientLogos?.length)return`
      <div class="client-portfolio-wrap">
        <div class="client-portfolio-grid" aria-label="Selected client logos">
          ${s.clientLogos.map(n=>`
                <figure class="client-logo-tile">
                  ${Q({src:`./assets/portfolio/client-logos/${n}.webp`,alt:`Client logo ${n}`,loading:"eager",fetchPriority:"low"})}
                </figure>
              `).join("")}
          <p class="client-portfolio-note">and many more...</p>
        </div>
      </div>
  ...
  `:'<div class="publication-missing">Client portfolio asset missing</div>'}function Ga(s,t){const e=t.assets.products?.[s.productId];return e?`
    <figure class="product-screenshot">
      ${Q({src:e.src,alt:e.alt})}
      <figcaption>${k(e.caption)}</figcaption>
    </figure>
  `:'<div class="publication-missing">Product screenshot missing</div>'}const Ya={topology:Ca,process:La,evidence:Ia,referrals:Na,values:$a,quote:Ma,metric:Ba,gains:za,logos:Da,contact:Fa,publication:ja,pillars:_a,illustration:Ua,offerings:Wa,partnership:Va,portfolio:Ka,product:Ga};function an(s,t){const e=s.theme||"dark",n=[Xa(s),Ja(s,t),es(s,t),ns(s,t)].join("");return`<section class="slide slide-${e} slide-${s.layout||"statement"}" data-slide-id="${k(s.id||"")}" data-section="${k(s.code||"")}">${n}</section>`}function Xa(s){return`
    <div class="slide-topline">
      ${qa(s.code||s.parentCode||"")}
      <span class="deck-identity">Arvy B. <span aria-hidden="true">·</span> BNI Firefly <span aria-hidden="true">·</span> BIO GAINS</span>
    </div>
  `}function Ja(s,t){const e=s.kicker?`<p class="kicker">${k(s.kicker)}</p>`:"",n=s.title?`<h1>${k(s.title)}</h1>`:"",i=s.subtitle?`<p class="subtitle">${k(s.subtitle)}</p>`:"",a=Za(s,t),r=ts(s,t),l=Qa(s,t);return`
  ...
  `}function Za(s,t){return s.brandIds?.length?`
    <div class="brand-row" aria-label="Brand marks">
      ${s.brandIds.map(e=>t.assets.logos[e]).filter(Boolean).map(e=>Q({src:e.src,alt:e.alt})).join("")}
    </div>
  `:""}function Qa(s,t){return s.component==="weekly"?`
      <div class="weekly-pitch">
        <p>${k(t.weekly.problem)}</p>
        <p>${k(t.weekly.solution)}</p>
        <strong>${k(t.weekly.request)}</strong>
      </div>
    `:s.monthlyRequest?`<div class="request-panel"><strong>Current request</strong><p>${k(t.monthlyRequest.request)}</p></div>`:s.points?`
    <div class="point-grid ${s.points.length>4?"compact":""}">
      ${s.points.map(e=>`<div class="point-card"><span>${k(e.label||e)}</span>${e.detail?`<p>${k(e.detail)}</p>`:""}</div>`).join("")}
    </div>
  `:""}function ts(s,t){if(!s.component&&!s.visual)return'<div class="visual-panel empty-panel" aria-hidden="true"></div>';const e=Ya[s.component||s.visual];return e?`<div class="visual-panel">${e(s,t)}</div>`:`<div class="visual-panel text-visual">${k(s.visualText||"")}</div>`}function es(s,t){const e=s.note||t.speakerNotes[s.id];return e?`<aside class="notes">${k(e)}</aside>`:""}function ns(s,t){const e=s.id==="close";return`
    <footer class="deck-footer">
      <span class="footer-contact-summary">${k(t.profile.contact.email)} | ${k(t.profile.contact.whatsapp)}</span>
      <div class="footer-actions">
        ${e?"":'<button class="footer-contact-button" type="button" data-contact-jump>Contact</button>'}
      </div>
    </footer>
  `}function is(s,t){return`
  ...
  `}function as(s){const t=s.slides.map(e=>{const n=an(e,s),i=(e.verticals||[]).map(a=>an({...a,parentCode:e.code},s));return i.length===0?n:`<section>${n}${i.join("")}</section>`});return`
    ...
    ${is(s.slides,s.lang)}
  `}function ss(s){const t=s.filter(e=>e.status!=="verified"&&e.displayOnSlide);t.length>0&&console.warn("Claims need verification before public use:",t.map(e=>`${e.id}: ${e.status}`))}const wn=Aa(),jt=wn.lang==="id"?"id":"en",le=wn.mode,sn=jt==="id"?Bi:Ni,kn=jt==="id"?Ki:Fi;document.documentElement.lang=jt;document.title=`${kn.name} | BNI GAINS ${le}`;const rs=document.querySelector("#app");rs.innerHTML=as({slides:Ra(sn.slides,le),weekly:sn.weekly,mode:le,lang:jt,profile:kn,assets:bn,referrals:ha,gains:ua,cases:na,claims:yn,monthlyRequest:fa,speakerNotes:xa});Li({icons:{Database:Si,RefreshCw:Ai,Bird:wi,ReceiptText:xi,Users:Ti,ContactRound:ki,List:Ei,Search:Ri,X:Ci}});ss(yn);const ae=window.matchMedia("(max-width: 600px)").matches,os=X.initialize({width:ae?window.innerWidth:1600,height:ae?window.innerHeight:900,margin:ae?0:.04,minScale:.2,maxScale:2,hash:!0,history:!0,controls:!0,progress:!0,center:!1,transition:"slide",transitionSpeed:"fast",backgroundTransition:"slide",navigationMode:"default",touch:!0,slideNumber:"c/t",pdfSeparateFragments:!1,plugins:[ui,hi,gi]});X.on("slidechanged",({currentSlide:s})=>Sn(s));os.then(()=>{En(),Sn(X.getCurrentSlide())});window.addEventListener("resize",En);cs();ds();ls();function Sn(s){s&&s.querySelectorAll('img[loading="lazy"]').forEach(t=>{t.loading="eager"})}function En(){const s=window.matchMedia("(max-width: 600px)").matches;X.configure({width:s?window.innerWidth:1600,height:s?window.innerHeight:900,margin:s?0:.04}),X.layout()}function ls(){document.addEventListener("click",s=>{if(!s.target.closest("[data-contact-jump]"))return;s.preventDefault(),s.stopPropagation();const e=document.querySelector('.reveal .slides section[data-slide-id="close"]');if(!e)return;const n=X.getIndices(e);X.slide(n.h,n.v)})}function cs(){const s=document.querySelector("[data-deck-index]"),t=document.querySelector("[data-index-open]"),e=document.querySelector("[data-index-search]"),n=[...document.querySelectorAll("[data-index-item]")],i=document.querySelector("[data-index-empty]");if(!s||!t||!e||!i)return;const a=()=>{s.hidden=!0,t.setAttribute("aria-expanded","false"),t.focus()},r=()=>{s.hidden=!1,t.setAttribute("aria-expanded","true"),e.value="",l(),requestAnimationFrame(()=>e.focus())},l=()=>{const o=e.value.trim().toLowerCase();let c=0;n.forEach(h=>{const u=!o||h.dataset.search.includes(o);h.hidden=!u,u&&(c+=1)}),i.hidden=c!==0};t.addEventListener("click",r),s.querySelectorAll("[data-index-close]").forEach(o=>o.addEventListener("click",a)),e.addEventListener("input",l),n.forEach(o=>{o.addEventListener("click",()=>{X.slide(Number(o.dataset.horizontal),Number(o.dataset.vertical)),a()})}),document.addEventListener("keydown",o=>{const c=["INPUT","TEXTAREA","SELECT"].includes(document.activeElement?.tagName);if(o.key==="Escape"&&!s.hidden){o.preventDefault(),a();return}o.key.toLowerCase()==="i"&&!c&&(o.preventDefault(),s.hidden?r():a())},!0)}function ds(){[...document.querySelectorAll("[data-language]")].forEach(t=>{t.addEventListener("click",()=>{const e=t.dataset.language,{h:n,v:i}=X.getIndices(),a=new URL(window.location.href);e==="en"?a.searchParams.delete("lang"):a.searchParams.set("lang",e),a.hash=`#/${n}${i>0?`/${i}`:""}`,window.location.assign(a.toString())})})}
